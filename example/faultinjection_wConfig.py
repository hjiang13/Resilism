...
currdir = "."
#progbin = currdir + "/home/veloc/CoMD0918/prog_output/looptest"
progbin = "/home/veloc/CoMD0918/prog_output/looptest"
pinbin = "../pin-v3.5/pin"
...
def main():
  ...
  execute(execlist)
  IPs = []
  with open ('/home/veloc/pin-v3.5/source/tools/pinfi/cmp.looptest.txt') as fi:
      for line in fi:
          IPs.append(line)
