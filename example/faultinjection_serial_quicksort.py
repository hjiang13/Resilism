...
currdir = "."
#progbin = currdir + "/home/veloc/quicksort/bin/quicksort-openmp"
progbin = "/home/veloc/quicksort/iterative/quicksort"
pinbin = "../pin-v3.5/pin"
...
optionlist = ["/home/veloc/quicksort/10.txt"]
...
def main():
  ...
  execute(execlist)
  IPs = []
  with open ('/home/veloc/pin-v3.5/source/tools/pinfi/cmp.quicksort.txt') as fi:
      for line in fi:
          IPs.append(line)
