...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi = call i64 @injectFault0(i64 1136, i64 %48, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1157
  %49 = getelementptr inbounds double, double* %21, i64 %fi, !llfi_index !1158
  ...
  %73 = getelementptr inbounds double, double* %52, i64 %fi, !llfi_index !1190
  ...
  %97 = getelementptr inbounds double, double* %76, i64 %fi, !llfi_index !1222
