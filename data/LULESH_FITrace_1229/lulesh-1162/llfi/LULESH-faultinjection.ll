...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi2 = call i64 @injectFault2(i64 1126, i64 %40, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %41 = getelementptr inbounds double, double* %21, i64 %fi2, !llfi_index !1148
  ...
  %fi3 = call double* @injectFault3(i64 1141, double* %52, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  ...
  %67 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1182
  %fi4 = call double* @injectFault3(i64 1161, double* %67, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %68 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1183
  %fi5 = call double @injectFault4(i64 1162, double %68, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %69 = getelementptr inbounds double, double* %2, i64 5, !llfi_index !1184
  store double %fi5, double* %69, align 8, !tbaa !345, !llfi_index !1185
  ...
  %91 = getelementptr inbounds double, double* %76, i64 %fi2, !llfi_index !1214
