...
182:                                              ; preds = %182, %158
  ...
  %187 = getelementptr double, double* %135, i64 %186, !llfi_index !6061
  %fi = call double* @injectFault0(i64 5927, double* %187, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !6062
  %188 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !6063
  %189 = fadd double %162, %188, !llfi_index !6064
  store double %189, double* %fi, align 8, !tbaa !345, !llfi_index !6065
