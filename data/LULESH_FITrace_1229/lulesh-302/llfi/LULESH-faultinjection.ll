...
253:                                              ; preds = %251, %247
  ...
  %fi = call i1 @injectFault0(i64 302, i1 %256, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !312
  br i1 %fi, label %259, label %257, !llfi_index !313
