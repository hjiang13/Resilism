...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi1 = call <2 x double> @injectFault0(i64 3311, <2 x double> %60, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %61 = insertelement <2 x double> poison, double %4, i32 0, !llfi_index !3354
  %fi2 = call <2 x double> @injectFault0(i64 3312, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %62 = insertelement <2 x double> %fi2, double %12, i32 1, !llfi_index !3355
  %fi3 = call <2 x double> @injectFault0(i64 3313, <2 x double> %62, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %63 = fsub <2 x double> %fi1, %fi3, !llfi_index !3356
  %fi4 = call <2 x double> @injectFault0(i64 3314, <2 x double> %63, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %64 = fsub double %22, %20, !llfi_index !3357
  %fi5 = call double @injectFault1(i64 3315, double %64, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  ...
  %76 = insertelement <2 x double> %fi2, double %1, i32 1, !llfi_index !3369
  ...
  %99 = fmul <2 x double> %fi4, %30, !llfi_index !3393
  ...
  %102 = extractelement <2 x double> %fi4, i32 1, !llfi_index !3396
  %fi6 = call double @injectFault1(i64 3354, double %102, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %103 = insertelement <2 x double> poison, double %fi6, i32 0, !llfi_index !3397
  %fi7 = call <2 x double> @injectFault0(i64 3355, <2 x double> %103, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %104 = insertelement <2 x double> %fi7, double %fi5, i32 1, !llfi_index !3398
  %fi8 = call <2 x double> @injectFault0(i64 3356, <2 x double> %104, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %105 = fmul <2 x double> %101, %fi8, !llfi_index !3399
