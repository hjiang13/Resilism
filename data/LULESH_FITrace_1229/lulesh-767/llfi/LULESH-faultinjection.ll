...
7:                                                ; preds = %122
  ...
  %30 = getelementptr double, double* %5, i64 2, !llfi_index !782
  %fi = call double* @injectFault0(i64 766, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !783
  %31 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !784
  %fi1 = call double @injectFault1(i64 767, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !783
  ...
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %0, double* nonnull %1, double* nonnull %2, double* nonnull %8, double* nonnull %9, double* nonnull %10, double* nonnull %11, double* nonnull %12, double* nonnull %13, double* nonnull %14, double* nonnull %15, double* nonnull %16, double %17, double %18, double %19, double %21, double %23, double %25, double %27, double %29, double %fi1, double %33, double %35, double %37), !llfi_index !791
  ...
  %79 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !834
  ...
  %85 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !841
