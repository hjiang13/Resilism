...
63:                                               ; preds = %47
  ...
  %fi = call <2 x double> @injectFault0(i64 4693, <2 x double> %65, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %66 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !4753
  %fi1 = call <2 x double> @injectFault0(i64 4694, <2 x double> %66, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %67 = insertelement <2 x double> poison, double %8, i32 0, !llfi_index !4754
  %fi2 = call <2 x double> @injectFault0(i64 4695, <2 x double> %67, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %68 = shufflevector <2 x double> %fi2, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !4755
  %fi3 = call <2 x double> @injectFault0(i64 4696, <2 x double> %68, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %69 = insertelement <2 x double> poison, double %6, i32 0, !llfi_index !4756
  %fi4 = call <2 x double> @injectFault0(i64 4697, <2 x double> %69, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %70 = shufflevector <2 x double> %fi4, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !4757
  %fi5 = call <2 x double> @injectFault0(i64 4698, <2 x double> %70, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  br label %71, !llfi_index !4758

71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi26, %106 ], !llfi_index !4759
  %fi6 = call i64 @injectFault1(i64 4700, i64 %72, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %73 = getelementptr double, double* %1, i64 %fi6, !llfi_index !4760
  %fi7 = call double* @injectFault2(i64 4701, double* %73, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %74 = bitcast double* %fi7 to <2 x double>*, !llfi_index !4761
  %fi8 = call <2 x double>* @injectFault3(i64 4702, <2 x double>* %74, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %75 = load <2 x double>, <2 x double>* %fi8, align 8, !tbaa !345, !alias.scope !4762, !llfi_index !4765
  %fi9 = call <2 x double> @injectFault0(i64 4703, <2 x double> %75, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %76 = getelementptr double, double* %3, i64 %fi6, !llfi_index !4766
  %fi10 = call double* @injectFault2(i64 4704, double* %76, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %77 = bitcast double* %fi10 to <2 x double>*, !llfi_index !4767
  %fi11 = call <2 x double>* @injectFault3(i64 4705, <2 x double>* %77, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %78 = load <2 x double>, <2 x double>* %fi11, align 8, !tbaa !345, !alias.scope !4768, !llfi_index !4770
  %fi12 = call <2 x double> @injectFault0(i64 4706, <2 x double> %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %79 = fmul <2 x double> %fi9, %fi12, !llfi_index !4771
  %fi13 = call <2 x double> @injectFault0(i64 4707, <2 x double> %79, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %80 = getelementptr inbounds double, double* %0, i64 %fi6, !llfi_index !4772
  %81 = call <2 x double> @llvm.fabs.v2f64(<2 x double> %fi13), !llfi_index !4773
  %fi14 = call <2 x double> @injectFault0(i64 4709, <2 x double> %81, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %82 = fcmp olt <2 x double> %fi14, %fi1, !llfi_index !4774
  %fi15 = call <2 x i1> @injectFault4(i64 4710, <2 x i1> %82, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %83 = select <2 x i1> %fi15, <2 x double> zeroinitializer, <2 x double> %fi13, !llfi_index !4775
  %fi16 = call <2 x double> @injectFault0(i64 4711, <2 x double> %83, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %84 = bitcast double* %80 to <2 x double>*, !llfi_index !4776
  store <2 x double> %fi16, <2 x double>* %84, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4781
  %85 = getelementptr double, double* %5, i64 %fi6, !llfi_index !4782
  %fi17 = call double* @injectFault2(i64 4714, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %86 = bitcast double* %fi17 to <2 x double>*, !llfi_index !4783
  %fi18 = call <2 x double>* @injectFault3(i64 4715, <2 x double>* %86, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %87 = load <2 x double>, <2 x double>* %fi18, align 8, !tbaa !345, !alias.scope !4784, !llfi_index !4785
  %fi19 = call <2 x double> @injectFault0(i64 4716, <2 x double> %87, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %88 = fcmp ult <2 x double> %fi19, %fi3, !llfi_index !4786
  %fi20 = call <2 x i1> @injectFault4(i64 4717, <2 x i1> %88, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %89 = select <2 x i1> %fi20, <2 x double> %fi16, <2 x double> zeroinitializer, !llfi_index !4787
  %fi21 = call <2 x double> @injectFault0(i64 4718, <2 x double> %89, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %90 = fcmp olt <2 x double> %fi21, %fi5, !llfi_index !4788
  %fi22 = call <2 x i1> @injectFault4(i64 4719, <2 x i1> %90, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %91 = xor <2 x i1> %fi20, <i1 true, i1 true>, !llfi_index !4789
  %fi23 = call <2 x i1> @injectFault4(i64 4720, <2 x i1> %91, i32 30, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @xor_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %92 = or <2 x i1> %fi22, %fi23, !llfi_index !4790
  %fi24 = call <2 x i1> @injectFault4(i64 4721, <2 x i1> %92, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @or_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %93 = extractelement <2 x i1> %fi24, i32 0, !llfi_index !4791
  br i1 %93, label %94, label %98, !llfi_index !4792

94:                                               ; preds = %71
  %95 = extractelement <2 x i1> %fi22, i32 0, !llfi_index !4793
  %96 = extractelement <2 x double> %fi21, i32 0, !llfi_index !4794
...
98:                                               ; preds = %94, %71
  %99 = extractelement <2 x i1> %fi24, i32 1, !llfi_index !4798
  %fi25 = call i1 @injectFault5(i64 4729, i1 %99, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  br i1 %fi25, label %100, label %106, !llfi_index !4799

100:                                              ; preds = %98
  %101 = or i64 %fi6, 1, !llfi_index !4800
  %102 = getelementptr inbounds double, double* %0, i64 %101, !llfi_index !4801
  %103 = extractelement <2 x i1> %fi22, i32 1, !llfi_index !4802
  %104 = extractelement <2 x double> %fi21, i32 1, !llfi_index !4803
...
106:                                              ; preds = %100, %98
  %107 = add nuw i64 %fi6, 2, !llfi_index !4807
  %fi26 = call i64 @injectFault1(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %108 = icmp eq i64 %fi26, %64, !llfi_index !4808
...
define <2 x double>* @injectFault3(i64 %0, <2 x double>* %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
...
define <2 x i1> @injectFault4(i64 %0, <2 x i1> %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
  %tmploc = alloca <2 x i1>, align 2
  store <2 x i1> %1, <2 x i1>* %tmploc, align 2
  %pre_cond = call i1 @preFunc(i64 %0, i32 %2, i32 %3, i32 %4)
  br i1 %pre_cond, label %inject, label %exit

inject:                                           ; preds = %entry
  %tmploc_cast = bitcast <2 x i1>* %tmploc to i8*
  call void @injectFunc(i64 %0, i32 2, i8* %tmploc_cast, i32 %3, i32 %5, i8* %6)
  br label %exit

exit:                                             ; preds = %inject, %entry
  %updateval = load <2 x i1>, <2 x i1>* %tmploc, align 2
  ret <2 x i1> %updateval
}

define i1 @injectFault5(i64 %0, i1 %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
