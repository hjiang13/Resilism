...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3223, double %38, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3263
  %39 = tail call double @llvm.fabs.f64(double %fi) #2, !llfi_index !3264
  %40 = fcmp olt double %39, %1, !llfi_index !3265
  %41 = select i1 %40, double 0.000000e+00, double %fi, !llfi_index !3266
