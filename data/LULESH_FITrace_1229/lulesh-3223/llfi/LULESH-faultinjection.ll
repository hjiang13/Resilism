...
13:                                               ; preds = %13, %11
  ...
  %39 = tail call double @llvm.fabs.f64(double %fi8) #2, !llfi_index !3264
  ...
  %fi9 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3230
