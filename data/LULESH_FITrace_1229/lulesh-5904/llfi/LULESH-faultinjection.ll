...
.loopexit35:                                      ; preds = %138, %121, %.loopexit37
  ...
  %130 = getelementptr inbounds [8 x double], [8 x double]* %fi, i64 0, i64 0, !llfi_index !5988
...
163:                                              ; preds = %163, %154
  ...
  %fi1 = call i64 @injectFault1(i64 5898, i64 %164, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  ...
  %170 = getelementptr [8 x double], [8 x double]* %fi, i64 0, i64 %fi1, !llfi_index !6037
  %fi2 = call double* @injectFault2(i64 5904, double* %170, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  store double %169, double* %fi2, align 8, !tbaa !345, !llfi_index !6038
  ...
  %176 = getelementptr inbounds [8 x double], [8 x double]* %5, i64 0, i64 %fi1, !llfi_index !6045
  store double %175, double* %176, align 8, !tbaa !345, !llfi_index !6046
  %177 = add nuw nsw i64 %fi1, 1, !llfi_index !6047
  %fi3 = call i64 @injectFault1(i64 5914, i64 %177, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5810
