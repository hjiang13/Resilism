...
163:                                              ; preds = %163, %154
  ...
  %170 = getelementptr [8 x double], [8 x double]* %3, i64 0, i64 %164, !llfi_index !6036
  %fi = call double* @injectFault0(i64 5904, double* %170, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !6037
  store double %169, double* %fi, align 8, !tbaa !345, !llfi_index !6038
