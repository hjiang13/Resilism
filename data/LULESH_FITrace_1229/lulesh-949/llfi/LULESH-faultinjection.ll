...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %28 = getelementptr [8 x double], [8 x double]* %0, i64 1, i64 6, !llfi_index !912
  %fi = call double* @injectFault0(i64 895, double* %28, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %29 = bitcast double* %fi to <2 x double>*, !llfi_index !914
  %fi1 = call <2 x double>* @injectFault1(i64 896, <2 x double>* %29, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %30 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !915
  %fi2 = call <2 x double> @injectFault2(i64 897, <2 x double> %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !913
  ...
  %fi3 = call <2 x double> @injectFault2(i64 932, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %62 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !951
  %fi4 = call <2 x double> @injectFault2(i64 933, <2 x double> %62, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !913
  ...
  %74 = fneg <2 x double> %fi2, !llfi_index !966
  %fi5 = call <2 x double> @injectFault2(i64 948, <2 x double> %74, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %75 = fmul <2 x double> %fi4, %fi5, !llfi_index !967
  %fi6 = call <2 x double> @injectFault2(i64 949, <2 x double> %75, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %76 = bitcast double* %73 to <2 x double>*, !llfi_index !968
  store <2 x double> %fi6, <2 x double>* %76, align 8, !tbaa !345, !llfi_index !969
