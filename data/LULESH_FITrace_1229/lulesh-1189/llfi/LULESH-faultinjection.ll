...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %88 = getelementptr double, double* %76, i64 %36, !llfi_index !1209
  %fi = call double* @injectFault0(i64 1189, double* %88, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1210
  %89 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1211
