...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi3 = call double* @injectFault3(i64 1141, double* %52, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  ...
  %58 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1170
  %fi4 = call double* @injectFault3(i64 1149, double* %58, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  %59 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1171
  %fi5 = call double @injectFault4(i64 1150, double %59, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  %60 = getelementptr inbounds double, double* %2, i64 2, !llfi_index !1172
  store double %fi5, double* %60, align 8, !tbaa !345, !llfi_index !1173
  ...
  %82 = getelementptr inbounds double, double* %76, i64 %fi2, !llfi_index !1202
