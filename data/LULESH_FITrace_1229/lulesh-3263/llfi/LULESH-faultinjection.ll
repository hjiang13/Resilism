...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3263, double %31, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3304
  store double %fi, double* %29, align 8, !tbaa !345, !llfi_index !3305
