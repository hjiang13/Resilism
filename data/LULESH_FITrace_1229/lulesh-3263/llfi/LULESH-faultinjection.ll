...
define dso_local void @_Z20CalcPositionForNodesd(double %0) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3236, double* %7, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  ...
  %fi1 = call double* @injectFault0(i64 3237, double* %8, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3277
...
12:                                               ; preds = %12, %10
  %13 = phi i64 [ 0, %10 ], [ %fi9, %12 ], !llfi_index !3284
  %fi2 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %14 = getelementptr inbounds double, double* %3, i64 %fi2, !llfi_index !3285
  %15 = load double, double* %14, align 8, !tbaa !345, !llfi_index !3286
  %16 = fmul double %15, %0, !llfi_index !3287
  %17 = getelementptr inbounds double, double* %4, i64 %fi2, !llfi_index !3288
  ...
  %20 = getelementptr inbounds double, double* %5, i64 %fi2, !llfi_index !3292
  %21 = load double, double* %20, align 8, !tbaa !345, !llfi_index !3293
  %22 = fmul double %21, %0, !llfi_index !3294
  %23 = getelementptr inbounds double, double* %6, i64 %fi2, !llfi_index !3295
  ...
  %26 = getelementptr double, double* %fi, i64 %fi2, !llfi_index !3299
  %fi3 = call double* @injectFault0(i64 3258, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %27 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3300
  %fi4 = call double @injectFault2(i64 3259, double %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %28 = fmul double %fi4, %0, !llfi_index !3301
  %fi5 = call double @injectFault2(i64 3260, double %28, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %29 = getelementptr double, double* %fi1, i64 %fi2, !llfi_index !3302
  %fi6 = call double* @injectFault0(i64 3261, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %30 = load double, double* %fi6, align 8, !tbaa !345, !llfi_index !3303
  %fi7 = call double @injectFault2(i64 3262, double %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %31 = fadd double %fi5, %fi7, !llfi_index !3304
  %fi8 = call double @injectFault2(i64 3263, double %31, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  store double %fi8, double* %fi6, align 8, !tbaa !345, !llfi_index !3305
  %32 = add nuw nsw i64 %fi2, 1, !llfi_index !3306
  %fi9 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %33 = icmp eq i64 %fi9, %11, !llfi_index !3307
