...
163:                                              ; preds = %161, %157
  %164 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 19, i32 0, i32 0, i32 0, i32 0, !llfi_index !204
  %fi = call i32** @injectFault0(i64 195, i32** %164, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !205
  %165 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !206
