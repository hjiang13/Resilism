...
163:                                              ; preds = %163, %154
  ...
  %171 = getelementptr double, double* %128, i64 %167, !llfi_index !6038
  %fi = call double* @injectFault0(i64 5906, double* %171, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !6039
  %172 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !6040
