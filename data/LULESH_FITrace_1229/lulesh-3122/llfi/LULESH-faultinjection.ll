...
12:                                               ; preds = %12, %10
  ...
  %fi3 = call i64 @injectFault1(i64 3139, i64 %30, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %31 = icmp eq i64 %fi3, %11, !llfi_index !3176
