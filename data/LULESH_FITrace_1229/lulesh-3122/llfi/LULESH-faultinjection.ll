...
12:                                               ; preds = %12, %10
  ...
  %16 = getelementptr double, double* %3, i64 %13, !llfi_index !3157
  %fi = call double* @injectFault0(i64 3122, double* %16, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3158
  %17 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3159
  ...
  %22 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3165
  ...
  %27 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3171
