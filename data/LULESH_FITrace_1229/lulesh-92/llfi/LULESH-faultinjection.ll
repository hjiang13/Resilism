...
73:                                               ; preds = %71, %67
  ...
  %fi = call i1 @injectFault0(i64 92, i1 %76, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !100
  br i1 %fi, label %79, label %77, !llfi_index !101
