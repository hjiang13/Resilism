...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi6 = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %52 = insertelement <2 x double> %fi6, double %10, i32 1, !llfi_index !3345
  %fi7 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %53 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %fi8 = call <2 x double> @injectFault0(i64 3304, <2 x double> %53, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %54 = fsub <2 x double> %fi7, %fi8, !llfi_index !3347
  %fi9 = call <2 x double> @injectFault0(i64 3305, <2 x double> %54, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %88 = fsub <2 x double> %87, %fi7, !llfi_index !3381
  ...
  %114 = fmul <2 x double> %fi9, %45, !llfi_index !3408
  ...
  %124 = fmul <2 x double> %fi5, %fi9, !llfi_index !3418
  %fi10 = call <2 x double> @injectFault0(i64 3376, <2 x double> %124, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %125 = fmul <2 x double> %50, %40, !llfi_index !3419
  %126 = fsub <2 x double> %fi10, %125, !llfi_index !3420
