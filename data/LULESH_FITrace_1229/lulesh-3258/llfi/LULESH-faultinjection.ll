...
12:                                               ; preds = %12, %10
  ...
  %26 = getelementptr double, double* %7, i64 %13, !llfi_index !3298
  %fi = call double* @injectFault0(i64 3258, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3299
  %27 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3300
