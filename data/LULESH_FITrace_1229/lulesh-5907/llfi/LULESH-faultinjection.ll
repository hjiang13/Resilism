...
163:                                              ; preds = %163, %154
  ...
  %fi = call double @injectFault0(i64 5907, double %172, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !6040
  %173 = getelementptr inbounds [8 x double], [8 x double]* %4, i64 0, i64 %164, !llfi_index !6041
  store double %fi, double* %173, align 8, !tbaa !345, !llfi_index !6042
