...
.loopexit35:                                      ; preds = %138, %121, %.loopexit37
  ...
  %fi1 = call double* @injectFault1(i64 5854, double* %128, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
163:                                              ; preds = %163, %154
  ...
  %171 = getelementptr double, double* %fi1, i64 %fi8, !llfi_index !6039
  %fi9 = call double* @injectFault1(i64 5906, double* %171, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %172 = load double, double* %fi9, align 8, !tbaa !345, !llfi_index !6040
  %fi10 = call double @injectFault4(i64 5907, double %172, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %173 = getelementptr inbounds [8 x double], [8 x double]* %4, i64 0, i64 %fi5, !llfi_index !6041
  store double %fi10, double* %173, align 8, !tbaa !345, !llfi_index !6042
