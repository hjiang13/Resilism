...
55:                                               ; preds = %53, %49
  ...
  %fi = call double* @injectFault0(i64 70, double* %57, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !78
  %58 = icmp eq double* %fi, null, !llfi_index !79
  br i1 %58, label %61, label %59, !llfi_index !80

59:                                               ; preds = %55
  %60 = bitcast double* %fi to i8*, !llfi_index !81
