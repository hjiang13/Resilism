...
7:                                                ; preds = %122
  ...
  %fi = call double* @injectFault0(i64 768, double* %32, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !785
  %33 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !786
  %fi1 = call double @injectFault1(i64 769, double %33, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !785
  ...
  %95 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !851
  ...
  %98 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !855
