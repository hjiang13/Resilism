...
182:                                              ; preds = %182, %158
  ...
  %fi = call i64 @injectFault0(i64 5926, i64 %186, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !6061
  %187 = getelementptr inbounds double, double* %135, i64 %fi, !llfi_index !6062
