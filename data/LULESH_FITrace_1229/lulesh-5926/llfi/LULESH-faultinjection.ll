...
154:                                              ; preds = %179, %136
  %155 = phi i64 [ 0, %136 ], [ %fi4, %179 ], !llfi_index !6017
...
163:                                              ; preds = %163, %154
  ...
  %165 = getelementptr inbounds i32, i32* %fi3, i64 %164, !llfi_index !6032
...
179:                                              ; preds = %182
  ...
  %fi4 = call i64 @injectFault1(i64 5920, i64 %180, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %181 = icmp eq i64 %fi4, %137, !llfi_index !6055
  br i1 %181, label %.loopexit34, label %154, !llvm.loop !6056, !llfi_index !6057

182:                                              ; preds = %182, %158
  %183 = phi i64 [ 0, %158 ], [ %fi9, %182 ], !llfi_index !6058
  %fi5 = call i64 @injectFault1(i64 5923, i64 %183, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %184 = getelementptr i32, i32* %fi3, i64 %fi5, !llfi_index !6059
  %fi6 = call i32* @injectFault0(i64 5924, i32* %184, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %185 = load i32, i32* %fi6, align 4, !tbaa !404, !llfi_index !6060
  %fi7 = call i32 @injectFault2(i64 5925, i32 %185, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %186 = sext i32 %fi7 to i64, !llfi_index !6061
  %fi8 = call i64 @injectFault1(i64 5926, i64 %186, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %187 = getelementptr inbounds double, double* %135, i64 %fi8, !llfi_index !6062
  ...
  %190 = add nuw nsw i64 %fi5, 1, !llfi_index !6066
  %fi9 = call i64 @injectFault1(i64 5931, i64 %190, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %191 = icmp eq i64 %fi9, 8, !llfi_index !6067
