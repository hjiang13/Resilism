...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %37 = getelementptr [8 x double], [8 x double]* %0, i64 2, i64 4, !llfi_index !921
  %fi2 = call double* @injectFault1(i64 904, double* %37, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %38 = bitcast double* %fi2 to <2 x double>*, !llfi_index !923
  %fi3 = call <2 x double>* @injectFault2(i64 905, <2 x double>* %38, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %39 = load <2 x double>, <2 x double>* %fi3, align 8, !tbaa !345, !llfi_index !924
  %fi4 = call <2 x double> @injectFault0(i64 906, <2 x double> %39, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !922
  ...
  %fi5 = call <2 x double> @injectFault0(i64 953, <2 x double> %78, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %79 = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !972
  %fi6 = call <2 x double> @injectFault0(i64 954, <2 x double> %79, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %80 = fmul <2 x double> %fi6, %77, !llfi_index !973
  ...
  %84 = fmul <2 x double> %fi6, %83, !llfi_index !978
  ...
  %87 = fneg <2 x double> %fi4, !llfi_index !982
  %fi = call <2 x double> @injectFault0(i64 964, <2 x double> %87, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %88 = fmul <2 x double> %fi6, %fi, !llfi_index !983
  %fi1 = call <2 x double> @injectFault0(i64 965, <2 x double> %88, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !922
  %89 = bitcast double* %86 to <2 x double>*, !llfi_index !984
  store <2 x double> %fi1, <2 x double>* %89, align 8, !tbaa !345, !llfi_index !985
  %90 = getelementptr inbounds double, double* %6, i64 6, !llfi_index !986
  %91 = fneg <2 x double> %42, !llfi_index !987
  %92 = fmul <2 x double> %fi6, %91, !llfi_index !988
