...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %fi = call <2 x double> @injectFault0(i64 965, <2 x double> %88, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !983
  %89 = bitcast double* %86 to <2 x double>*, !llfi_index !984
  store <2 x double> %fi, <2 x double>* %89, align 8, !tbaa !345, !llfi_index !985
