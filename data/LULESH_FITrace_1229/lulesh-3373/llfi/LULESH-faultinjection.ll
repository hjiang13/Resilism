...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3282, <2 x double> %31, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %32 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3325
  %fi1 = call <2 x double> @injectFault0(i64 3283, <2 x double> %32, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %33 = insertelement <2 x double> poison, double %1, i32 0, !llfi_index !3326
  %fi2 = call <2 x double> @injectFault0(i64 3284, <2 x double> %33, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %34 = insertelement <2 x double> %fi2, double %3, i32 1, !llfi_index !3327
  %fi3 = call <2 x double> @injectFault0(i64 3285, <2 x double> %34, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %35 = fsub <2 x double> %fi1, %fi3, !llfi_index !3328
  %fi4 = call <2 x double> @injectFault0(i64 3286, <2 x double> %35, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  ...
  %fi5 = call <2 x double> @injectFault0(i64 3289, <2 x double> %38, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %39 = insertelement <2 x double> %fi5, double %11, i32 1, !llfi_index !3332
  %fi6 = call <2 x double> @injectFault0(i64 3290, <2 x double> %39, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %40 = fsub <2 x double> %37, %fi6, !llfi_index !3333
  %41 = insertelement <2 x double> poison, double %22, i32 0, !llfi_index !3334
  %fi7 = call <2 x double> @injectFault0(i64 3292, <2 x double> %41, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %42 = shufflevector <2 x double> %fi7, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3335
  %fi8 = call <2 x double> @injectFault0(i64 3293, <2 x double> %42, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %43 = insertelement <2 x double> poison, double %17, i32 0, !llfi_index !3336
  %fi9 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %44 = insertelement <2 x double> %fi9, double %19, i32 1, !llfi_index !3337
  %fi10 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %45 = fsub <2 x double> %fi8, %fi10, !llfi_index !3338
  %fi11 = call <2 x double> @injectFault0(i64 3296, <2 x double> %45, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %46 = insertelement <2 x double> poison, double %5, i32 0, !llfi_index !3339
  %fi12 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %47 = insertelement <2 x double> %fi12, double %2, i32 1, !llfi_index !3340
  %fi13 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi14 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %49 = shufflevector <2 x double> %fi14, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi15 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %50 = fsub <2 x double> %fi13, %fi15, !llfi_index !3343
  %fi16 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %51 = insertelement <2 x double> poison, double %13, i32 0, !llfi_index !3344
  %fi17 = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %52 = insertelement <2 x double> %fi17, double %10, i32 1, !llfi_index !3345
  %fi18 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %53 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %54 = fsub <2 x double> %fi18, %53, !llfi_index !3347
  %55 = insertelement <2 x double> poison, double %21, i32 0, !llfi_index !3348
  %fi19 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %56 = insertelement <2 x double> %fi19, double %18, i32 1, !llfi_index !3349
  %fi20 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %57 = insertelement <2 x double> poison, double %16, i32 0, !llfi_index !3350
  %fi21 = call <2 x double> @injectFault0(i64 3308, <2 x double> %57, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %58 = shufflevector <2 x double> %fi21, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3351
  %fi22 = call <2 x double> @injectFault0(i64 3309, <2 x double> %58, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %59 = fsub <2 x double> %fi20, %fi22, !llfi_index !3352
  %fi23 = call <2 x double> @injectFault0(i64 3310, <2 x double> %59, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %60 = insertelement <2 x double> %fi, double %14, i32 1, !llfi_index !3353
  ...
  %77 = fsub <2 x double> %fi3, %76, !llfi_index !3370
  %78 = insertelement <2 x double> poison, double %12, i32 0, !llfi_index !3371
  %fi24 = call <2 x double> @injectFault0(i64 3329, <2 x double> %78, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %79 = insertelement <2 x double> %fi24, double %9, i32 1, !llfi_index !3372
  %fi25 = call <2 x double> @injectFault0(i64 3330, <2 x double> %79, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %80 = fsub <2 x double> %fi6, %fi25, !llfi_index !3373
  %fi26 = call <2 x double> @injectFault0(i64 3331, <2 x double> %80, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %81 = insertelement <2 x double> %66, double %17, i32 1, !llfi_index !3374
  %82 = fsub <2 x double> %fi10, %81, !llfi_index !3375
  ...
  %85 = fsub <2 x double> %84, %fi13, !llfi_index !3378
  %86 = insertelement <2 x double> poison, double %10, i32 0, !llfi_index !3379
  %fi27 = call <2 x double> @injectFault0(i64 3337, <2 x double> %86, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %87 = insertelement <2 x double> %fi27, double %15, i32 1, !llfi_index !3380
  %fi28 = call <2 x double> @injectFault0(i64 3338, <2 x double> %87, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %88 = fsub <2 x double> %fi28, %fi18, !llfi_index !3381
  %fi29 = call <2 x double> @injectFault0(i64 3339, <2 x double> %88, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  ...
  %113 = fmul <2 x double> %40, %fi23, !llfi_index !3407
  %114 = fmul <2 x double> %54, %fi11, !llfi_index !3408
  %115 = fsub <2 x double> %113, %114, !llfi_index !3409
  %116 = fmul <2 x double> %112, %115, !llfi_index !3410
  %117 = fadd <2 x double> %fi26, %fi29, !llfi_index !3411
  %fi30 = call <2 x double> @injectFault0(i64 3369, <2 x double> %117, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %118 = fmul <2 x double> %fi16, %fi11, !llfi_index !3412
  %fi31 = call <2 x double> @injectFault0(i64 3370, <2 x double> %118, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %119 = fmul <2 x double> %fi4, %fi23, !llfi_index !3413
  %fi32 = call <2 x double> @injectFault0(i64 3371, <2 x double> %119, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %120 = fsub <2 x double> %fi31, %fi32, !llfi_index !3414
  %fi33 = call <2 x double> @injectFault0(i64 3372, <2 x double> %120, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %121 = fmul <2 x double> %fi30, %fi33, !llfi_index !3415
  %fi34 = call <2 x double> @injectFault0(i64 3373, <2 x double> %121, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %122 = fadd <2 x double> %116, %fi34, !llfi_index !3416
  %123 = fadd <2 x double> %82, %91, !llfi_index !3417
  %124 = fmul <2 x double> %fi4, %54, !llfi_index !3418
  %125 = fmul <2 x double> %fi16, %40, !llfi_index !3419
