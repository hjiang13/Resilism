...
169:                                              ; preds = %167, %163
  %170 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 18, i32 0, i32 0, i32 0, i32 0, !llfi_index !211
  %fi = call i32** @injectFault0(i64 202, i32** %170, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !212
  %171 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !213
