...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %39 = getelementptr double, double* %2, i64 3, !llfi_index !3463
  %fi = call double* @injectFault0(i64 3422, double* %39, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3464
  %40 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3465
  %fi1 = call double @injectFault1(i64 3423, double %40, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3464
