...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3221, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3261
  %37 = fmul double %fi, %0, !llfi_index !3262
