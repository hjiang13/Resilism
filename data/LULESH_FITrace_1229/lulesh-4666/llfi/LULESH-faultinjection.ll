...
32:                                               ; preds = %32, %30
  %33 = phi i64 [ 0, %30 ], [ %fi3, %32 ], !llfi_index !4705
  ...
  %41 = getelementptr double, double* %2, i64 %fi, !llfi_index !4722
  %fi1 = call double* @injectFault1(i64 4665, double* %41, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %42 = bitcast double* %fi1 to <2 x double>*, !llfi_index !4723
  %fi2 = call <2 x double>* @injectFault2(i64 4666, <2 x double>* %42, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  store <2 x double> <double 0x3FE5555555555555, double 0x3FE5555555555555>, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4724, !noalias !4709, !llfi_index !4725
  %43 = add nuw i64 %fi, 2, !llfi_index !4726
  %fi3 = call i64 @injectFault0(i64 4668, i64 %43, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %44 = icmp eq i64 %fi3, %31, !llfi_index !4727
