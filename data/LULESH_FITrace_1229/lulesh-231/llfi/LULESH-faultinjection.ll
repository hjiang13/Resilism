...
193:                                              ; preds = %191, %187
  ...
  %fi = call i32* @injectFault0(i64 231, i32* %195, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !241
  %196 = icmp eq i32* %fi, null, !llfi_index !242
  br i1 %196, label %199, label %197, !llfi_index !243

197:                                              ; preds = %193
  %198 = bitcast i32* %fi to i8*, !llfi_index !244
