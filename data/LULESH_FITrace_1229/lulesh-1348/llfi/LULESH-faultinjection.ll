...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %41 = getelementptr double, double* %5, i64 7, !llfi_index !1324
  %fi = call double* @injectFault0(i64 1304, double* %41, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1325
  %42 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1326
  ...
  %60 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1345
  ...
  %83 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1369
  %fi1 = call double @injectFault1(i64 1348, double %83, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1325
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %67, double %68, double %69, double %70, double %71, double %72, double %73, double %74, double %75, double %76, double %77, double %78, double %79, double %80, double %81, double %82, double %fi1, double %84, double* nonnull %85, double* nonnull %86, double* nonnull %87), !llfi_index !1374
  ...
  %121 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1409
  ...
  %143 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1432
  ...
  %165 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1455
