...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi12 = call double @injectFault0(i64 3344, double %93, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %shift = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> <i32 1, i32 undef>, !llfi_index !3387
  %fi13 = call <2 x double> @injectFault1(i64 3345, <2 x double> %shift, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %94 = fmul <2 x double> %fi10, %fi13, !llfi_index !3388
  %fi14 = call <2 x double> @injectFault1(i64 3346, <2 x double> %94, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %95 = extractelement <2 x double> %fi14, i32 0, !llfi_index !3389
  %fi15 = call double @injectFault0(i64 3347, double %95, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %96 = fsub double %fi12, %fi15, !llfi_index !3390
  %fi16 = call double @injectFault0(i64 3348, double %96, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %97 = fmul double %92, %fi16, !llfi_index !3391
