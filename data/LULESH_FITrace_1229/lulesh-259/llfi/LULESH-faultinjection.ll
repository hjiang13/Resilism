...
217:                                              ; preds = %215, %211
  ...
  %fi = call double* @injectFault0(i64 259, double* %219, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !269
  %220 = icmp eq double* %fi, null, !llfi_index !270
  br i1 %220, label %223, label %221, !llfi_index !271

221:                                              ; preds = %217
  %222 = bitcast double* %fi to i8*, !llfi_index !272
