...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1292, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1313
  %30 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1314
  ...
  %53 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1338
  ...
  %77 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1363
  ...
  %115 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1403
  ...
  %137 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1426
  ...
  %159 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1449
  %fi = call double @injectFault0(i64 1428, double %159, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1313
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %151, double %152, double %153, double %154, double %155, double %156, double %157, double %158, double %fi, double %160, double %161, double %162, double %163, double %164, double %165, double %166, double %167, double %168, double* nonnull %169, double* nonnull %170, double* nonnull %171), !llfi_index !1462
