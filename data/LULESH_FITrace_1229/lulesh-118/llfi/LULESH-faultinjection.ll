...
97:                                               ; preds = %95, %91
  %98 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 30, i32 0, i32 0, i32 0, i32 0, !llfi_index !125
  %fi = call double** @injectFault0(i64 118, double** %98, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !126
  %99 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !127
