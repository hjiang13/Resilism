...
12:                                               ; preds = %12, %10
  ...
  %29 = getelementptr double, double* %8, i64 %13, !llfi_index !3172
  %fi = call double* @injectFault0(i64 3137, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3173
  store double %28, double* %fi, align 8, !tbaa !345, !llfi_index !3174
