...
37:                                               ; preds = %35, %31
  ...
  %fi = call double* @injectFault0(i64 49, double* %39, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !57
  %40 = icmp eq double* %fi, null, !llfi_index !58
  br i1 %40, label %43, label %41, !llfi_index !59

41:                                               ; preds = %37
  %42 = bitcast double* %fi to i8*, !llfi_index !60
