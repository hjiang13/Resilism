...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3292, <2 x double> %41, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %42 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3335
  %fi1 = call <2 x double> @injectFault0(i64 3293, <2 x double> %42, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %43 = insertelement <2 x double> poison, double %17, i32 0, !llfi_index !3336
  %fi2 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %44 = insertelement <2 x double> %fi2, double %19, i32 1, !llfi_index !3337
  %fi3 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %45 = fsub <2 x double> %fi1, %fi3, !llfi_index !3338
  %fi4 = call <2 x double> @injectFault0(i64 3296, <2 x double> %45, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %46 = insertelement <2 x double> poison, double %5, i32 0, !llfi_index !3339
  %fi5 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %47 = insertelement <2 x double> %fi5, double %2, i32 1, !llfi_index !3340
  %fi6 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi7 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %49 = shufflevector <2 x double> %fi7, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi8 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %50 = fsub <2 x double> %fi6, %fi8, !llfi_index !3343
  %fi9 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  ...
  %82 = fsub <2 x double> %fi3, %81, !llfi_index !3375
  ...
  %85 = fsub <2 x double> %84, %fi6, !llfi_index !3378
  ...
  %114 = fmul <2 x double> %54, %fi4, !llfi_index !3408
  ...
  %118 = fmul <2 x double> %fi9, %fi4, !llfi_index !3412
  %fi10 = call <2 x double> @injectFault0(i64 3370, <2 x double> %118, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3334
  %119 = fmul <2 x double> %35, %59, !llfi_index !3413
  %120 = fsub <2 x double> %fi10, %119, !llfi_index !3414
  ...
  %125 = fmul <2 x double> %fi9, %40, !llfi_index !3419
