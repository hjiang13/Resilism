...
187:                                              ; preds = %185, %181
  ...
  %fi = call i32* @injectFault0(i64 224, i32* %189, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !234
  %190 = icmp eq i32* %fi, null, !llfi_index !235
  br i1 %190, label %193, label %191, !llfi_index !236

191:                                              ; preds = %187
  %192 = bitcast i32* %fi to i8*, !llfi_index !237
