...
41:                                               ; preds = %52
  ...
  %fi = call double @injectFault0(i64 1033, double %48, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1051
  call void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nonnull %23, double %44, double %46, double %fi, double* nonnull %27, double* nonnull %28, double* nonnull %29), !llfi_index !1052
