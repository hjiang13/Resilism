...
41:                                               ; preds = %52
  ...
  %47 = getelementptr double, double* %3, i64 %fi1, !llfi_index !1050
  %fi2 = call double* @injectFault1(i64 1032, double* %47, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  %48 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1051
  %fi3 = call double @injectFault2(i64 1033, double %48, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  call void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nonnull %23, double %44, double %46, double %fi3, double* nonnull %27, double* nonnull %28, double* nonnull %29), !llfi_index !1052
