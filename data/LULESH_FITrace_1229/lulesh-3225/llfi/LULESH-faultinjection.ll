...
13:                                               ; preds = %13, %11
  ...
  store double %41, double* %fi3, align 8, !tbaa !345, !llfi_index !3267
  %42 = add nuw nsw i64 %fi2, 1, !llfi_index !3268
  %fi11 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3230
