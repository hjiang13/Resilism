...
169:                                              ; preds = %167, %163
  ...
  %fi = call i32* @injectFault0(i64 203, i32* %171, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !213
  %172 = icmp eq i32* %fi, null, !llfi_index !214
  br i1 %172, label %175, label %173, !llfi_index !215

173:                                              ; preds = %169
  %174 = bitcast i32* %fi to i8*, !llfi_index !216
