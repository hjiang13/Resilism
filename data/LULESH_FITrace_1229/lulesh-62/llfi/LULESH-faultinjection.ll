...
49:                                               ; preds = %47, %43
  %50 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 38, i32 0, i32 0, i32 0, i32 0, !llfi_index !69
  %fi = call double** @injectFault0(i64 62, double** %50, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !70
  %51 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !71
