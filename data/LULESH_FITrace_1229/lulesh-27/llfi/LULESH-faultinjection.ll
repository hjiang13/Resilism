...
19:                                               ; preds = %17, %13
  %20 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 43, i32 0, i32 0, i32 0, i32 0, !llfi_index !34
  %fi = call double** @injectFault0(i64 27, double** %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !35
  %21 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !36
