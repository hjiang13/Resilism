...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1489
  %fi3 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %21 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1491
  %fi4 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  ...
  %59 = fmul double %fi4, %58, !llfi_index !1529
  ...
  %fi = call double* @injectFault0(i64 1568, double* %119, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %120 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1590
  %fi1 = call double @injectFault1(i64 1569, double %120, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %121 = fmul double %fi4, %fi1, !llfi_index !1591
  %fi2 = call double @injectFault1(i64 1570, double %121, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %122 = fadd double %118, %fi2, !llfi_index !1592
  ...
  %163 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1634
  ...
  %332 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1810
  ...
  %369 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1848
  ...
  %538 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2024
  ...
  %575 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2062
