...
151:                                              ; preds = %149, %145
  ...
  %fi = call i1 @injectFault0(i64 183, i1 %154, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !193
  br i1 %fi, label %157, label %155, !llfi_index !194
