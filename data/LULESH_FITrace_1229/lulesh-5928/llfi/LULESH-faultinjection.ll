...
182:                                              ; preds = %182, %158
  ...
  %fi = call double @injectFault0(i64 5928, double %188, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !6063
  %189 = fadd double %162, %fi, !llfi_index !6064
