...
.loopexit35:                                      ; preds = %138, %121, %.loopexit37
  ...
  %fi4 = call i32* @injectFault3(i64 5852, i32* %126, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  ...
  %fi5 = call double* @injectFault1(i64 5861, double* %135, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
154:                                              ; preds = %179, %136
  %155 = phi i64 [ 0, %136 ], [ %fi9, %179 ], !llfi_index !6017
  %fi6 = call i64 @injectFault0(i64 5884, i64 %155, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  ...
  %156 = shl nsw i64 %fi6, 3, !llfi_index !6021
  %fi7 = call i64 @injectFault0(i64 5888, i64 %156, i32 25, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %157 = getelementptr i32, i32* %fi4, i64 %fi7, !llfi_index !6022
  %fi8 = call i32* @injectFault3(i64 5889, i32* %157, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
158:                                              ; preds = %163
  ...
  %160 = getelementptr inbounds double, double* %133, i64 %fi6, !llfi_index !6025
  store double %159, double* %160, align 8, !tbaa !345, !llfi_index !6026
  %161 = getelementptr inbounds double, double* %134, i64 %fi6, !llfi_index !6027
...
163:                                              ; preds = %163, %154
  ...
  %165 = getelementptr inbounds i32, i32* %fi8, i64 %164, !llfi_index !6032
...
179:                                              ; preds = %182
  ...
  %180 = add nuw nsw i64 %fi6, 1, !llfi_index !6054
  %fi9 = call i64 @injectFault0(i64 5920, i64 %180, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %181 = icmp eq i64 %fi9, %137, !llfi_index !6055
  br i1 %181, label %.loopexit34, label %154, !llvm.loop !6056, !llfi_index !6057

182:                                              ; preds = %182, %158
  %183 = phi i64 [ 0, %158 ], [ %fi3, %182 ], !llfi_index !6058
  %fi10 = call i64 @injectFault0(i64 5923, i64 %183, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %184 = getelementptr i32, i32* %fi8, i64 %fi10, !llfi_index !6059
  %fi11 = call i32* @injectFault3(i64 5924, i32* %184, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %185 = load i32, i32* %fi11, align 4, !tbaa !404, !llfi_index !6060
  %fi12 = call i32 @injectFault4(i64 5925, i32 %185, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %186 = sext i32 %fi12 to i64, !llfi_index !6061
  %fi = call i64 @injectFault0(i64 5926, i64 %186, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %187 = getelementptr double, double* %fi5, i64 %fi, !llfi_index !6062
  %fi1 = call double* @injectFault1(i64 5927, double* %187, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %188 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !6063
  %fi2 = call double @injectFault2(i64 5928, double %188, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %189 = fadd double %162, %fi2, !llfi_index !6064
  store double %189, double* %fi1, align 8, !tbaa !345, !llfi_index !6065
  %190 = add nuw nsw i64 %fi10, 1, !llfi_index !6066
  %fi3 = call i64 @injectFault0(i64 5931, i64 %190, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %191 = icmp eq i64 %fi3, 8, !llfi_index !6067
...
define i32 @injectFault4(i64 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
