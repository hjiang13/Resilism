...
71:                                               ; preds = %106, %63
  ...
  %fi1 = call double* @injectFault1(i64 4704, double* %76, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %77 = bitcast double* %fi1 to <2 x double>*, !llfi_index !4767
  %fi2 = call <2 x double>* @injectFault2(i64 4705, <2 x double>* %77, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %78 = load <2 x double>, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4768, !llfi_index !4770
  %fi3 = call <2 x double> @injectFault3(i64 4706, <2 x double> %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %79 = fmul <2 x double> %75, %fi3, !llfi_index !4771
