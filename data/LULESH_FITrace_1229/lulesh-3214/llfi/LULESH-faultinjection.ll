...
13:                                               ; preds = %13, %11
  ...
  %30 = call double @llvm.fabs.f64(double %29) #2, !llfi_index !3253
  %fi = call double @injectFault0(i64 3214, double %30, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !3254
  %31 = fcmp olt double %fi, %1, !llfi_index !3255
