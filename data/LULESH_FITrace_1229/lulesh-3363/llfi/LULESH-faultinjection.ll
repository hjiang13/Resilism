...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi7 = call <2 x double> @injectFault1(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %56 = insertelement <2 x double> %fi7, double %18, i32 1, !llfi_index !3349
  ...
  %fi8 = call <2 x double> @injectFault1(i64 3311, <2 x double> %60, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %61 = insertelement <2 x double> poison, double %4, i32 0, !llfi_index !3354
  %fi9 = call <2 x double> @injectFault1(i64 3312, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %62 = insertelement <2 x double> %fi9, double %12, i32 1, !llfi_index !3355
  %fi10 = call <2 x double> @injectFault1(i64 3313, <2 x double> %62, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %63 = fsub <2 x double> %fi8, %fi10, !llfi_index !3356
  %fi11 = call <2 x double> @injectFault1(i64 3314, <2 x double> %63, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %64 = fsub double %22, %20, !llfi_index !3357
  %fi12 = call double @injectFault0(i64 3315, double %64, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %65 = fsub double %12, %11, !llfi_index !3358
  %fi13 = call double @injectFault0(i64 3316, double %65, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %66 = insertelement <2 x double> poison, double %20, i32 0, !llfi_index !3359
  %fi14 = call <2 x double> @injectFault1(i64 3317, <2 x double> %66, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %67 = insertelement <2 x double> %fi14, double %4, i32 1, !llfi_index !3360
  %fi15 = call <2 x double> @injectFault1(i64 3318, <2 x double> %67, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %68 = insertelement <2 x double> poison, double %19, i32 0, !llfi_index !3361
  %fi16 = call <2 x double> @injectFault1(i64 3319, <2 x double> %68, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %69 = insertelement <2 x double> %fi16, double %3, i32 1, !llfi_index !3362
  %fi17 = call <2 x double> @injectFault1(i64 3320, <2 x double> %69, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %70 = fsub <2 x double> %fi15, %fi17, !llfi_index !3363
  %fi18 = call <2 x double> @injectFault1(i64 3321, <2 x double> %70, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %71 = fsub double %13, %15, !llfi_index !3364
  %fi19 = call double @injectFault0(i64 3322, double %71, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %72 = insertelement <2 x double> %fi7, double %5, i32 1, !llfi_index !3365
  %fi20 = call <2 x double> @injectFault1(i64 3323, <2 x double> %72, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %73 = insertelement <2 x double> poison, double %23, i32 0, !llfi_index !3366
  %fi21 = call <2 x double> @injectFault1(i64 3324, <2 x double> %73, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %74 = insertelement <2 x double> %fi21, double %7, i32 1, !llfi_index !3367
  %fi22 = call <2 x double> @injectFault1(i64 3325, <2 x double> %74, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %75 = fsub <2 x double> %fi20, %fi22, !llfi_index !3368
  %fi23 = call <2 x double> @injectFault1(i64 3326, <2 x double> %75, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %76 = insertelement <2 x double> %fi9, double %1, i32 1, !llfi_index !3369
  ...
  %81 = insertelement <2 x double> %fi14, double %17, i32 1, !llfi_index !3374
  ...
  %92 = fadd double %fi13, %fi19, !llfi_index !3385
  %fi24 = call double @injectFault0(i64 3343, double %92, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %93 = fmul double %fi, %fi12, !llfi_index !3386
  %fi25 = call double @injectFault0(i64 3344, double %93, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %shift = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> <i32 1, i32 undef>, !llfi_index !3387
  %fi26 = call <2 x double> @injectFault1(i64 3345, <2 x double> %shift, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %94 = fmul <2 x double> %fi11, %fi26, !llfi_index !3388
  %fi27 = call <2 x double> @injectFault1(i64 3346, <2 x double> %94, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %95 = extractelement <2 x double> %fi27, i32 0, !llfi_index !3389
  %fi28 = call double @injectFault0(i64 3347, double %95, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %96 = fsub double %fi25, %fi28, !llfi_index !3390
  %fi29 = call double @injectFault0(i64 3348, double %96, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %97 = fmul double %fi24, %fi29, !llfi_index !3391
  %fi30 = call double @injectFault0(i64 3349, double %97, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %98 = fadd <2 x double> %fi18, %fi23, !llfi_index !3392
  %fi31 = call <2 x double> @injectFault1(i64 3350, <2 x double> %98, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %99 = fmul <2 x double> %fi11, %fi5, !llfi_index !3393
  %fi32 = call <2 x double> @injectFault1(i64 3351, <2 x double> %99, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %100 = insertelement <2 x double> poison, double %fi, i32 0, !llfi_index !3394
  %fi33 = call <2 x double> @injectFault1(i64 3352, <2 x double> %100, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %101 = shufflevector <2 x double> %fi33, <2 x double> %fi5, <2 x i32> <i32 0, i32 2>, !llfi_index !3395
  %fi34 = call <2 x double> @injectFault1(i64 3353, <2 x double> %101, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %102 = extractelement <2 x double> %fi11, i32 1, !llfi_index !3396
  %fi35 = call double @injectFault0(i64 3354, double %102, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %103 = insertelement <2 x double> poison, double %fi35, i32 0, !llfi_index !3397
  %fi36 = call <2 x double> @injectFault1(i64 3355, <2 x double> %103, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %104 = insertelement <2 x double> %fi36, double %fi12, i32 1, !llfi_index !3398
  %fi37 = call <2 x double> @injectFault1(i64 3356, <2 x double> %104, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %105 = fmul <2 x double> %fi34, %fi37, !llfi_index !3399
  %fi38 = call <2 x double> @injectFault1(i64 3357, <2 x double> %105, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %106 = fsub <2 x double> %fi32, %fi38, !llfi_index !3400
  %fi39 = call <2 x double> @injectFault1(i64 3358, <2 x double> %106, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %107 = fmul <2 x double> %fi39, %fi31, !llfi_index !3401
  %fi40 = call <2 x double> @injectFault1(i64 3359, <2 x double> %107, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %108 = extractelement <2 x double> %fi40, i32 1, !llfi_index !3402
  %fi41 = call double @injectFault0(i64 3360, double %108, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %109 = fadd double %fi41, %fi30, !llfi_index !3403
  %fi42 = call double @injectFault0(i64 3361, double %109, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %110 = extractelement <2 x double> %fi40, i32 0, !llfi_index !3404
  %fi43 = call double @injectFault0(i64 3362, double %110, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %111 = fadd double %fi43, %fi42, !llfi_index !3405
  %fi44 = call double @injectFault0(i64 3363, double %111, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  ...
  %130 = fadd double %fi44, %129, !llfi_index !3424
