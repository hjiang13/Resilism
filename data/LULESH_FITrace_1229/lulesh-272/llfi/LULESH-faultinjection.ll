...
229:                                              ; preds = %227, %223
  %230 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 8, i32 0, i32 0, i32 0, i32 0, !llfi_index !281
  %fi = call double** @injectFault0(i64 272, double** %230, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !282
  %231 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !283
