...
41:                                               ; preds = %52
  ...
  %43 = getelementptr inbounds double, double* %1, i64 %fi1, !llfi_index !1046
  %44 = load double, double* %43, align 8, !tbaa !345, !llfi_index !1047
  %45 = getelementptr double, double* %2, i64 %fi1, !llfi_index !1048
  %fi2 = call double* @injectFault1(i64 1030, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  %46 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1049
  %fi3 = call double @injectFault2(i64 1031, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  ...
  call void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nonnull %23, double %44, double %fi3, double %48, double* nonnull %27, double* nonnull %28, double* nonnull %29), !llfi_index !1052
