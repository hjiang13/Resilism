...
33:                                               ; preds = %68, %31
  ...
  %fi = call double* @injectFault0(i64 1022, double* %39, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1040
...
52:                                               ; preds = %52, %33
  ...
  %60 = getelementptr inbounds double, double* %fi, i64 %56, !llfi_index !1065
