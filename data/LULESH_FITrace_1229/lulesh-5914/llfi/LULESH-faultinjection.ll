...
163:                                              ; preds = %163, %154
  %164 = phi i64 [ 0, %154 ], [ %fi, %163 ], !llfi_index !6030
  ...
  %fi = call i64 @injectFault0(i64 5914, i64 %177, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !6047
  %178 = icmp eq i64 %fi, 8, !llfi_index !6048
