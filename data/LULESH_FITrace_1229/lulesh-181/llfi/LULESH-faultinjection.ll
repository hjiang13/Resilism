...
151:                                              ; preds = %149, %145
  %152 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 21, i32 0, i32 0, i32 0, i32 0, !llfi_index !190
  %fi = call i32** @injectFault0(i64 181, i32** %152, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !191
  %153 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !192
