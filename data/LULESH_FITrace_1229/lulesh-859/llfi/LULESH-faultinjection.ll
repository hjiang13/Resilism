...
7:                                                ; preds = %122
  ...
  %75 = getelementptr double, double* %5, i64 6, !llfi_index !829
  %fi = call double* @injectFault0(i64 813, double* %75, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !830
  %76 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !831
  ...
  %88 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !844
  ...
  %118 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !876
  %fi1 = call double @injectFault1(i64 859, double %118, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !830
