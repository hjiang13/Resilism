...
7:                                                ; preds = %122
  ...
  %fi1 = call double* @injectFault1(i64 764, double* %28, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !781
  %29 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !782
  ...
  %78 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !833
  %fi = call double @injectFault0(i64 816, double %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !781
  %79 = load double, double* %30, align 8, !tbaa !345, !llfi_index !834
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %8, double* nonnull %9, double* nonnull %10, double* nonnull %41, double* nonnull %42, double* nonnull %43, double* nonnull %62, double* nonnull %63, double* nonnull %64, double* nonnull %11, double* nonnull %12, double* nonnull %13, double %65, double %66, double %67, double %68, double %69, double %70, double %72, double %74, double %76, double %77, double %fi, double %79), !llfi_index !835
  ...
  %84 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !840
