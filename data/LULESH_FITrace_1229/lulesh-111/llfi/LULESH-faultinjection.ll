...
91:                                               ; preds = %89, %85
  %92 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 31, i32 0, i32 0, i32 0, i32 0, !llfi_index !118
  %fi = call double** @injectFault0(i64 111, double** %92, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !119
  %93 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !120
