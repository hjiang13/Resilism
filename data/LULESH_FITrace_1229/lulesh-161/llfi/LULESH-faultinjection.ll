...
133:                                              ; preds = %131, %127
  ...
  %fi = call i32* @injectFault0(i64 161, i32* %135, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !171
  %136 = icmp eq i32* %fi, null, !llfi_index !172
  br i1 %136, label %139, label %137, !llfi_index !173

137:                                              ; preds = %133
  %138 = bitcast i32* %fi to i8*, !llfi_index !174
