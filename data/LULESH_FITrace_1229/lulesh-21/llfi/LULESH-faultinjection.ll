...
13:                                               ; preds = %11, %7
  ...
  %fi = call double* @injectFault0(i64 21, double* %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !29
  %16 = icmp eq double* %fi, null, !llfi_index !30
  br i1 %16, label %19, label %17, !llfi_index !31

17:                                               ; preds = %13
  %18 = bitcast double* %fi to i8*, !llfi_index !32
