...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %70 = getelementptr inbounds double, double* %52, i64 %fi2, !llfi_index !1186
  ...
  %fi3 = call double* @injectFault3(i64 1173, double* %76, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  ...
  %94 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1218
  %fi4 = call double* @injectFault3(i64 1197, double* %94, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %95 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1219
  %fi5 = call double @injectFault4(i64 1198, double %95, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %96 = getelementptr inbounds double, double* %3, i64 6, !llfi_index !1220
  store double %fi5, double* %96, align 8, !tbaa !345, !llfi_index !1221
