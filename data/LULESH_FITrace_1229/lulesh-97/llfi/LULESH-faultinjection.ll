...
79:                                               ; preds = %77, %73
  %80 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 33, i32 0, i32 0, i32 0, i32 0, !llfi_index !104
  %fi = call double** @injectFault0(i64 97, double** %80, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !105
  %81 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !106
