...
43:                                               ; preds = %41, %37
  %44 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 39, i32 0, i32 0, i32 0, i32 0, !llfi_index !62
  %fi = call double** @injectFault0(i64 55, double** %44, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !63
  %45 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !64
