...
13:                                               ; preds = %13, %11
  ...
  %fi1 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  ...
  %33 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3258
  %fi2 = call double* @injectFault0(i64 3218, double* %33, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %34 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3259
  %fi3 = call double @injectFault2(i64 3219, double %34, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  ...
  %38 = fadd double %fi3, %37, !llfi_index !3263
  ...
  store double %41, double* %fi2, align 8, !tbaa !345, !llfi_index !3267
  %42 = add nuw nsw i64 %fi1, 1, !llfi_index !3268
  %fi4 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3230
