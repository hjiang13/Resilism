...
define linkonce_odr dso_local void @_ZN4MeshD2Ev(%struct.Mesh* nonnull align 8 dereferenceable(1376) %0) unnamed_addr #3 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
  ...
  %fi = call double* @injectFault0(i64 7, double* %3, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !15
  %4 = icmp eq double* %fi, null, !llfi_index !16
  br i1 %4, label %7, label %5, !llfi_index !17

5:                                                ; preds = %1
  %6 = bitcast double* %fi to i8*, !llfi_index !18
