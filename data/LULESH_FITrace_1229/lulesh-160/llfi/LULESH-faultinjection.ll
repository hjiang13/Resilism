...
133:                                              ; preds = %131, %127
  %134 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 24, i32 0, i32 0, i32 0, i32 0, !llfi_index !167
  %fi = call i32** @injectFault0(i64 160, i32** %134, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !168
  %135 = load i32*, i32** %fi, align 8, !tbaa !169, !llfi_index !171
