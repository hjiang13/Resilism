...
235:                                              ; preds = %233, %229
  ...
  %fi = call i1 @injectFault0(i64 281, i1 %238, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !291
  br i1 %fi, label %241, label %239, !llfi_index !292
