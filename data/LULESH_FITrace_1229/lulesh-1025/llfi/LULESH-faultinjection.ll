...
41:                                               ; preds = %52
  %42 = getelementptr double, double* %4, i64 %34, !llfi_index !1042
  %fi = call double* @injectFault0(i64 1025, double* %42, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1043
  call void @_Z32CalcElemShapeFunctionDerivativesPKdS0_S0_PA8_dPd(double* nonnull %20, double* nonnull %21, double* nonnull %22, [8 x double]* nonnull %23, double* %fi), !llfi_index !1044
