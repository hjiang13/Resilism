...
12:                                               ; preds = %12, %10
  ...
  %14 = getelementptr double, double* %2, i64 %13, !llfi_index !3155
  %fi = call double* @injectFault0(i64 3120, double* %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3156
  %15 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3157
