...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %35 = getelementptr double, double* %0, i64 4, !llfi_index !1504
  %fi3 = call double* @injectFault0(i64 1484, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1505
  %36 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1506
  %fi4 = call double @injectFault1(i64 1485, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1505
  %37 = fmul double %34, %fi4, !llfi_index !1507
  ...
  %71 = fmul double %fi4, %70, !llfi_index !1541
  ...
  %102 = fmul double %fi4, %101, !llfi_index !1572
  ...
  %fi = call double* @injectFault0(i64 1580, double* %131, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1505
  %132 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1602
  %fi1 = call double @injectFault1(i64 1581, double %132, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1505
  %133 = fmul double %fi4, %fi1, !llfi_index !1603
  %fi2 = call double @injectFault1(i64 1582, double %133, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1505
  %134 = fadd double %130, %fi2, !llfi_index !1604
  ...
  %202 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1676
  ...
  %341 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1819
  ...
  %408 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1890
  ...
  %547 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2033
  ...
  %614 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2104
