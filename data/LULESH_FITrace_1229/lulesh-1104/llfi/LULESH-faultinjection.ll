...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi = call i32 @injectFault0(i64 1086, i32 %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1107
  ...
  %20 = sext i32 %fi to i64, !llfi_index !1122
  %fi1 = call i64 @injectFault1(i64 1101, i64 %20, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1107
  ...
  %fi2 = call double* @injectFault2(i64 1102, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1107
  %22 = getelementptr double, double* %fi2, i64 %fi1, !llfi_index !1124
  %fi3 = call double* @injectFault2(i64 1103, double* %22, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1107
  %23 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1125
  %fi4 = call double @injectFault3(i64 1104, double %23, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1107
  store double %fi4, double* %1, align 8, !tbaa !345, !llfi_index !1126
  ...
  %53 = getelementptr inbounds double, double* %52, i64 %fi1, !llfi_index !1163
  ...
  %77 = getelementptr inbounds double, double* %76, i64 %fi1, !llfi_index !1195
