...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3213, double %29, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3253
  %30 = tail call double @llvm.fabs.f64(double %fi) #2, !llfi_index !3254
  %31 = fcmp olt double %30, %1, !llfi_index !3255
  %32 = select i1 %31, double 0.000000e+00, double %fi, !llfi_index !3256
