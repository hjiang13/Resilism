...
71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi20, %106 ], !llfi_index !4759
  %fi4 = call i64 @injectFault1(i64 4700, i64 %72, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %73 = getelementptr double, double* %1, i64 %fi4, !llfi_index !4760
  %fi5 = call double* @injectFault2(i64 4701, double* %73, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %74 = bitcast double* %fi5 to <2 x double>*, !llfi_index !4761
  %fi6 = call <2 x double>* @injectFault3(i64 4702, <2 x double>* %74, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %75 = load <2 x double>, <2 x double>* %fi6, align 8, !tbaa !345, !alias.scope !4762, !llfi_index !4765
  %fi7 = call <2 x double> @injectFault0(i64 4703, <2 x double> %75, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %76 = getelementptr double, double* %3, i64 %fi4, !llfi_index !4766
  %fi8 = call double* @injectFault2(i64 4704, double* %76, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %77 = bitcast double* %fi8 to <2 x double>*, !llfi_index !4767
  %fi9 = call <2 x double>* @injectFault3(i64 4705, <2 x double>* %77, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %78 = load <2 x double>, <2 x double>* %fi9, align 8, !tbaa !345, !alias.scope !4768, !llfi_index !4770
  %fi10 = call <2 x double> @injectFault0(i64 4706, <2 x double> %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %79 = fmul <2 x double> %fi7, %fi10, !llfi_index !4771
  %fi11 = call <2 x double> @injectFault0(i64 4707, <2 x double> %79, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %80 = getelementptr inbounds double, double* %0, i64 %fi4, !llfi_index !4772
  %81 = call <2 x double> @llvm.fabs.v2f64(<2 x double> %fi11), !llfi_index !4773
  %fi12 = call <2 x double> @injectFault0(i64 4709, <2 x double> %81, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %82 = fcmp olt <2 x double> %fi12, %fi1, !llfi_index !4774
  %fi13 = call <2 x i1> @injectFault4(i64 4710, <2 x i1> %82, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %83 = select <2 x i1> %fi13, <2 x double> zeroinitializer, <2 x double> %fi11, !llfi_index !4775
  %fi14 = call <2 x double> @injectFault0(i64 4711, <2 x double> %83, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %84 = bitcast double* %80 to <2 x double>*, !llfi_index !4776
  store <2 x double> %fi14, <2 x double>* %84, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4781
  %85 = getelementptr double, double* %5, i64 %fi4, !llfi_index !4782
  %fi15 = call double* @injectFault2(i64 4714, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %86 = bitcast double* %fi15 to <2 x double>*, !llfi_index !4783
  %fi16 = call <2 x double>* @injectFault3(i64 4715, <2 x double>* %86, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %87 = load <2 x double>, <2 x double>* %fi16, align 8, !tbaa !345, !alias.scope !4784, !llfi_index !4785
  %fi17 = call <2 x double> @injectFault0(i64 4716, <2 x double> %87, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %88 = fcmp ult <2 x double> %fi17, %fi3, !llfi_index !4786
  %fi18 = call <2 x i1> @injectFault4(i64 4717, <2 x i1> %88, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %89 = select <2 x i1> %fi18, <2 x double> %fi14, <2 x double> zeroinitializer, !llfi_index !4787
  %fi19 = call <2 x double> @injectFault0(i64 4718, <2 x double> %89, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %90 = fcmp olt <2 x double> %fi19, %70, !llfi_index !4788
  %91 = xor <2 x i1> %fi18, <i1 true, i1 true>, !llfi_index !4789
...
94:                                               ; preds = %71
  ...
  %96 = extractelement <2 x double> %fi19, i32 0, !llfi_index !4794
...
106:                                              ; preds = %100, %98
  %107 = add nuw i64 %fi4, 2, !llfi_index !4807
  %fi20 = call i64 @injectFault1(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %108 = icmp eq i64 %fi20, %64, !llfi_index !4808
