...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double> @injectFault0(i64 4718, <2 x double> %89, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4787
  %90 = fcmp olt <2 x double> %fi, %70, !llfi_index !4788
...
94:                                               ; preds = %71
  ...
  %96 = extractelement <2 x double> %fi, i32 0, !llfi_index !4794
...
100:                                              ; preds = %98
  ...
  %104 = extractelement <2 x double> %fi, i32 1, !llfi_index !4803
