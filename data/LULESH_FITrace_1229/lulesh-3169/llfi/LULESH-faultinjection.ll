...
23:                                               ; preds = %23, %9
  ...
  %fi1 = call i64 @injectFault1(i64 3166, i64 %24, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %25 = getelementptr i32, i32* %fi, i64 %fi1, !llfi_index !3205
  %fi2 = call i32* @injectFault0(i64 3167, i32* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %26 = load i32, i32* %fi2, align 4, !tbaa !404, !llfi_index !3206
  %fi3 = call i32 @injectFault2(i64 3168, i32 %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %27 = sext i32 %fi3 to i64, !llfi_index !3207
  %fi4 = call i64 @injectFault1(i64 3169, i64 %27, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %28 = getelementptr inbounds double, double* %11, i64 %fi4, !llfi_index !3208
  store double 0.000000e+00, double* %28, align 8, !tbaa !345, !llfi_index !3209
  %29 = add nuw nsw i64 %fi1, 1, !llfi_index !3210
  %fi5 = call i64 @injectFault1(i64 3172, i64 %29, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %30 = icmp eq i64 %fi5, %8, !llfi_index !3211
