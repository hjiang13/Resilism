...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %19 = getelementptr [8 x double], [8 x double]* %0, i64 1, i64 0, !llfi_index !903
  %fi = call double* @injectFault0(i64 886, double* %19, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %20 = bitcast double* %fi to <2 x double>*, !llfi_index !905
  %fi1 = call <2 x double>* @injectFault1(i64 887, <2 x double>* %20, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %21 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !906
  %fi2 = call <2 x double> @injectFault2(i64 888, <2 x double> %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !904
  ...
  %60 = fneg <2 x double> %fi2, !llfi_index !949
  %fi3 = call <2 x double> @injectFault2(i64 931, <2 x double> %60, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %61 = insertelement <2 x double> poison, double %2, i32 0, !llfi_index !950
  %fi4 = call <2 x double> @injectFault2(i64 932, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %62 = shufflevector <2 x double> %fi4, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !951
  %fi5 = call <2 x double> @injectFault2(i64 933, <2 x double> %62, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %63 = fmul <2 x double> %fi5, %fi3, !llfi_index !952
  %fi6 = call <2 x double> @injectFault2(i64 934, <2 x double> %63, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !904
  %64 = bitcast double* %5 to <2 x double>*, !llfi_index !953
  store <2 x double> %fi6, <2 x double>* %64, align 8, !tbaa !345, !llfi_index !954
  %65 = getelementptr inbounds double, double* %5, i64 2, !llfi_index !955
  %66 = fneg <2 x double> %24, !llfi_index !956
  %67 = fmul <2 x double> %fi5, %66, !llfi_index !957
  ...
  %71 = fmul <2 x double> %fi5, %70, !llfi_index !962
  ...
  %75 = fmul <2 x double> %fi5, %74, !llfi_index !967
