...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi31 = call <2 x double> @injectFault0(i64 3327, <2 x double> %76, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %77 = fsub <2 x double> %fi4, %fi31, !llfi_index !3370
  %fi32 = call <2 x double> @injectFault0(i64 3328, <2 x double> %77, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %78 = insertelement <2 x double> poison, double %12, i32 0, !llfi_index !3371
  %fi33 = call <2 x double> @injectFault0(i64 3329, <2 x double> %78, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %79 = insertelement <2 x double> %fi33, double %9, i32 1, !llfi_index !3372
  %fi34 = call <2 x double> @injectFault0(i64 3330, <2 x double> %79, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %80 = fsub <2 x double> %fi9, %fi34, !llfi_index !3373
  %fi35 = call <2 x double> @injectFault0(i64 3331, <2 x double> %80, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %81 = insertelement <2 x double> %66, double %17, i32 1, !llfi_index !3374
  %82 = fsub <2 x double> %fi14, %81, !llfi_index !3375
  %83 = insertelement <2 x double> poison, double %2, i32 0, !llfi_index !3376
  %fi36 = call <2 x double> @injectFault0(i64 3334, <2 x double> %83, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %84 = insertelement <2 x double> %fi36, double %7, i32 1, !llfi_index !3377
  %fi37 = call <2 x double> @injectFault0(i64 3335, <2 x double> %84, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %85 = fsub <2 x double> %fi37, %fi17, !llfi_index !3378
  %fi38 = call <2 x double> @injectFault0(i64 3336, <2 x double> %85, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %86 = insertelement <2 x double> poison, double %10, i32 0, !llfi_index !3379
  %fi39 = call <2 x double> @injectFault0(i64 3337, <2 x double> %86, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %87 = insertelement <2 x double> %fi39, double %15, i32 1, !llfi_index !3380
  %fi40 = call <2 x double> @injectFault0(i64 3338, <2 x double> %87, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %88 = fsub <2 x double> %fi40, %fi22, !llfi_index !3381
  %fi41 = call <2 x double> @injectFault0(i64 3339, <2 x double> %88, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %91 = fsub <2 x double> %90, %fi26, !llfi_index !3384
  ...
  %112 = fadd <2 x double> %fi32, %fi38, !llfi_index !3406
  %fi42 = call <2 x double> @injectFault0(i64 3364, <2 x double> %112, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %113 = fmul <2 x double> %fi10, %fi29, !llfi_index !3407
  %fi43 = call <2 x double> @injectFault0(i64 3365, <2 x double> %113, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %114 = fmul <2 x double> %fi24, %fi15, !llfi_index !3408
  %fi44 = call <2 x double> @injectFault0(i64 3366, <2 x double> %114, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %115 = fsub <2 x double> %fi43, %fi44, !llfi_index !3409
  %fi45 = call <2 x double> @injectFault0(i64 3367, <2 x double> %115, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %116 = fmul <2 x double> %fi42, %fi45, !llfi_index !3410
  %fi46 = call <2 x double> @injectFault0(i64 3368, <2 x double> %116, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %117 = fadd <2 x double> %fi35, %fi41, !llfi_index !3411
  %fi47 = call <2 x double> @injectFault0(i64 3369, <2 x double> %117, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %118 = fmul <2 x double> %fi20, %fi15, !llfi_index !3412
  %fi48 = call <2 x double> @injectFault0(i64 3370, <2 x double> %118, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %119 = fmul <2 x double> %fi5, %fi29, !llfi_index !3413
  %fi49 = call <2 x double> @injectFault0(i64 3371, <2 x double> %119, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %120 = fsub <2 x double> %fi48, %fi49, !llfi_index !3414
  %fi50 = call <2 x double> @injectFault0(i64 3372, <2 x double> %120, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %121 = fmul <2 x double> %fi47, %fi50, !llfi_index !3415
  %fi51 = call <2 x double> @injectFault0(i64 3373, <2 x double> %121, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %122 = fadd <2 x double> %fi46, %fi51, !llfi_index !3416
  %fi52 = call <2 x double> @injectFault0(i64 3374, <2 x double> %122, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %128 = fadd <2 x double> %127, %fi52, !llfi_index !3422
