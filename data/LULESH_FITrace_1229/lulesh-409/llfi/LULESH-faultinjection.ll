...
10:                                               ; preds = %10, %8
  ...
  %18 = getelementptr double, double* %3, i64 %fi, !llfi_index !423
  %fi1 = call double* @injectFault1(i64 409, double* %18, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !416
  store double %17, double* %fi1, align 8, !tbaa !345, !llfi_index !424
