...
10:                                               ; preds = %10, %8
  ...
  %18 = getelementptr double, double* %3, i64 %11, !llfi_index !422
  %fi = call double* @injectFault0(i64 409, double* %18, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !423
  store double %17, double* %fi, align 8, !tbaa !345, !llfi_index !424
