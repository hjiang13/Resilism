...
13:                                               ; preds = %13, %11
  ...
  %21 = call double @llvm.fabs.f64(double %20) #2, !llfi_index !3243
  %fi = call double @injectFault0(i64 3204, double %21, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !3244
  %22 = fcmp olt double %fi, %1, !llfi_index !3245
