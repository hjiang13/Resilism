...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %56 = fmul double %fi, %55, !llfi_index !1526
  ...
  %fi1 = call double* @injectFault1(i64 1534, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %86 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1556
  %fi2 = call double @injectFault0(i64 1535, double %86, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %87 = fmul double %fi, %fi2, !llfi_index !1557
  %fi3 = call double @injectFault0(i64 1536, double %87, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  ...
  %91 = fadd double %fi3, %90, !llfi_index !1561
  ...
  %150 = fmul double %fi2, %115, !llfi_index !1620
  ...
  %307 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1785
  ...
  %513 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1999
