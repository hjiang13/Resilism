...
49:                                               ; preds = %47, %43
  ...
  %fi = call i1 @injectFault0(i64 64, i1 %52, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !72
  br i1 %fi, label %55, label %53, !llfi_index !73
