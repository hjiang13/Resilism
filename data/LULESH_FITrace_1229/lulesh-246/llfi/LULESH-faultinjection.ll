...
205:                                              ; preds = %203, %199
  ...
  %fi = call i1 @injectFault0(i64 246, i1 %208, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !256
  br i1 %fi, label %211, label %209, !llfi_index !257
