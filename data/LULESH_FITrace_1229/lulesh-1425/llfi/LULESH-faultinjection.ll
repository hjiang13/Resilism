...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1274, double* %11, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1295
  %12 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1296
  ...
  %67 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1353
  ...
  %89 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1376
  ...
  %113 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1401
  ...
  %156 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1446
  %fi = call double @injectFault0(i64 1425, double %156, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1295
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %151, double %152, double %153, double %154, double %155, double %fi, double %157, double %158, double %159, double %160, double %161, double %162, double %163, double %164, double %165, double %166, double %167, double %168, double* nonnull %169, double* nonnull %170, double* nonnull %171), !llfi_index !1462
  ...
  %175 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1466
