...
7:                                                ; preds = %5, %1
  ...
  %fi = call double* @injectFault0(i64 14, double* %9, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !22
  %10 = icmp eq double* %fi, null, !llfi_index !23
  br i1 %10, label %13, label %11, !llfi_index !24

11:                                               ; preds = %7
  %12 = bitcast double* %fi to i8*, !llfi_index !25
