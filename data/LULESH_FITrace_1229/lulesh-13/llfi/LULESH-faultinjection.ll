...
7:                                                ; preds = %5, %1
  %8 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 45, i32 0, i32 0, i32 0, i32 0, !llfi_index !20
  %fi = call double** @injectFault0(i64 13, double** %8, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !21
  %9 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !22
