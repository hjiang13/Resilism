...
12:                                               ; preds = %12, %10
  ...
  %25 = getelementptr double, double* %7, i64 %13, !llfi_index !3168
  %fi = call double* @injectFault0(i64 3133, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3169
  %26 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3170
