...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3130, double %23, i32 21, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !3166
  %24 = getelementptr inbounds double, double* %6, i64 %13, !llfi_index !3167
  store double %fi, double* %24, align 8, !tbaa !345, !llfi_index !3168
