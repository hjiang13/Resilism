...
define dso_local void @_Z24CalcAccelerationForNodesv() local_unnamed_addr #6 {
  ...
  %fi1 = call double* @injectFault0(i64 3110, double* %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
...
12:                                               ; preds = %12, %10
  ...
  %20 = getelementptr double, double* %fi1, i64 %fi2, !llfi_index !3163
  %fi4 = call double* @injectFault0(i64 3127, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %21 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !3164
  %fi5 = call double @injectFault2(i64 3128, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %22 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3165
  %fi6 = call double @injectFault2(i64 3129, double %22, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %23 = fdiv double %fi5, %fi6, !llfi_index !3166
  %fi7 = call double @injectFault2(i64 3130, double %23, i32 21, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %24 = getelementptr inbounds double, double* %6, i64 %fi2, !llfi_index !3167
  store double %fi7, double* %24, align 8, !tbaa !345, !llfi_index !3168
  %25 = getelementptr inbounds double, double* %7, i64 %fi2, !llfi_index !3169
