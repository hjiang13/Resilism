...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %90 = getelementptr double, double* %6, i64 6, !llfi_index !985
  %fi = call double* @injectFault0(i64 968, double* %90, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !986
  %91 = fneg <2 x double> %42, !llfi_index !987
  %92 = fmul <2 x double> %79, %91, !llfi_index !988
  %93 = bitcast double* %fi to <2 x double>*, !llfi_index !989
  %fi1 = call <2 x double>* @injectFault1(i64 971, <2 x double>* %93, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !986
  store <2 x double> %92, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !990
