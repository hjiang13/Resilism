...
107:                                              ; preds = %103
  ...
  %fi = call i8* @injectFault0(i64 129, i8* %108, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !137
  tail call void @_ZdlPv(i8* nonnull %fi) #2, !llfi_index !138
