...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  ...
  %20 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3292
  %fi2 = call double* @injectFault0(i64 3251, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %21 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3293
  %fi3 = call double @injectFault2(i64 3252, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %22 = fmul double %fi3, %0, !llfi_index !3294
  %fi4 = call double @injectFault2(i64 3253, double %22, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  ...
  %25 = fadd double %fi4, %24, !llfi_index !3297
  ...
  %fi5 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3275
