...
10:                                               ; preds = %10, %8
  ...
  %15 = getelementptr double, double* %6, i64 %11, !llfi_index !419
  %fi = call double* @injectFault0(i64 406, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !420
  %16 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !421
