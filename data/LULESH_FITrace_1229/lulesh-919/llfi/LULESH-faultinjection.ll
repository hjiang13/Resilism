...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %48 = getelementptr double, double* %4, i64 2, !llfi_index !933
  %fi = call double* @injectFault0(i64 916, double* %48, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !934
  %49 = fneg <2 x double> %12, !llfi_index !935
  %50 = fmul <2 x double> %45, %49, !llfi_index !936
  %51 = bitcast double* %fi to <2 x double>*, !llfi_index !937
  %fi1 = call <2 x double>* @injectFault1(i64 919, <2 x double>* %51, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !934
  store <2 x double> %50, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !938
