...
139:                                              ; preds = %137, %133
  ...
  %fi = call i1 @injectFault0(i64 169, i1 %142, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !179
  br i1 %fi, label %145, label %143, !llfi_index !180
