...
127:                                              ; preds = %125, %121
  ...
  %fi = call double* @injectFault0(i64 154, double* %129, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !162
  %130 = icmp eq double* %fi, null, !llfi_index !163
  br i1 %130, label %133, label %131, !llfi_index !164

131:                                              ; preds = %127
  %132 = bitcast double* %fi to i8*, !llfi_index !165
