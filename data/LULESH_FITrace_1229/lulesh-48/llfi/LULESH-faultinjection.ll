...
37:                                               ; preds = %35, %31
  %38 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 40, i32 0, i32 0, i32 0, i32 0, !llfi_index !55
  %fi = call double** @injectFault0(i64 48, double** %38, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !56
  %39 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !57
