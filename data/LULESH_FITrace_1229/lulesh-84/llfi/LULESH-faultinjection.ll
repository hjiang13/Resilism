...
67:                                               ; preds = %65, %61
  ...
  %fi = call double* @injectFault0(i64 84, double* %69, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !92
  %70 = icmp eq double* %fi, null, !llfi_index !93
  br i1 %70, label %73, label %71, !llfi_index !94

71:                                               ; preds = %67
  %72 = bitcast double* %fi to i8*, !llfi_index !95
