...
12:                                               ; preds = %12, %10
  ...
  %fi3 = call double @injectFault2(i64 3135, double %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %28 = fdiv double %26, %fi3, !llfi_index !3172
