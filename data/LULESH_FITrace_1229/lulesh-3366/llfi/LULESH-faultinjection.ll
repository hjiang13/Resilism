...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi1 = call <2 x double> @injectFault0(i64 3292, <2 x double> %41, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %42 = shufflevector <2 x double> %fi1, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3335
  %fi2 = call <2 x double> @injectFault0(i64 3293, <2 x double> %42, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %43 = insertelement <2 x double> poison, double %17, i32 0, !llfi_index !3336
  %fi3 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %44 = insertelement <2 x double> %fi3, double %19, i32 1, !llfi_index !3337
  %fi4 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %45 = fsub <2 x double> %fi2, %fi4, !llfi_index !3338
  %fi5 = call <2 x double> @injectFault0(i64 3296, <2 x double> %45, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %82 = fsub <2 x double> %fi4, %81, !llfi_index !3375
  ...
  %114 = fmul <2 x double> %fi9, %fi5, !llfi_index !3408
  %fi10 = call <2 x double> @injectFault0(i64 3366, <2 x double> %114, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %115 = fsub <2 x double> %113, %fi10, !llfi_index !3409
  %116 = fmul <2 x double> %112, %115, !llfi_index !3410
  %117 = fadd <2 x double> %80, %88, !llfi_index !3411
  %118 = fmul <2 x double> %50, %fi5, !llfi_index !3412
  ...
  %124 = fmul <2 x double> %35, %fi9, !llfi_index !3418
