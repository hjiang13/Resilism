...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %56 = insertelement <2 x double> %fi, double %18, i32 1, !llfi_index !3349
  ...
  %fi1 = call <2 x double> @injectFault0(i64 3317, <2 x double> %66, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %67 = insertelement <2 x double> %fi1, double %4, i32 1, !llfi_index !3360
  %fi2 = call <2 x double> @injectFault0(i64 3318, <2 x double> %67, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %68 = insertelement <2 x double> poison, double %19, i32 0, !llfi_index !3361
  %fi3 = call <2 x double> @injectFault0(i64 3319, <2 x double> %68, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %69 = insertelement <2 x double> %fi3, double %3, i32 1, !llfi_index !3362
  %fi4 = call <2 x double> @injectFault0(i64 3320, <2 x double> %69, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %70 = fsub <2 x double> %fi2, %fi4, !llfi_index !3363
  %fi5 = call <2 x double> @injectFault0(i64 3321, <2 x double> %70, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %71 = fsub double %13, %15, !llfi_index !3364
  %72 = insertelement <2 x double> %fi, double %5, i32 1, !llfi_index !3365
  %fi6 = call <2 x double> @injectFault0(i64 3323, <2 x double> %72, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %73 = insertelement <2 x double> poison, double %23, i32 0, !llfi_index !3366
  %fi7 = call <2 x double> @injectFault0(i64 3324, <2 x double> %73, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %74 = insertelement <2 x double> %fi7, double %7, i32 1, !llfi_index !3367
  %fi8 = call <2 x double> @injectFault0(i64 3325, <2 x double> %74, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  %75 = fsub <2 x double> %fi6, %fi8, !llfi_index !3368
  %fi9 = call <2 x double> @injectFault0(i64 3326, <2 x double> %75, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  ...
  %81 = insertelement <2 x double> %fi1, double %17, i32 1, !llfi_index !3374
  ...
  %98 = fadd <2 x double> %fi5, %fi9, !llfi_index !3392
  %fi10 = call <2 x double> @injectFault0(i64 3350, <2 x double> %98, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3348
  ...
  %107 = fmul <2 x double> %106, %fi10, !llfi_index !3401
