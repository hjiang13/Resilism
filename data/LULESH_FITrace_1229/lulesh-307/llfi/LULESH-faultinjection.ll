...
259:                                              ; preds = %257, %253
  %260 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 3, i32 0, i32 0, i32 0, i32 0, !llfi_index !316
  %fi = call double** @injectFault0(i64 307, double** %260, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !317
  %261 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !318
