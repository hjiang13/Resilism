...
97:                                               ; preds = %95, %91
  ...
  %fi = call double* @injectFault0(i64 119, double* %99, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !127
  %100 = icmp eq double* %fi, null, !llfi_index !128
  br i1 %100, label %103, label %101, !llfi_index !129

101:                                              ; preds = %97
  %102 = bitcast double* %fi to i8*, !llfi_index !130
