...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi11 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %44 = insertelement <2 x double> %fi11, double %19, i32 1, !llfi_index !3337
  %fi12 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %45 = fsub <2 x double> %42, %fi12, !llfi_index !3338
  %46 = insertelement <2 x double> poison, double %5, i32 0, !llfi_index !3339
  %fi13 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %47 = insertelement <2 x double> %fi13, double %2, i32 1, !llfi_index !3340
  %fi14 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi15 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %49 = shufflevector <2 x double> %fi15, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi16 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %50 = fsub <2 x double> %fi14, %fi16, !llfi_index !3343
  %fi17 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %51 = insertelement <2 x double> poison, double %13, i32 0, !llfi_index !3344
  %fi18 = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %52 = insertelement <2 x double> %fi18, double %10, i32 1, !llfi_index !3345
  %fi19 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %53 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %fi20 = call <2 x double> @injectFault0(i64 3304, <2 x double> %53, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %54 = fsub <2 x double> %fi19, %fi20, !llfi_index !3347
  %fi21 = call <2 x double> @injectFault0(i64 3305, <2 x double> %54, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %55 = insertelement <2 x double> poison, double %21, i32 0, !llfi_index !3348
  %fi22 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %56 = insertelement <2 x double> %fi22, double %18, i32 1, !llfi_index !3349
  %fi23 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %59 = fsub <2 x double> %fi23, %58, !llfi_index !3352
  ...
  %fi24 = call <2 x double> @injectFault0(i64 3317, <2 x double> %66, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %67 = insertelement <2 x double> %fi24, double %4, i32 1, !llfi_index !3360
  ...
  %72 = insertelement <2 x double> %fi22, double %5, i32 1, !llfi_index !3365
  ...
  %77 = fsub <2 x double> %fi4, %76, !llfi_index !3370
  ...
  %80 = fsub <2 x double> %fi9, %79, !llfi_index !3373
  %81 = insertelement <2 x double> %fi24, double %17, i32 1, !llfi_index !3374
  %fi25 = call <2 x double> @injectFault0(i64 3332, <2 x double> %81, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %82 = fsub <2 x double> %fi12, %fi25, !llfi_index !3375
  %fi26 = call <2 x double> @injectFault0(i64 3333, <2 x double> %82, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %85 = fsub <2 x double> %84, %fi14, !llfi_index !3378
  ...
  %88 = fsub <2 x double> %87, %fi19, !llfi_index !3381
  %89 = insertelement <2 x double> poison, double %18, i32 0, !llfi_index !3382
  %fi27 = call <2 x double> @injectFault0(i64 3340, <2 x double> %89, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %90 = insertelement <2 x double> %fi27, double %23, i32 1, !llfi_index !3383
  %fi28 = call <2 x double> @injectFault0(i64 3341, <2 x double> %90, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %91 = fsub <2 x double> %fi28, %fi23, !llfi_index !3384
  %fi29 = call <2 x double> @injectFault0(i64 3342, <2 x double> %91, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %113 = fmul <2 x double> %fi10, %59, !llfi_index !3407
  %114 = fmul <2 x double> %fi21, %45, !llfi_index !3408
  ...
  %118 = fmul <2 x double> %fi17, %45, !llfi_index !3412
  %119 = fmul <2 x double> %fi5, %59, !llfi_index !3413
  ...
  %123 = fadd <2 x double> %fi26, %fi29, !llfi_index !3417
  %fi30 = call <2 x double> @injectFault0(i64 3375, <2 x double> %123, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %124 = fmul <2 x double> %fi5, %fi21, !llfi_index !3418
  %fi31 = call <2 x double> @injectFault0(i64 3376, <2 x double> %124, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %125 = fmul <2 x double> %fi17, %fi10, !llfi_index !3419
  %fi32 = call <2 x double> @injectFault0(i64 3377, <2 x double> %125, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %126 = fsub <2 x double> %fi31, %fi32, !llfi_index !3420
  %fi33 = call <2 x double> @injectFault0(i64 3378, <2 x double> %126, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %127 = fmul <2 x double> %fi33, %fi30, !llfi_index !3421
  %fi34 = call <2 x double> @injectFault0(i64 3379, <2 x double> %127, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %128 = fadd <2 x double> %fi34, %122, !llfi_index !3422
