...
13:                                               ; preds = %13, %11
  ...
  %fi = call i1 @injectFault0(i64 3229, i1 %43, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3269
  br i1 %fi, label %.loopexit, label %13, !llvm.loop !3270, !llfi_index !3271
}
