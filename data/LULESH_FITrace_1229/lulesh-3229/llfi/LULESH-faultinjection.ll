...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call i32 @injectFault0(i64 3185, i32 %3, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3225
  ...
  %10 = icmp sgt i32 %fi, 0, !llfi_index !3232
  br i1 %10, label %11, label %.loopexit, !llfi_index !3233

11:                                               ; preds = %2
  %12 = zext i32 %fi to i64, !llfi_index !3234
  %fi1 = call i64 @injectFault1(i64 3194, i64 %12, i32 39, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !3225
...
13:                                               ; preds = %13, %11
  %14 = phi i64 [ 0, %11 ], [ %fi3, %13 ], !llfi_index !3237
  %fi2 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3225
  ...
  %fi3 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3225
  %43 = icmp eq i64 %fi3, %fi1, !llfi_index !3269
  %fi4 = call i1 @injectFault2(i64 3229, i1 %43, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3225
  br i1 %fi4, label %.loopexit, label %13, !llvm.loop !3270, !llfi_index !3271
}
