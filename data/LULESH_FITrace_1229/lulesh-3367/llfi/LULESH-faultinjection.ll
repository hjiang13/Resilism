...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi1 = call <2 x double> @injectFault0(i64 3287, <2 x double> %36, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %37 = shufflevector <2 x double> %fi1, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3330
  %fi2 = call <2 x double> @injectFault0(i64 3288, <2 x double> %37, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %38 = insertelement <2 x double> poison, double %9, i32 0, !llfi_index !3331
  %fi3 = call <2 x double> @injectFault0(i64 3289, <2 x double> %38, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %39 = insertelement <2 x double> %fi3, double %11, i32 1, !llfi_index !3332
  %fi4 = call <2 x double> @injectFault0(i64 3290, <2 x double> %39, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %40 = fsub <2 x double> %fi2, %fi4, !llfi_index !3333
  %fi5 = call <2 x double> @injectFault0(i64 3291, <2 x double> %40, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %41 = insertelement <2 x double> poison, double %22, i32 0, !llfi_index !3334
  %fi6 = call <2 x double> @injectFault0(i64 3292, <2 x double> %41, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %42 = shufflevector <2 x double> %fi6, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3335
  %fi7 = call <2 x double> @injectFault0(i64 3293, <2 x double> %42, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %43 = insertelement <2 x double> poison, double %17, i32 0, !llfi_index !3336
  %fi8 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %44 = insertelement <2 x double> %fi8, double %19, i32 1, !llfi_index !3337
  %fi9 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %45 = fsub <2 x double> %fi7, %fi9, !llfi_index !3338
  %fi10 = call <2 x double> @injectFault0(i64 3296, <2 x double> %45, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %fi11 = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %52 = insertelement <2 x double> %fi11, double %10, i32 1, !llfi_index !3345
  %fi12 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %53 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %fi13 = call <2 x double> @injectFault0(i64 3304, <2 x double> %53, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %54 = fsub <2 x double> %fi12, %fi13, !llfi_index !3347
  %fi14 = call <2 x double> @injectFault0(i64 3305, <2 x double> %54, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %55 = insertelement <2 x double> poison, double %21, i32 0, !llfi_index !3348
  %fi15 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %56 = insertelement <2 x double> %fi15, double %18, i32 1, !llfi_index !3349
  %fi16 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %57 = insertelement <2 x double> poison, double %16, i32 0, !llfi_index !3350
  %fi17 = call <2 x double> @injectFault0(i64 3308, <2 x double> %57, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %58 = shufflevector <2 x double> %fi17, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3351
  %fi18 = call <2 x double> @injectFault0(i64 3309, <2 x double> %58, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %59 = fsub <2 x double> %fi16, %fi18, !llfi_index !3352
  %fi19 = call <2 x double> @injectFault0(i64 3310, <2 x double> %59, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %72 = insertelement <2 x double> %fi15, double %5, i32 1, !llfi_index !3365
  ...
  %80 = fsub <2 x double> %fi4, %79, !llfi_index !3373
  %81 = insertelement <2 x double> %66, double %17, i32 1, !llfi_index !3374
  %82 = fsub <2 x double> %fi9, %81, !llfi_index !3375
  ...
  %88 = fsub <2 x double> %87, %fi12, !llfi_index !3381
  ...
  %91 = fsub <2 x double> %90, %fi16, !llfi_index !3384
  ...
  %113 = fmul <2 x double> %fi5, %fi19, !llfi_index !3407
  %fi20 = call <2 x double> @injectFault0(i64 3365, <2 x double> %113, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %114 = fmul <2 x double> %fi14, %fi10, !llfi_index !3408
  %fi21 = call <2 x double> @injectFault0(i64 3366, <2 x double> %114, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %115 = fsub <2 x double> %fi20, %fi21, !llfi_index !3409
  %fi22 = call <2 x double> @injectFault0(i64 3367, <2 x double> %115, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %116 = fmul <2 x double> %112, %fi22, !llfi_index !3410
  %117 = fadd <2 x double> %80, %88, !llfi_index !3411
  %118 = fmul <2 x double> %50, %fi10, !llfi_index !3412
  %119 = fmul <2 x double> %35, %fi19, !llfi_index !3413
  ...
  %124 = fmul <2 x double> %35, %fi14, !llfi_index !3418
  %125 = fmul <2 x double> %50, %fi5, !llfi_index !3419
