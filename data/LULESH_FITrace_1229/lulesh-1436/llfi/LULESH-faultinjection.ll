...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1294, double* %31, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1315
  %32 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1316
  ...
  %58 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1343
  ...
  %81 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1367
  ...
  %126 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1414
  ...
  %145 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1434
  ...
  %167 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1457
  %fi = call double @injectFault0(i64 1436, double %167, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1315
