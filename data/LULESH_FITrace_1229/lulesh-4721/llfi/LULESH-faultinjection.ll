...
71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi25, %106 ], !llfi_index !4759
...
106:                                              ; preds = %100, %98
  ...
  %fi25 = call i64 @injectFault1(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4752
  %108 = icmp eq i64 %fi25, %64, !llfi_index !4808
