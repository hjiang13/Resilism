...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x i1> @injectFault0(i64 4721, <2 x i1> %92, i32 29, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @or_namestr, i32 0, i32 0)), !llfi_injectfault !4790
  %93 = extractelement <2 x i1> %fi, i32 0, !llfi_index !4791
...
98:                                               ; preds = %94, %71
  %99 = extractelement <2 x i1> %fi, i32 1, !llfi_index !4798
