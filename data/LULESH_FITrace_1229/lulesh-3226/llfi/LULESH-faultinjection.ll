...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call double* @injectFault0(i64 3190, double* %8, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  ...
  %fi1 = call double* @injectFault0(i64 3191, double* %9, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3230
...
13:                                               ; preds = %13, %11
  ...
  %fi2 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %15 = getelementptr inbounds double, double* %4, i64 %fi2, !llfi_index !3238
  %16 = load double, double* %15, align 8, !tbaa !345, !llfi_index !3239
  %17 = getelementptr inbounds double, double* %5, i64 %fi2, !llfi_index !3240
  ...
  %24 = getelementptr inbounds double, double* %6, i64 %fi2, !llfi_index !3248
  %25 = load double, double* %24, align 8, !tbaa !345, !llfi_index !3249
  %26 = getelementptr inbounds double, double* %7, i64 %fi2, !llfi_index !3250
  ...
  %33 = getelementptr double, double* %fi, i64 %fi2, !llfi_index !3258
  %fi3 = call double* @injectFault0(i64 3218, double* %33, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %34 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3259
  %fi4 = call double @injectFault2(i64 3219, double %34, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %35 = getelementptr double, double* %fi1, i64 %fi2, !llfi_index !3260
  %fi5 = call double* @injectFault0(i64 3220, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %36 = load double, double* %fi5, align 8, !tbaa !345, !llfi_index !3261
  %fi6 = call double @injectFault2(i64 3221, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %37 = fmul double %fi6, %0, !llfi_index !3262
  %fi7 = call double @injectFault2(i64 3222, double %37, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %38 = fadd double %fi4, %fi7, !llfi_index !3263
  %fi8 = call double @injectFault2(i64 3223, double %38, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %39 = call double @llvm.fabs.f64(double %fi8) #2, !llfi_index !3264
  %fi9 = call double @injectFault2(i64 3224, double %39, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %40 = fcmp olt double %fi9, %1, !llfi_index !3265
  %fi10 = call i1 @injectFault3(i64 3225, i1 %40, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  %41 = select i1 %fi10, double 0.000000e+00, double %fi8, !llfi_index !3266
  %fi11 = call double @injectFault2(i64 3226, double %41, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !3230
  store double %fi11, double* %fi3, align 8, !tbaa !345, !llfi_index !3267
  %42 = add nuw nsw i64 %fi2, 1, !llfi_index !3268
  %fi12 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3230
