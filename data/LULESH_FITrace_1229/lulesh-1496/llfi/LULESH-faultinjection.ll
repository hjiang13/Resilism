...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi = call double @injectFault0(i64 1493, double %44, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1514
  %45 = getelementptr double, double* %0, i64 6, !llfi_index !1515
  %fi1 = call double* @injectFault1(i64 1494, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1514
  %46 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1516
  %fi2 = call double @injectFault0(i64 1495, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1514
  %47 = fmul double %fi, %fi2, !llfi_index !1517
  %fi3 = call double @injectFault0(i64 1496, double %47, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1514
  %48 = fadd double %43, %fi3, !llfi_index !1518
  ...
  %79 = fmul double %fi2, %78, !llfi_index !1549
  ...
  %110 = fmul double %fi2, %109, !llfi_index !1580
  ...
  %141 = fmul double %fi2, %140, !llfi_index !1611
