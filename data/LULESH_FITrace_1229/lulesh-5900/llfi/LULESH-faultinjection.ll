...
163:                                              ; preds = %163, %154
  ...
  %fi = call i32 @injectFault0(i64 5900, i32 %166, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !6033
  %167 = sext i32 %fi to i64, !llfi_index !6034
