...
154:                                              ; preds = %179, %136
  %155 = phi i64 [ 0, %136 ], [ %fi8, %179 ], !llfi_index !6017
...
163:                                              ; preds = %163, %154
  %164 = phi i64 [ 0, %154 ], [ %fi7, %163 ], !llfi_index !6031
  ...
  %fi7 = call i64 @injectFault1(i64 5914, i64 %177, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %178 = icmp eq i64 %fi7, 8, !llfi_index !6048
...
179:                                              ; preds = %182
  ...
  %fi8 = call i64 @injectFault1(i64 5920, i64 %180, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %181 = icmp eq i64 %fi8, %137, !llfi_index !6055
