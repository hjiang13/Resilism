...
12:                                               ; preds = %12, %7
  ...
  %17 = getelementptr double, double* %5, i64 %16, !llfi_index !3194
  %fi = call double* @injectFault0(i64 3158, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3195
  store double 0.000000e+00, double* %fi, align 8, !tbaa !345, !llfi_index !3196
