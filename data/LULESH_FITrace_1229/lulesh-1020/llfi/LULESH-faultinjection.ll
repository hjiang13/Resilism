...
33:                                               ; preds = %68, %31
  %34 = phi i64 [ 0, %31 ], [ %fi4, %68 ], !llfi_index !1034
  %fi = call i64 @injectFault0(i64 1017, i64 %34, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  %35 = shl nsw i64 %fi, 3, !llfi_index !1036
  %fi1 = call i64 @injectFault0(i64 1018, i64 %35, i32 25, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  ...
  %fi2 = call i32* @injectFault1(i64 1019, i32* %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  %37 = getelementptr i32, i32* %fi2, i64 %fi1, !llfi_index !1038
  %fi3 = call i32* @injectFault1(i64 1020, i32* %37, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1035
...
41:                                               ; preds = %52
  %42 = getelementptr inbounds double, double* %4, i64 %fi, !llfi_index !1043
  ...
  %43 = getelementptr inbounds double, double* %1, i64 %fi, !llfi_index !1046
  %44 = load double, double* %43, align 8, !tbaa !345, !llfi_index !1047
  %45 = getelementptr inbounds double, double* %2, i64 %fi, !llfi_index !1048
  %46 = load double, double* %45, align 8, !tbaa !345, !llfi_index !1049
  %47 = getelementptr inbounds double, double* %3, i64 %fi, !llfi_index !1050
...
52:                                               ; preds = %52, %33
  ...
  %54 = getelementptr inbounds i32, i32* %fi3, i64 %53, !llfi_index !1058
...
68:                                               ; preds = %71
  %69 = add nuw nsw i64 %fi, 1, !llfi_index !1077
  %fi4 = call i64 @injectFault0(i64 1058, i64 %69, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !1035
  %70 = icmp eq i64 %fi4, %32, !llfi_index !1078
  br i1 %70, label %.loopexit, label %33, !llvm.loop !1079, !llfi_index !1080

71:                                               ; preds = %71, %41
  %72 = phi i64 [ 0, %41 ], [ %91, %71 ], !llfi_index !1081
  %73 = getelementptr inbounds i32, i32* %fi3, i64 %72, !llfi_index !1082
