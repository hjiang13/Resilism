...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %13 = getelementptr [8 x double], [8 x double]* %0, i64 0, i64 4, !llfi_index !897
  %fi = call double* @injectFault0(i64 880, double* %13, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !898
  %14 = bitcast double* %fi to <2 x double>*, !llfi_index !899
  %fi1 = call <2 x double>* @injectFault1(i64 881, <2 x double>* %14, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !898
  %15 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !900
  %fi2 = call <2 x double> @injectFault2(i64 882, <2 x double> %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !898
  ...
  %fi3 = call <2 x double> @injectFault2(i64 911, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !898
  %45 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !930
  %fi4 = call <2 x double> @injectFault2(i64 912, <2 x double> %45, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !898
  ...
  %50 = fmul <2 x double> %fi4, %49, !llfi_index !936
  ...
  %53 = fneg <2 x double> %fi2, !llfi_index !940
  %fi5 = call <2 x double> @injectFault2(i64 922, <2 x double> %53, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !898
  %54 = fmul <2 x double> %fi4, %fi5, !llfi_index !941
  %fi6 = call <2 x double> @injectFault2(i64 923, <2 x double> %54, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !898
  %55 = bitcast double* %52 to <2 x double>*, !llfi_index !942
  store <2 x double> %fi6, <2 x double>* %55, align 8, !tbaa !345, !llfi_index !943
