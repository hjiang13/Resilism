...
71:                                               ; preds = %106, %63
  ...
  %76 = getelementptr double, double* %3, i64 %72, !llfi_index !4765
  %fi = call double* @injectFault0(i64 4704, double* %76, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4766
  %77 = bitcast double* %fi to <2 x double>*, !llfi_index !4767
