...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi27 = call double @injectFault1(i64 1466, double %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %18 = fmul double %16, %fi27, !llfi_index !1488
  %19 = load double, double* %4, align 8, !tbaa !345, !llfi_index !1489
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1490
  %fi28 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %21 = load double, double* %fi28, align 8, !tbaa !345, !llfi_index !1491
  %fi29 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %22 = fmul double %19, %fi29, !llfi_index !1492
  ...
  %fi30 = call double* @injectFault0(i64 1474, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %26 = load double, double* %fi30, align 8, !tbaa !345, !llfi_index !1496
  %fi31 = call double @injectFault1(i64 1475, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %27 = fmul double %24, %fi31, !llfi_index !1497
  ...
  %fi32 = call double* @injectFault0(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %31 = load double, double* %fi32, align 8, !tbaa !345, !llfi_index !1501
  %fi33 = call double @injectFault1(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %32 = fmul double %29, %fi33, !llfi_index !1502
  ...
  %fi34 = call double* @injectFault0(i64 1484, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %36 = load double, double* %fi34, align 8, !tbaa !345, !llfi_index !1506
  %fi35 = call double @injectFault1(i64 1485, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %37 = fmul double %34, %fi35, !llfi_index !1507
  ...
  %fi36 = call double* @injectFault0(i64 1489, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %41 = load double, double* %fi36, align 8, !tbaa !345, !llfi_index !1511
  %fi37 = call double @injectFault1(i64 1490, double %41, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %42 = fmul double %39, %fi37, !llfi_index !1512
  ...
  %fi38 = call double* @injectFault0(i64 1494, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %46 = load double, double* %fi38, align 8, !tbaa !345, !llfi_index !1516
  %fi39 = call double @injectFault1(i64 1495, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %47 = fmul double %44, %fi39, !llfi_index !1517
  ...
  %63 = fmul double %fi31, %62, !llfi_index !1533
  ...
  %67 = fmul double %fi33, %66, !llfi_index !1537
  ...
  %71 = fmul double %fi35, %70, !llfi_index !1541
  ...
  %75 = fmul double %fi37, %74, !llfi_index !1545
  ...
  %79 = fmul double %fi39, %78, !llfi_index !1549
  ...
  %94 = fmul double %fi31, %93, !llfi_index !1564
  ...
  %98 = fmul double %fi33, %97, !llfi_index !1568
  ...
  %102 = fmul double %fi35, %101, !llfi_index !1572
  ...
  %106 = fmul double %fi37, %105, !llfi_index !1576
  ...
  %110 = fmul double %fi39, %109, !llfi_index !1580
  ...
  %118 = fmul double %fi27, %fi1, !llfi_index !1588
  ...
  %121 = fmul double %fi29, %fi4, !llfi_index !1591
  ...
  %125 = fmul double %fi31, %fi8, !llfi_index !1595
  ...
  %129 = fmul double %fi33, %fi12, !llfi_index !1599
  ...
  %133 = fmul double %fi35, %fi16, !llfi_index !1603
  ...
  %137 = fmul double %fi37, %fi20, !llfi_index !1607
  ...
  %141 = fmul double %fi39, %fi24, !llfi_index !1611
  ...
  %146 = fadd double %fi26, %145, !llfi_index !1616
  ...
  %152 = fmul double %fi1, %146, !llfi_index !1622
