...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3134, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3170
  %27 = load double, double* %16, align 8, !tbaa !345, !llfi_index !3171
  %28 = fdiv double %fi, %27, !llfi_index !3172
