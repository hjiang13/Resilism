...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %25 = getelementptr double, double* %0, i64 2, !llfi_index !1494
  %fi3 = call double* @injectFault0(i64 1474, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1495
  %26 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1496
  %fi4 = call double @injectFault1(i64 1475, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1495
  ...
  %63 = fmul double %fi4, %62, !llfi_index !1533
  ...
  %fi = call double* @injectFault0(i64 1572, double* %123, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1495
  %124 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1594
  %fi1 = call double @injectFault1(i64 1573, double %124, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1495
  %125 = fmul double %fi4, %fi1, !llfi_index !1595
  %fi2 = call double @injectFault1(i64 1574, double %125, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1495
  %126 = fadd double %122, %fi2, !llfi_index !1596
  ...
  %176 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1648
  ...
  %335 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1813
  ...
  %382 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1862
  ...
  %541 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2027
  ...
  %588 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2076
