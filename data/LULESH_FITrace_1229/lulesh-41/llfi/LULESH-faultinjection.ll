...
31:                                               ; preds = %29, %25
  %32 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 41, i32 0, i32 0, i32 0, i32 0, !llfi_index !48
  %fi = call double** @injectFault0(i64 41, double** %32, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !49
  %33 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !50
