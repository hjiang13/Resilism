...
241:                                              ; preds = %239, %235
  ...
  %fi = call i1 @injectFault0(i64 288, i1 %244, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !298
  br i1 %fi, label %247, label %245, !llfi_index !299
