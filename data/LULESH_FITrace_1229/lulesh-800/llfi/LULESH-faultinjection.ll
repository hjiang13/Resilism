...
7:                                                ; preds = %122
  ...
  %62 = getelementptr double, double* %0, i64 6, !llfi_index !816
  %fi = call double* @injectFault0(i64 800, double* %62, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !817
