...
253:                                              ; preds = %251, %247
  ...
  %fi = call double* @injectFault0(i64 301, double* %255, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !311
  %256 = icmp eq double* %fi, null, !llfi_index !312
  br i1 %256, label %259, label %257, !llfi_index !313

257:                                              ; preds = %253
  %258 = bitcast double* %fi to i8*, !llfi_index !314
