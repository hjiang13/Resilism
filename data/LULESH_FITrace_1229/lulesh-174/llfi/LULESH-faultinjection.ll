...
145:                                              ; preds = %143, %139
  %146 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 22, i32 0, i32 0, i32 0, i32 0, !llfi_index !183
  %fi = call i32** @injectFault0(i64 174, i32** %146, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !184
  %147 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !185
