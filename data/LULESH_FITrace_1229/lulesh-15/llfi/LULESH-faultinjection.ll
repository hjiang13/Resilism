...
7:                                                ; preds = %5, %1
  ...
  %fi = call i1 @injectFault0(i64 15, i1 %10, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !23
  br i1 %fi, label %13, label %11, !llfi_index !24
