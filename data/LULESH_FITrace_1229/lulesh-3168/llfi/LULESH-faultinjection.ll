...
23:                                               ; preds = %23, %9
  %24 = phi i64 [ 0, %9 ], [ %fi4, %23 ], !llfi_index !3204
  ...
  %fi4 = call i64 @injectFault1(i64 3172, i64 %29, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3188
  %30 = icmp eq i64 %fi4, %8, !llfi_index !3211
