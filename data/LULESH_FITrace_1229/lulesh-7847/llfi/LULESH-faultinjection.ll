...
156:                                              ; preds = %156, %151
  ...
  %fi = call double* @injectFault0(i64 7847, double* %158, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !8049
  %159 = bitcast double* %fi to <2 x double>*, !llfi_index !8050
