...
156:                                              ; preds = %156, %151
  %157 = phi i64 [ 0, %151 ], [ %fi25, %156 ], !llfi_index !8048
  ...
  %fi25 = call i64 @injectFault2(i64 7850, i64 %160, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !7873
  %161 = icmp eq i64 %fi25, %152, !llfi_index !8053
