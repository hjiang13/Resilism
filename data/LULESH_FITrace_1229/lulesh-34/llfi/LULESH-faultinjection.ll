...
25:                                               ; preds = %23, %19
  %26 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 42, i32 0, i32 0, i32 0, i32 0, !llfi_index !41
  %fi = call double** @injectFault0(i64 34, double** %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !42
  %27 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !43
