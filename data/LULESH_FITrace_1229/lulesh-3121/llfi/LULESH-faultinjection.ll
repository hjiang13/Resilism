...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3119, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3143
  %14 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3156
  %fi2 = call double* @injectFault0(i64 3120, double* %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3143
  %15 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3157
  %fi3 = call double @injectFault2(i64 3121, double %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3143
  ...
  %18 = fdiv double %fi3, %17, !llfi_index !3160
  ...
  %fi4 = call i64 @injectFault1(i64 3139, i64 %30, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3143
