...
157:                                              ; preds = %155, %151
  %158 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 20, i32 0, i32 0, i32 0, i32 0, !llfi_index !197
  %fi = call i32** @injectFault0(i64 188, i32** %158, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !198
  %159 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !199
