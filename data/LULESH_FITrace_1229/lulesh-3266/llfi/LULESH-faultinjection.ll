...
12:                                               ; preds = %12, %10
  ...
  %fi = call i1 @injectFault0(i64 3266, i1 %33, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3307
  br i1 %fi, label %.loopexit, label %12, !llvm.loop !3308, !llfi_index !3309
}
