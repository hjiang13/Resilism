...
151:                                              ; preds = %149, %145
  ...
  %fi = call i32* @injectFault0(i64 182, i32* %153, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !192
  %154 = icmp eq i32* %fi, null, !llfi_index !193
  br i1 %154, label %157, label %155, !llfi_index !194

155:                                              ; preds = %151
  %156 = bitcast i32* %fi to i8*, !llfi_index !195
