...
182:                                              ; preds = %182, %158
  ...
  %184 = getelementptr i32, i32* %157, i64 %183, !llfi_index !6058
  %fi = call i32* @injectFault0(i64 5924, i32* %184, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !6059
  %185 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !6060
