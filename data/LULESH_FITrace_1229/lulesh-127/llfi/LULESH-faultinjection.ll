...
103:                                              ; preds = %101, %97
  ...
  %fi = call i1 @injectFault0(i64 127, i1 %106, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !135
  br i1 %fi, label %109, label %107, !llfi_index !136
