...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3284, <2 x double> %33, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %34 = insertelement <2 x double> %fi, double %3, i32 1, !llfi_index !3327
  %fi1 = call <2 x double> @injectFault0(i64 3285, <2 x double> %34, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %35 = fsub <2 x double> %32, %fi1, !llfi_index !3328
  ...
  %fi2 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %47 = insertelement <2 x double> %fi2, double %2, i32 1, !llfi_index !3340
  %fi3 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  ...
  %50 = fsub <2 x double> %fi3, %49, !llfi_index !3343
  ...
  %fi4 = call <2 x double> @injectFault0(i64 3312, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %62 = insertelement <2 x double> %fi4, double %12, i32 1, !llfi_index !3355
  ...
  %76 = insertelement <2 x double> %fi4, double %1, i32 1, !llfi_index !3369
  %fi5 = call <2 x double> @injectFault0(i64 3327, <2 x double> %76, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %77 = fsub <2 x double> %fi1, %fi5, !llfi_index !3370
  %fi6 = call <2 x double> @injectFault0(i64 3328, <2 x double> %77, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  ...
  %fi7 = call <2 x double> @injectFault0(i64 3334, <2 x double> %83, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %84 = insertelement <2 x double> %fi7, double %7, i32 1, !llfi_index !3377
  %fi8 = call <2 x double> @injectFault0(i64 3335, <2 x double> %84, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  %85 = fsub <2 x double> %fi8, %fi3, !llfi_index !3378
  %fi9 = call <2 x double> @injectFault0(i64 3336, <2 x double> %85, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  ...
  %112 = fadd <2 x double> %fi6, %fi9, !llfi_index !3406
  %fi10 = call <2 x double> @injectFault0(i64 3364, <2 x double> %112, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3326
  ...
  %116 = fmul <2 x double> %fi10, %115, !llfi_index !3410
