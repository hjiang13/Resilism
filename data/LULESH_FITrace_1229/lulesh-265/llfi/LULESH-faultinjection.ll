...
223:                                              ; preds = %221, %217
  %224 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 9, i32 0, i32 0, i32 0, i32 0, !llfi_index !274
  %fi = call double** @injectFault0(i64 265, double** %224, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !275
  %225 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !276
