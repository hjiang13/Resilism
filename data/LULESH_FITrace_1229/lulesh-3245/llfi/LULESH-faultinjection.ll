...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3245, double %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3286
  %16 = fmul double %fi, %0, !llfi_index !3287
