...
12:                                               ; preds = %12, %10
  ...
  %19 = getelementptr double, double* %4, i64 %13, !llfi_index !3160
  %fi = call double* @injectFault0(i64 3125, double* %19, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3161
  store double %18, double* %fi, align 8, !tbaa !345, !llfi_index !3162
