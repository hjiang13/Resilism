...
157:                                              ; preds = %155, %151
  ...
  %fi = call i32* @injectFault0(i64 189, i32* %159, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !199
  %160 = icmp eq i32* %fi, null, !llfi_index !200
  br i1 %160, label %163, label %161, !llfi_index !201

161:                                              ; preds = %157
  %162 = bitcast i32* %fi to i8*, !llfi_index !202
