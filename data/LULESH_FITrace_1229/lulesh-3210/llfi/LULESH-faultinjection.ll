...
13:                                               ; preds = %13, %11
  ...
  %26 = getelementptr double, double* %7, i64 %14, !llfi_index !3249
  %fi = call double* @injectFault0(i64 3210, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3250
  %27 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3251
