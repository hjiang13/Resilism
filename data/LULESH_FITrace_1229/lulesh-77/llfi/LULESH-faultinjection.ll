...
61:                                               ; preds = %59, %55
  ...
  %fi = call double* @injectFault0(i64 77, double* %63, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !85
  %64 = icmp eq double* %fi, null, !llfi_index !86
  br i1 %64, label %67, label %65, !llfi_index !87

65:                                               ; preds = %61
  %66 = bitcast double* %fi to i8*, !llfi_index !88
