...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3128, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3164
  %22 = load double, double* %16, align 8, !tbaa !345, !llfi_index !3165
  %23 = fdiv double %fi, %22, !llfi_index !3166
