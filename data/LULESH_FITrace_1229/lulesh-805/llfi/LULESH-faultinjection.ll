...
7:                                                ; preds = %122
  ...
  %fi1 = call double* @injectFault1(i64 760, double* %24, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !777
  %25 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !778
  ...
  %61 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !815
  ...
  %67 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !822
  %fi = call double @injectFault0(i64 805, double %67, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !777
