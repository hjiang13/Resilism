...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %fi2 = call <2 x double> @injectFault1(i64 876, <2 x double> %9, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !893
  ...
  %43 = fneg <2 x double> %fi2, !llfi_index !928
  %fi3 = call <2 x double> @injectFault1(i64 910, <2 x double> %43, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !893
  %44 = insertelement <2 x double> poison, double %1, i32 0, !llfi_index !929
  %fi4 = call <2 x double> @injectFault1(i64 911, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !893
  %45 = shufflevector <2 x double> %fi4, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !930
  %fi5 = call <2 x double> @injectFault1(i64 912, <2 x double> %45, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !893
  %46 = fmul <2 x double> %fi5, %fi3, !llfi_index !931
  %fi1 = call <2 x double> @injectFault1(i64 913, <2 x double> %46, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !893
  %47 = bitcast double* %4 to <2 x double>*, !llfi_index !932
  store <2 x double> %fi1, <2 x double>* %47, align 8, !tbaa !345, !llfi_index !933
  %48 = getelementptr inbounds double, double* %4, i64 2, !llfi_index !934
  %49 = fneg <2 x double> %12, !llfi_index !935
  %50 = fmul <2 x double> %fi5, %49, !llfi_index !936
  ...
  %54 = fmul <2 x double> %fi5, %53, !llfi_index !941
  ...
  %58 = fmul <2 x double> %fi5, %57, !llfi_index !946
