...
32:                                               ; preds = %32, %30
  ...
  %fi = call <2 x double> @injectFault0(i64 4660, <2 x double> %37, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !4713
  %38 = fmul <2 x double> %fi, <double 0x3FE5555555555555, double 0x3FE5555555555555>, !llfi_index !4714
