...
32:                                               ; preds = %32, %30
  %33 = phi i64 [ 0, %30 ], [ %fi5, %32 ], !llfi_index !4705
  ...
  %fi5 = call i64 @injectFault0(i64 4668, i64 %43, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %44 = icmp eq i64 %fi5, %31, !llfi_index !4727
