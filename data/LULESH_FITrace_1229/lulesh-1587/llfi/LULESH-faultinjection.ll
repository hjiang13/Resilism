...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi23 = call double @injectFault1(i64 1466, double %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %18 = fmul double %16, %fi23, !llfi_index !1488
  %19 = load double, double* %4, align 8, !tbaa !345, !llfi_index !1489
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1490
  %fi24 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %21 = load double, double* %fi24, align 8, !tbaa !345, !llfi_index !1491
  %fi25 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %22 = fmul double %19, %fi25, !llfi_index !1492
  ...
  %fi26 = call double* @injectFault0(i64 1474, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %26 = load double, double* %fi26, align 8, !tbaa !345, !llfi_index !1496
  %fi27 = call double @injectFault1(i64 1475, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %27 = fmul double %24, %fi27, !llfi_index !1497
  ...
  %fi28 = call double* @injectFault0(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %31 = load double, double* %fi28, align 8, !tbaa !345, !llfi_index !1501
  %fi29 = call double @injectFault1(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %32 = fmul double %29, %fi29, !llfi_index !1502
  ...
  %fi30 = call double* @injectFault0(i64 1484, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %36 = load double, double* %fi30, align 8, !tbaa !345, !llfi_index !1506
  %fi31 = call double @injectFault1(i64 1485, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %37 = fmul double %34, %fi31, !llfi_index !1507
  ...
  %fi32 = call double* @injectFault0(i64 1489, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %41 = load double, double* %fi32, align 8, !tbaa !345, !llfi_index !1511
  %fi33 = call double @injectFault1(i64 1490, double %41, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %42 = fmul double %39, %fi33, !llfi_index !1512
  ...
  %63 = fmul double %fi27, %62, !llfi_index !1533
  ...
  %67 = fmul double %fi29, %66, !llfi_index !1537
  ...
  %71 = fmul double %fi31, %70, !llfi_index !1541
  ...
  %75 = fmul double %fi33, %74, !llfi_index !1545
  ...
  %94 = fmul double %fi27, %93, !llfi_index !1564
  ...
  %98 = fmul double %fi29, %97, !llfi_index !1568
  ...
  %102 = fmul double %fi31, %101, !llfi_index !1572
  ...
  %106 = fmul double %fi33, %105, !llfi_index !1576
  ...
  %118 = fmul double %fi23, %fi1, !llfi_index !1588
  ...
  %121 = fmul double %fi25, %fi4, !llfi_index !1591
  ...
  %125 = fmul double %fi27, %fi8, !llfi_index !1595
  ...
  %129 = fmul double %fi29, %fi12, !llfi_index !1599
  ...
  %133 = fmul double %fi31, %fi16, !llfi_index !1603
  ...
  %137 = fmul double %fi33, %fi20, !llfi_index !1607
  ...
  %142 = fadd double %fi22, %141, !llfi_index !1612
