...
165:                                              ; preds = %165, %.preheader
  ...
  %167 = phi double* [ %fi, %165 ], [ %.ph22, %.preheader ], !llfi_index !8062
  store double %149, double* %167, align 8, !tbaa !345, !llfi_index !8063
  %168 = add i64 %166, -1, !llfi_index !8064
  %169 = getelementptr double, double* %167, i64 1, !llfi_index !8065
  %fi = call double* @injectFault0(i64 7863, double* %169, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !8066
