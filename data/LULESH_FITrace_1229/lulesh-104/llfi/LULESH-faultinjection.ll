...
85:                                               ; preds = %83, %79
  %86 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 32, i32 0, i32 0, i32 0, i32 0, !llfi_index !111
  %fi = call double** @injectFault0(i64 104, double** %86, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !112
  %87 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !113
