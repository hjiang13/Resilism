...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %14 = getelementptr i32, i32* %0, i64 5, !llfi_index !1115
  %fi = call i32* @injectFault0(i64 1095, i32* %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %15 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !1117
  %fi1 = call i32 @injectFault1(i64 1096, i32 %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  ...
  %fi2 = call double* @injectFault2(i64 1102, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  ...
  %40 = sext i32 %fi1 to i64, !llfi_index !1147
  %fi3 = call i64 @injectFault3(i64 1126, i64 %40, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %41 = getelementptr double, double* %fi2, i64 %fi3, !llfi_index !1148
  %fi4 = call double* @injectFault2(i64 1127, double* %41, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %42 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1149
  %fi5 = call double @injectFault4(i64 1128, double %42, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %43 = getelementptr inbounds double, double* %1, i64 5, !llfi_index !1150
  store double %fi5, double* %43, align 8, !tbaa !345, !llfi_index !1151
  ...
  %67 = getelementptr inbounds double, double* %52, i64 %fi3, !llfi_index !1182
  ...
  %91 = getelementptr inbounds double, double* %76, i64 %fi3, !llfi_index !1214
