...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %45 = getelementptr double, double* %0, i64 6, !llfi_index !1514
  %fi3 = call double* @injectFault0(i64 1494, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %46 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1516
  %fi4 = call double @injectFault1(i64 1495, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %47 = fmul double %44, %fi4, !llfi_index !1517
  ...
  %79 = fmul double %fi4, %78, !llfi_index !1549
  ...
  %110 = fmul double %fi4, %109, !llfi_index !1580
  ...
  %fi = call double* @injectFault0(i64 1588, double* %139, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %140 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1610
  %fi1 = call double @injectFault1(i64 1589, double %140, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %141 = fmul double %fi4, %fi1, !llfi_index !1611
  %fi2 = call double @injectFault1(i64 1590, double %141, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %142 = fadd double %138, %fi2, !llfi_index !1612
  ...
  %228 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1704
  ...
  %347 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1825
  ...
  %434 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1918
  ...
  %553 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2039
  ...
  %640 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2132
