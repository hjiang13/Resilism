...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi2 = call i64 @injectFault2(i64 1121, i64 %36, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1114
  %37 = getelementptr inbounds double, double* %21, i64 %fi2, !llfi_index !1143
  ...
  %fi3 = call double* @injectFault3(i64 1141, double* %52, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1114
  ...
  %55 = getelementptr inbounds double, double* %fi3, i64 %24, !llfi_index !1166
  ...
  %64 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1178
  %fi4 = call double* @injectFault3(i64 1157, double* %64, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1114
  %65 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1179
  %fi5 = call double @injectFault4(i64 1158, double %65, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1114
  %66 = getelementptr inbounds double, double* %2, i64 4, !llfi_index !1180
  store double %fi5, double* %66, align 8, !tbaa !345, !llfi_index !1181
  ...
  %88 = getelementptr inbounds double, double* %76, i64 %fi2, !llfi_index !1210
