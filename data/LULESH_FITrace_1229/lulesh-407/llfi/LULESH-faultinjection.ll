...
define dso_local void @_Z23InitStressTermsForElemsiPdS_S_(i32 %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 396, double* %6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !410
...
10:                                               ; preds = %10, %8
  ...
  %fi1 = call i64 @injectFault1(i64 402, i64 %11, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !410
  ...
  %15 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !420
  %fi2 = call double* @injectFault0(i64 406, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !410
  %16 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !421
  %fi3 = call double @injectFault2(i64 407, double %16, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !410
  %17 = fsub double %14, %fi3, !llfi_index !422
  ...
  %fi4 = call i64 @injectFault1(i64 415, i64 %21, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !410
