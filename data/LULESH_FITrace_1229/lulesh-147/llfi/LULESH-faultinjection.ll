...
121:                                              ; preds = %119, %115
  ...
  %fi = call double* @injectFault0(i64 147, double* %123, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !155
  %124 = icmp eq double* %fi, null, !llfi_index !156
  br i1 %124, label %127, label %125, !llfi_index !157

125:                                              ; preds = %121
  %126 = bitcast double* %fi to i8*, !llfi_index !158
