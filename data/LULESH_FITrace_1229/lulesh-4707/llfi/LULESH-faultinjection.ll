...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double> @injectFault0(i64 4707, <2 x double> %79, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4771
  %80 = getelementptr inbounds double, double* %0, i64 %72, !llfi_index !4772
  %81 = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %fi), !llfi_index !4773
  %82 = fcmp olt <2 x double> %81, %66, !llfi_index !4774
  %83 = select <2 x i1> %82, <2 x double> zeroinitializer, <2 x double> %fi, !llfi_index !4775
