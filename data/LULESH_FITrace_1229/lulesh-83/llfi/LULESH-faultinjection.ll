...
67:                                               ; preds = %65, %61
  %68 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 35, i32 0, i32 0, i32 0, i32 0, !llfi_index !90
  %fi = call double** @injectFault0(i64 83, double** %68, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !91
  %69 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !92
