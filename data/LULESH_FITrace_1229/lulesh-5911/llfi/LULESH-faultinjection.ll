...
.loopexit35:                                      ; preds = %138, %121, %.loopexit37
  ...
  %fi1 = call double* @injectFault1(i64 5855, double* %129, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
163:                                              ; preds = %163, %154
  ...
  %168 = getelementptr inbounds double, double* %127, i64 %fi8, !llfi_index !6035
  ...
  %174 = getelementptr double, double* %fi1, i64 %fi8, !llfi_index !6043
  %fi9 = call double* @injectFault1(i64 5910, double* %174, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %175 = load double, double* %fi9, align 8, !tbaa !345, !llfi_index !6044
  %fi10 = call double @injectFault4(i64 5911, double %175, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %176 = getelementptr inbounds [8 x double], [8 x double]* %5, i64 0, i64 %fi5, !llfi_index !6045
  store double %fi10, double* %176, align 8, !tbaa !345, !llfi_index !6046
