...
10:                                               ; preds = %10, %8
  ...
  %20 = getelementptr double, double* %1, i64 %11, !llfi_index !426
  %fi = call double* @injectFault0(i64 413, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !427
  store double %17, double* %fi, align 8, !tbaa !345, !llfi_index !428
