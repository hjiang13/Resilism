...
10:                                               ; preds = %10, %8
  %11 = phi i64 [ 0, %8 ], [ %fi2, %10 ], !llfi_index !415
  ...
  %15 = getelementptr inbounds double, double* %6, i64 %fi, !llfi_index !420
  %16 = load double, double* %15, align 8, !tbaa !345, !llfi_index !421
  %17 = fsub double %14, %16, !llfi_index !422
  %18 = getelementptr inbounds double, double* %3, i64 %fi, !llfi_index !423
  store double %17, double* %18, align 8, !tbaa !345, !llfi_index !424
  %19 = getelementptr inbounds double, double* %2, i64 %fi, !llfi_index !425
  store double %17, double* %19, align 8, !tbaa !345, !llfi_index !426
  %20 = getelementptr double, double* %1, i64 %fi, !llfi_index !427
  %fi1 = call double* @injectFault1(i64 413, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !416
  store double %17, double* %fi1, align 8, !tbaa !345, !llfi_index !428
  %21 = add nuw nsw i64 %fi, 1, !llfi_index !429
  %fi2 = call i64 @injectFault0(i64 415, i64 %21, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !416
  %22 = icmp eq i64 %fi2, %9, !llfi_index !430
