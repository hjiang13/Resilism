...
235:                                              ; preds = %233, %229
  %236 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 7, i32 0, i32 0, i32 0, i32 0, !llfi_index !288
  %fi = call double** @injectFault0(i64 279, double** %236, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !289
  %237 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !290
