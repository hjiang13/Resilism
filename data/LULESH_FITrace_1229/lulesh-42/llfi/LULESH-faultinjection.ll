...
31:                                               ; preds = %29, %25
  ...
  %fi = call double* @injectFault0(i64 42, double* %33, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !50
  %34 = icmp eq double* %fi, null, !llfi_index !51
  br i1 %34, label %37, label %35, !llfi_index !52

35:                                               ; preds = %31
  %36 = bitcast double* %fi to i8*, !llfi_index !53
