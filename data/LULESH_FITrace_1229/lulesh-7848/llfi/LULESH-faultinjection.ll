...
156:                                              ; preds = %156, %151
  ...
  %fi = call <2 x double>* @injectFault0(i64 7848, <2 x double>* %159, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !8050
  store <2 x double> %155, <2 x double>* %fi, align 8, !tbaa !345, !llfi_index !8051
