...
199:                                              ; preds = %197, %193
  ...
  %fi = call i1 @injectFault0(i64 239, i1 %202, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !249
  br i1 %fi, label %205, label %203, !llfi_index !250
