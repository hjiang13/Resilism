...
12:                                               ; preds = %12, %7
  ...
  %14 = getelementptr i32, i32* %4, i64 %13, !llfi_index !3191
  %fi = call i32* @injectFault0(i64 3155, i32* %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3192
  %15 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !3193
