...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %21 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1491
  %fi1 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %22 = fmul double %19, %fi1, !llfi_index !1492
  ...
  %fi2 = call double* @injectFault0(i64 1506, double* %57, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %58 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1528
  %fi3 = call double @injectFault1(i64 1507, double %58, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %59 = fmul double %fi1, %fi3, !llfi_index !1529
  %fi4 = call double @injectFault1(i64 1508, double %59, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1490
  %60 = fadd double %56, %fi4, !llfi_index !1530
  ...
  %90 = fmul double %fi1, %89, !llfi_index !1560
  ...
  %121 = fmul double %fi1, %120, !llfi_index !1591
  ...
  %157 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1628
  ...
  %286 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1764
  ...
  %363 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1842
  ...
  %492 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1978
  ...
  %569 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !2056
