...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %34 = getelementptr [8 x double], [8 x double]* %0, i64 2, i64 2, !llfi_index !918
  %fi = call double* @injectFault0(i64 901, double* %34, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %35 = bitcast double* %fi to <2 x double>*, !llfi_index !920
  %fi1 = call <2 x double>* @injectFault1(i64 902, <2 x double>* %35, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %36 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !921
  %fi2 = call <2 x double> @injectFault2(i64 903, <2 x double> %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !919
  ...
  %fi3 = call <2 x double> @injectFault2(i64 953, <2 x double> %78, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %79 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !972
  %fi4 = call <2 x double> @injectFault2(i64 954, <2 x double> %79, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %80 = fmul <2 x double> %fi4, %77, !llfi_index !973
  ...
  %83 = fneg <2 x double> %fi2, !llfi_index !977
  %fi5 = call <2 x double> @injectFault2(i64 959, <2 x double> %83, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %84 = fmul <2 x double> %fi4, %fi5, !llfi_index !978
  %fi6 = call <2 x double> @injectFault2(i64 960, <2 x double> %84, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !919
  %85 = bitcast double* %82 to <2 x double>*, !llfi_index !979
  store <2 x double> %fi6, <2 x double>* %85, align 8, !tbaa !345, !llfi_index !980
  %86 = getelementptr inbounds double, double* %6, i64 4, !llfi_index !981
  %87 = fneg <2 x double> %39, !llfi_index !982
  %88 = fmul <2 x double> %fi4, %87, !llfi_index !983
  ...
  %92 = fmul <2 x double> %fi4, %91, !llfi_index !988
