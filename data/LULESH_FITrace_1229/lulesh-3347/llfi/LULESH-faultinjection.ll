...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi2 = call <2 x double> @injectFault0(i64 3279, <2 x double> %28, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %29 = insertelement <2 x double> %fi2, double %16, i32 1, !llfi_index !3322
  %fi3 = call <2 x double> @injectFault0(i64 3280, <2 x double> %29, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %30 = fsub <2 x double> %fi1, %fi3, !llfi_index !3323
  %fi4 = call <2 x double> @injectFault0(i64 3281, <2 x double> %30, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %31 = insertelement <2 x double> poison, double %6, i32 0, !llfi_index !3324
  %fi5 = call <2 x double> @injectFault0(i64 3282, <2 x double> %31, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %32 = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3325
  ...
  %53 = shufflevector <2 x double> %fi2, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  ...
  %60 = insertelement <2 x double> %fi5, double %14, i32 1, !llfi_index !3353
  %fi6 = call <2 x double> @injectFault0(i64 3311, <2 x double> %60, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %61 = insertelement <2 x double> poison, double %4, i32 0, !llfi_index !3354
  %fi7 = call <2 x double> @injectFault0(i64 3312, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %62 = insertelement <2 x double> %fi7, double %12, i32 1, !llfi_index !3355
  %fi8 = call <2 x double> @injectFault0(i64 3313, <2 x double> %62, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %63 = fsub <2 x double> %fi6, %fi8, !llfi_index !3356
  %fi9 = call <2 x double> @injectFault0(i64 3314, <2 x double> %63, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  ...
  %76 = insertelement <2 x double> %fi7, double %1, i32 1, !llfi_index !3369
  ...
  %shift = shufflevector <2 x double> %fi4, <2 x double> poison, <2 x i32> <i32 1, i32 undef>, !llfi_index !3387
  %fi10 = call <2 x double> @injectFault0(i64 3345, <2 x double> %shift, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %94 = fmul <2 x double> %fi9, %fi10, !llfi_index !3388
  %fi11 = call <2 x double> @injectFault0(i64 3346, <2 x double> %94, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %95 = extractelement <2 x double> %fi11, i32 0, !llfi_index !3389
  %fi12 = call double @injectFault1(i64 3347, double %95, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3319
  %96 = fsub double %93, %fi12, !llfi_index !3390
  %97 = fmul double %92, %96, !llfi_index !3391
  %98 = fadd <2 x double> %70, %75, !llfi_index !3392
  %99 = fmul <2 x double> %fi9, %fi4, !llfi_index !3393
  %100 = insertelement <2 x double> poison, double %25, i32 0, !llfi_index !3394
  %101 = shufflevector <2 x double> %100, <2 x double> %fi4, <2 x i32> <i32 0, i32 2>, !llfi_index !3395
  %102 = extractelement <2 x double> %fi9, i32 1, !llfi_index !3396
