...
205:                                              ; preds = %203, %199
  %206 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 12, i32 0, i32 0, i32 0, i32 0, !llfi_index !253
  %fi = call double** @injectFault0(i64 244, double** %206, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !254
  %207 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !255
