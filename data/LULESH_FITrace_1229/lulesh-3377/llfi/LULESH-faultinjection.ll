...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi5 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %47 = insertelement <2 x double> %fi5, double %2, i32 1, !llfi_index !3340
  %fi6 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi7 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %49 = shufflevector <2 x double> %fi7, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi8 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %50 = fsub <2 x double> %fi6, %fi8, !llfi_index !3343
  %fi9 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  ...
  %118 = fmul <2 x double> %fi9, %45, !llfi_index !3412
  ...
  %125 = fmul <2 x double> %fi9, %fi4, !llfi_index !3419
  %fi10 = call <2 x double> @injectFault0(i64 3377, <2 x double> %125, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %126 = fsub <2 x double> %124, %fi10, !llfi_index !3420
