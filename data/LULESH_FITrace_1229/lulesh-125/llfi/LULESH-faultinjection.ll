...
103:                                              ; preds = %101, %97
  %104 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 29, i32 0, i32 0, i32 0, i32 0, !llfi_index !132
  %fi = call double** @injectFault0(i64 125, double** %104, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !133
  %105 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !134
