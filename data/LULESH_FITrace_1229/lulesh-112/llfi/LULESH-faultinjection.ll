...
91:                                               ; preds = %89, %85
  ...
  %fi = call double* @injectFault0(i64 112, double* %93, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !120
  %94 = icmp eq double* %fi, null, !llfi_index !121
  br i1 %94, label %97, label %95, !llfi_index !122

95:                                               ; preds = %91
  %96 = bitcast double* %fi to i8*, !llfi_index !123
