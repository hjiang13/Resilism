...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi3 = call double* @injectFault0(i64 1489, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1510
  %41 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1511
  %fi4 = call double @injectFault1(i64 1490, double %41, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1510
  %42 = fmul double %39, %fi4, !llfi_index !1512
  ...
  %75 = fmul double %fi4, %74, !llfi_index !1545
  ...
  %fi = call double* @injectFault0(i64 1553, double* %104, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1510
  %105 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1575
  %fi1 = call double @injectFault1(i64 1554, double %105, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1510
  %106 = fmul double %fi4, %fi1, !llfi_index !1576
  %fi2 = call double @injectFault1(i64 1555, double %106, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1510
  %107 = fadd double %103, %fi2, !llfi_index !1577
  ...
  %137 = fmul double %fi4, %136, !llfi_index !1607
  ...
  %212 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1687
  ...
  %321 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1799
  ...
  %418 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1901
  ...
  %527 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2013
  ...
  %624 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2115
