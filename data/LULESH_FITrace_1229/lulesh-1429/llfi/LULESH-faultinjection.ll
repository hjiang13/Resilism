...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1284, double* %21, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1305
  %22 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1306
  ...
  %52 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1337
  ...
  %94 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1381
  ...
  %141 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1430
  ...
  %160 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1450
  %fi = call double @injectFault0(i64 1429, double %160, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1305
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %151, double %152, double %153, double %154, double %155, double %156, double %157, double %158, double %159, double %fi, double %161, double %162, double %163, double %164, double %165, double %166, double %167, double %168, double* nonnull %169, double* nonnull %170, double* nonnull %171), !llfi_index !1462
  ...
  %182 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1473
