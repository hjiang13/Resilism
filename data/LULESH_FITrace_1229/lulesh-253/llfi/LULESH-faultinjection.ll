...
211:                                              ; preds = %209, %205
  ...
  %fi = call i1 @injectFault0(i64 253, i1 %214, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !263
  br i1 %fi, label %217, label %215, !llfi_index !264
