...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %156 = fmul double %fi107, %155, !llfi_index !1627
  %157 = load double, double* %fi111, align 8, !tbaa !345, !llfi_index !1628
  %158 = fmul double %fi138, %157, !llfi_index !1629
  ...
  %169 = fmul double %fi107, %fi59, !llfi_index !1641
  %fi61 = call double @injectFault1(i64 1620, double %169, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %170 = load double, double* %fi115, align 8, !tbaa !345, !llfi_index !1642
  %fi62 = call double @injectFault1(i64 1621, double %170, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %171 = fmul double %fi138, %fi62, !llfi_index !1643
  %fi63 = call double @injectFault1(i64 1622, double %171, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %172 = fadd double %fi61, %fi63, !llfi_index !1644
  %fi64 = call double @injectFault1(i64 1623, double %172, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %173 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1645
  %fi65 = call double @injectFault1(i64 1624, double %173, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %174 = fmul double %fi27, %fi65, !llfi_index !1646
  %fi66 = call double @injectFault1(i64 1625, double %174, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %175 = fadd double %fi64, %fi66, !llfi_index !1647
  %fi67 = call double @injectFault1(i64 1626, double %175, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %176 = load double, double* %fi35, align 8, !tbaa !345, !llfi_index !1648
  %fi68 = call double @injectFault1(i64 1627, double %176, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %177 = fmul double %fi58, %fi68, !llfi_index !1649
  %fi69 = call double @injectFault1(i64 1628, double %177, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %178 = fadd double %fi67, %fi69, !llfi_index !1650
