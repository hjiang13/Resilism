...
10:                                               ; preds = %10, %8
  ...
  %12 = getelementptr double, double* %5, i64 %11, !llfi_index !416
  %fi = call double* @injectFault0(i64 403, double* %12, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !417
  %13 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !418
