...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi5 = call <2 x double> @injectFault0(i64 3292, <2 x double> %41, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %42 = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3335
  %fi6 = call <2 x double> @injectFault0(i64 3293, <2 x double> %42, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %43 = insertelement <2 x double> poison, double %17, i32 0, !llfi_index !3336
  %fi7 = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %44 = insertelement <2 x double> %fi7, double %19, i32 1, !llfi_index !3337
  %fi8 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %45 = fsub <2 x double> %fi6, %fi8, !llfi_index !3338
  %fi9 = call <2 x double> @injectFault0(i64 3296, <2 x double> %45, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %46 = insertelement <2 x double> poison, double %5, i32 0, !llfi_index !3339
  %fi10 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %47 = insertelement <2 x double> %fi10, double %2, i32 1, !llfi_index !3340
  %fi11 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi12 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %49 = shufflevector <2 x double> %fi12, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi13 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %50 = fsub <2 x double> %fi11, %fi13, !llfi_index !3343
  %fi14 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  ...
  %fi15 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %56 = insertelement <2 x double> %fi15, double %18, i32 1, !llfi_index !3349
  %fi16 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %57 = insertelement <2 x double> poison, double %16, i32 0, !llfi_index !3350
  %fi17 = call <2 x double> @injectFault0(i64 3308, <2 x double> %57, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %58 = shufflevector <2 x double> %fi17, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3351
  %fi18 = call <2 x double> @injectFault0(i64 3309, <2 x double> %58, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %59 = fsub <2 x double> %fi16, %fi18, !llfi_index !3352
  %fi19 = call <2 x double> @injectFault0(i64 3310, <2 x double> %59, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  ...
  %82 = fsub <2 x double> %fi8, %81, !llfi_index !3375
  ...
  %85 = fsub <2 x double> %84, %fi11, !llfi_index !3378
  ...
  %113 = fmul <2 x double> %40, %fi19, !llfi_index !3407
  %114 = fmul <2 x double> %54, %fi9, !llfi_index !3408
  ...
  %118 = fmul <2 x double> %fi14, %fi9, !llfi_index !3412
  %fi20 = call <2 x double> @injectFault0(i64 3370, <2 x double> %118, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %119 = fmul <2 x double> %fi4, %fi19, !llfi_index !3413
  %fi21 = call <2 x double> @injectFault0(i64 3371, <2 x double> %119, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %120 = fsub <2 x double> %fi20, %fi21, !llfi_index !3414
  %fi22 = call <2 x double> @injectFault0(i64 3372, <2 x double> %120, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3324
  %121 = fmul <2 x double> %117, %fi22, !llfi_index !3415
  ...
  %125 = fmul <2 x double> %fi14, %40, !llfi_index !3419
