...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %10 = getelementptr i32, i32* %0, i64 3, !llfi_index !1111
  %fi = call i32* @injectFault0(i64 1091, i32* %10, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %11 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !1113
  %fi1 = call i32 @injectFault1(i64 1092, i32 %11, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  ...
  %fi2 = call double* @injectFault2(i64 1102, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  ...
  %32 = sext i32 %fi1 to i64, !llfi_index !1137
  %fi3 = call i64 @injectFault3(i64 1116, i64 %32, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %33 = getelementptr double, double* %fi2, i64 %fi3, !llfi_index !1138
  %fi4 = call double* @injectFault2(i64 1117, double* %33, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %34 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1139
  %fi5 = call double @injectFault4(i64 1118, double %34, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %35 = getelementptr inbounds double, double* %1, i64 3, !llfi_index !1140
  store double %fi5, double* %35, align 8, !tbaa !345, !llfi_index !1141
  ...
  %61 = getelementptr inbounds double, double* %52, i64 %fi3, !llfi_index !1174
  ...
  %85 = getelementptr inbounds double, double* %76, i64 %fi3, !llfi_index !1206
