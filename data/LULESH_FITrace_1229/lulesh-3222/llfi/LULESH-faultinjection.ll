...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call double* @injectFault0(i64 3191, double* %9, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3231
...
13:                                               ; preds = %13, %11
  ...
  %fi1 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3231
  ...
  %26 = getelementptr inbounds double, double* %7, i64 %fi1, !llfi_index !3250
  ...
  %35 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3260
  %fi2 = call double* @injectFault0(i64 3220, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3231
  %36 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3261
  %fi3 = call double @injectFault2(i64 3221, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3231
  %37 = fmul double %fi3, %0, !llfi_index !3262
  %fi4 = call double @injectFault2(i64 3222, double %37, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3231
  %38 = fadd double %34, %fi4, !llfi_index !3263
  ...
  %fi5 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3231
