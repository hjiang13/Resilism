...
13:                                               ; preds = %11, %7
  %14 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 44, i32 0, i32 0, i32 0, i32 0, !llfi_index !27
  %fi = call double** @injectFault0(i64 20, double** %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !28
  %15 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !29
