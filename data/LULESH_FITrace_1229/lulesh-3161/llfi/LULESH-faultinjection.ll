...
12:                                               ; preds = %12, %7
  ...
  %fi = call i1 @injectFault0(i64 3161, i1 %19, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3198
  br i1 %fi, label %9, label %12, !llvm.loop !3199, !llfi_index !3200
