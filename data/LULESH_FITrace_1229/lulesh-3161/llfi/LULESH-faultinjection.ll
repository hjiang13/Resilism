...
12:                                               ; preds = %12, %7
  %13 = phi i64 [ 0, %7 ], [ %fi5, %12 ], !llfi_index !3191
  %fi4 = call i64 @injectFault1(i64 3154, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  %14 = getelementptr inbounds i32, i32* %4, i64 %fi4, !llfi_index !3192
  ...
  %18 = add nuw nsw i64 %fi4, 1, !llfi_index !3197
  %fi5 = call i64 @injectFault1(i64 3160, i64 %18, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  %19 = icmp eq i64 %fi5, %fi3, !llfi_index !3198
  %fi6 = call i1 @injectFault2(i64 3161, i1 %19, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  br i1 %fi6, label %9, label %12, !llvm.loop !3199, !llfi_index !3200
