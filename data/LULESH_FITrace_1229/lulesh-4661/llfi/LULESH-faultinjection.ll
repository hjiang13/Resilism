...
32:                                               ; preds = %32, %30
  %33 = phi i64 [ 0, %30 ], [ %fi6, %32 ], !llfi_index !4705
  ...
  %fi2 = call <2 x double>* @injectFault2(i64 4658, <2 x double>* %35, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %36 = load <2 x double>, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4709, !llfi_index !4712
  %fi3 = call <2 x double> @injectFault3(i64 4659, <2 x double> %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %37 = fadd <2 x double> %fi3, <double 1.000000e+00, double 1.000000e+00>, !llfi_index !4713
  %fi4 = call <2 x double> @injectFault3(i64 4660, <2 x double> %37, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %38 = fmul <2 x double> %fi4, <double 0x3FE5555555555555, double 0x3FE5555555555555>, !llfi_index !4714
  %fi5 = call <2 x double> @injectFault3(i64 4661, <2 x double> %38, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %39 = getelementptr inbounds double, double* %1, i64 %fi, !llfi_index !4715
  %40 = bitcast double* %39 to <2 x double>*, !llfi_index !4716
  store <2 x double> %fi5, <2 x double>* %40, align 8, !tbaa !345, !alias.scope !4717, !noalias !4719, !llfi_index !4721
  ...
  %fi6 = call i64 @injectFault0(i64 4668, i64 %43, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4706
  %44 = icmp eq i64 %fi6, %31, !llfi_index !4727
