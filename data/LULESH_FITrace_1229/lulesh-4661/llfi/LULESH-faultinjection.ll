...
32:                                               ; preds = %32, %30
  ...
  %fi = call <2 x double> @injectFault0(i64 4661, <2 x double> %38, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4714
  %39 = getelementptr inbounds double, double* %1, i64 %33, !llfi_index !4715
  %40 = bitcast double* %39 to <2 x double>*, !llfi_index !4716
  store <2 x double> %fi, <2 x double>* %40, align 8, !tbaa !345, !alias.scope !4717, !noalias !4719, !llfi_index !4721
  %41 = getelementptr inbounds double, double* %2, i64 %33, !llfi_index !4722
  %42 = bitcast double* %41 to <2 x double>*, !llfi_index !4723
  store <2 x double> <double 0x3FE5555555555555, double 0x3FE5555555555555>, <2 x double>* %42, align 8, !tbaa !345, !alias.scope !4724, !noalias !4708, !llfi_index !4725
...
!4716 = !{i64 4663}
!4717 = !{!4718}
!4718 = distinct !{!4718, !4710}
!4719 = !{!4720, !4709}
!4720 = distinct !{!4720, !4710}
!4721 = !{i64 4664}
!4722 = !{i64 4665}
!4723 = !{i64 4666}
!4724 = !{!4720}
