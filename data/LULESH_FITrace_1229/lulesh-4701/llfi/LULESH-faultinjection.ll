...
71:                                               ; preds = %106, %63
  ...
  %73 = getelementptr double, double* %1, i64 %72, !llfi_index !4759
  %fi = call double* @injectFault0(i64 4701, double* %73, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4760
  %74 = bitcast double* %fi to <2 x double>*, !llfi_index !4761
