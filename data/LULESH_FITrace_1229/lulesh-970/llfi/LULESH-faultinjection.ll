...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %40 = getelementptr [8 x double], [8 x double]* %0, i64 2, i64 6, !llfi_index !924
  %fi = call double* @injectFault0(i64 907, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !925
  %41 = bitcast double* %fi to <2 x double>*, !llfi_index !926
  %fi1 = call <2 x double>* @injectFault1(i64 908, <2 x double>* %41, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !925
  %42 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !927
  %fi2 = call <2 x double> @injectFault2(i64 909, <2 x double> %42, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !925
  ...
  %fi3 = call <2 x double> @injectFault2(i64 953, <2 x double> %78, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !925
  %79 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !972
  %fi4 = call <2 x double> @injectFault2(i64 954, <2 x double> %79, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !925
  ...
  %84 = fmul <2 x double> %fi4, %83, !llfi_index !978
  ...
  %91 = fneg <2 x double> %fi2, !llfi_index !987
  %fi5 = call <2 x double> @injectFault2(i64 969, <2 x double> %91, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !925
  %92 = fmul <2 x double> %fi4, %fi5, !llfi_index !988
  %fi6 = call <2 x double> @injectFault2(i64 970, <2 x double> %92, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !925
  %93 = bitcast double* %90 to <2 x double>*, !llfi_index !989
  store <2 x double> %fi6, <2 x double>* %93, align 8, !tbaa !345, !llfi_index !990
