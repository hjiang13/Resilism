...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1312, double* %48, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1333
  %49 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1334
  ...
  %70 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1356
  ...
  %92 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1379
  ...
  %110 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1398
  ...
  %132 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1421
  ...
  %172 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1463
  %fi = call double @injectFault0(i64 1442, double %172, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1333
