...
187:                                              ; preds = %185, %181
  %188 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 15, i32 0, i32 0, i32 0, i32 0, !llfi_index !232
  %fi = call i32** @injectFault0(i64 223, i32** %188, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !233
  %189 = load i32*, i32** %fi, align 8, !tbaa !168, !llfi_index !234
