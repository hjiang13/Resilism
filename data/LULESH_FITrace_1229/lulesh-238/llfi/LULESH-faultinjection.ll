...
199:                                              ; preds = %197, %193
  ...
  %fi = call i32* @injectFault0(i64 238, i32* %201, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !248
  %202 = icmp eq i32* %fi, null, !llfi_index !249
  br i1 %202, label %205, label %203, !llfi_index !250

203:                                              ; preds = %199
  %204 = bitcast i32* %fi to i8*, !llfi_index !251
