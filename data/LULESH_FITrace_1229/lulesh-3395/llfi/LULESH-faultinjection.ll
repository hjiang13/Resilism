...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %11 = getelementptr double, double* %0, i64 4, !llfi_index !3435
  %fi = call double* @injectFault0(i64 3394, double* %11, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3436
  %12 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3437
  %fi1 = call double @injectFault1(i64 3395, double %12, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3436
