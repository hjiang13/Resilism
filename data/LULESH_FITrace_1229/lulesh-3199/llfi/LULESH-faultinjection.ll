...
13:                                               ; preds = %13, %11
  %14 = phi i64 [ 0, %11 ], [ %fi4, %13 ], !llfi_index !3237
  %fi1 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %15 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3238
  %fi2 = call double* @injectFault0(i64 3198, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %16 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3239
  %fi3 = call double @injectFault2(i64 3199, double %16, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  ...
  %20 = fadd double %fi3, %19, !llfi_index !3243
  ...
  store double %23, double* %fi2, align 8, !tbaa !345, !llfi_index !3247
  ...
  %fi4 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %43 = icmp eq i64 %fi4, %12, !llfi_index !3269
