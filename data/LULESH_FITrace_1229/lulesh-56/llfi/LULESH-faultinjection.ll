...
43:                                               ; preds = %41, %37
  ...
  %fi = call double* @injectFault0(i64 56, double* %45, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !64
  %46 = icmp eq double* %fi, null, !llfi_index !65
  br i1 %46, label %49, label %47, !llfi_index !66

47:                                               ; preds = %43
  %48 = bitcast double* %fi to i8*, !llfi_index !67
