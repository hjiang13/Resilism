...
19:                                               ; preds = %17, %13
  ...
  %fi = call double* @injectFault0(i64 28, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !36
  %22 = icmp eq double* %fi, null, !llfi_index !37
  br i1 %22, label %25, label %23, !llfi_index !38

23:                                               ; preds = %19
  %24 = bitcast double* %fi to i8*, !llfi_index !39
