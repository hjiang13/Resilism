...
163:                                              ; preds = %163, %154
  ...
  %165 = getelementptr i32, i32* %157, i64 %164, !llfi_index !6031
  %fi = call i32* @injectFault0(i64 5899, i32* %165, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !6032
  %166 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !6033
