...
223:                                              ; preds = %221, %217
  ...
  %fi = call double* @injectFault0(i64 266, double* %225, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !276
  %226 = icmp eq double* %fi, null, !llfi_index !277
  br i1 %226, label %229, label %227, !llfi_index !278

227:                                              ; preds = %223
  %228 = bitcast double* %fi to i8*, !llfi_index !279
