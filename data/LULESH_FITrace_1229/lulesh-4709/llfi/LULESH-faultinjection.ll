...
71:                                               ; preds = %106, %63
  ...
  %81 = call <2 x double> @llvm.fabs.v2f64(<2 x double> %79), !llfi_index !4772
  %fi = call <2 x double> @injectFault0(i64 4709, <2 x double> %81, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !4773
  %82 = fcmp olt <2 x double> %fi, %66, !llfi_index !4774
