...
71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi9, %106 ], !llfi_index !4758
  ...
  %73 = getelementptr double, double* %1, i64 %fi, !llfi_index !4760
  %fi1 = call double* @injectFault1(i64 4701, double* %73, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %74 = bitcast double* %fi1 to <2 x double>*, !llfi_index !4761
  %fi2 = call <2 x double>* @injectFault2(i64 4702, <2 x double>* %74, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %75 = load <2 x double>, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4762, !llfi_index !4765
  %fi3 = call <2 x double> @injectFault3(i64 4703, <2 x double> %75, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %76 = getelementptr double, double* %3, i64 %fi, !llfi_index !4766
  %fi4 = call double* @injectFault1(i64 4704, double* %76, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %77 = bitcast double* %fi4 to <2 x double>*, !llfi_index !4767
  %fi5 = call <2 x double>* @injectFault2(i64 4705, <2 x double>* %77, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %78 = load <2 x double>, <2 x double>* %fi5, align 8, !tbaa !345, !alias.scope !4768, !llfi_index !4770
  %fi6 = call <2 x double> @injectFault3(i64 4706, <2 x double> %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %79 = fmul <2 x double> %fi3, %fi6, !llfi_index !4771
  %fi7 = call <2 x double> @injectFault3(i64 4707, <2 x double> %79, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %80 = getelementptr inbounds double, double* %0, i64 %fi, !llfi_index !4772
  %81 = call <2 x double> @llvm.fabs.v2f64(<2 x double> %fi7), !llfi_index !4773
  %fi8 = call <2 x double> @injectFault3(i64 4709, <2 x double> %81, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %82 = fcmp olt <2 x double> %fi8, %66, !llfi_index !4774
  %83 = select <2 x i1> %82, <2 x double> zeroinitializer, <2 x double> %fi7, !llfi_index !4775
  ...
  %85 = getelementptr inbounds double, double* %5, i64 %fi, !llfi_index !4782
...
100:                                              ; preds = %98
  %101 = or i64 %fi, 1, !llfi_index !4800
...
106:                                              ; preds = %100, %98
  ...
  %fi9 = call i64 @injectFault0(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %108 = icmp eq i64 %fi9, %64, !llfi_index !4808
