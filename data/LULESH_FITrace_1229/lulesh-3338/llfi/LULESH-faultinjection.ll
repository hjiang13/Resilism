...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3337, <2 x double> %86, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3379
  %87 = insertelement <2 x double> %fi, double %15, i32 1, !llfi_index !3380
  %fi1 = call <2 x double> @injectFault0(i64 3338, <2 x double> %87, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3379
  %88 = fsub <2 x double> %fi1, %52, !llfi_index !3381
