...
7:                                                ; preds = %122
  ...
  %fi = call double* @injectFault0(i64 758, double* %22, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !775
  %23 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !776
  %fi1 = call double @injectFault1(i64 759, double %23, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !775
  ...
  %60 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !814
  ...
  %66 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !821
