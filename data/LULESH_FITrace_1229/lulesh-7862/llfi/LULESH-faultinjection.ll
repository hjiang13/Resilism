...
165:                                              ; preds = %165, %.preheader
  %166 = phi i64 [ %fi, %165 ], [ %.ph, %.preheader ], !llfi_index !8061
  ...
  %fi = call i64 @injectFault0(i64 7862, i64 %168, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !8065
  %169 = getelementptr inbounds double, double* %167, i64 1, !llfi_index !8066
  %170 = icmp eq i64 %fi, 0, !llfi_index !8067
