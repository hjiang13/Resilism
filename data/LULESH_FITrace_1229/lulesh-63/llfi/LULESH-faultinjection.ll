...
49:                                               ; preds = %47, %43
  ...
  %fi = call double* @injectFault0(i64 63, double* %51, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !71
  %52 = icmp eq double* %fi, null, !llfi_index !72
  br i1 %52, label %55, label %53, !llfi_index !73

53:                                               ; preds = %49
  %54 = bitcast double* %fi to i8*, !llfi_index !74
