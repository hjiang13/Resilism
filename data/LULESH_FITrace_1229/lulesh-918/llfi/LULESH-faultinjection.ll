...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %10 = getelementptr [8 x double], [8 x double]* %0, i64 0, i64 2, !llfi_index !894
  %fi = call double* @injectFault0(i64 877, double* %10, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %11 = bitcast double* %fi to <2 x double>*, !llfi_index !896
  %fi1 = call <2 x double>* @injectFault1(i64 878, <2 x double>* %11, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %12 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !897
  %fi2 = call <2 x double> @injectFault2(i64 879, <2 x double> %12, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !895
  ...
  %fi3 = call <2 x double> @injectFault2(i64 911, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %45 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !930
  %fi4 = call <2 x double> @injectFault2(i64 912, <2 x double> %45, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %46 = fmul <2 x double> %fi4, %43, !llfi_index !931
  ...
  %49 = fneg <2 x double> %fi2, !llfi_index !935
  %fi5 = call <2 x double> @injectFault2(i64 917, <2 x double> %49, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %50 = fmul <2 x double> %fi4, %fi5, !llfi_index !936
  %fi6 = call <2 x double> @injectFault2(i64 918, <2 x double> %50, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !895
  %51 = bitcast double* %48 to <2 x double>*, !llfi_index !937
  store <2 x double> %fi6, <2 x double>* %51, align 8, !tbaa !345, !llfi_index !938
  %52 = getelementptr inbounds double, double* %4, i64 4, !llfi_index !939
  %53 = fneg <2 x double> %15, !llfi_index !940
  %54 = fmul <2 x double> %fi4, %53, !llfi_index !941
  ...
  %58 = fmul <2 x double> %fi4, %57, !llfi_index !946
...
define <2 x double> @injectFault2(i64 %0, <2 x double> %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
