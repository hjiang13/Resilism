...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double>* @injectFault0(i64 4705, <2 x double>* %77, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4767
  %78 = load <2 x double>, <2 x double>* %fi, align 8, !tbaa !345, !alias.scope !4768, !llfi_index !4770
