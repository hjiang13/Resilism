...
169:                                              ; preds = %167, %163
  ...
  %fi = call i1 @injectFault0(i64 204, i1 %172, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !214
  br i1 %fi, label %175, label %173, !llfi_index !215
