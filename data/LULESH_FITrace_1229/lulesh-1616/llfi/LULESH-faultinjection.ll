...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi59 = call double @injectFault1(i64 1605, double %155, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %156 = fmul double %fi108, %fi59, !llfi_index !1627
  %fi60 = call double @injectFault1(i64 1606, double %156, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %157 = load double, double* %fi112, align 8, !tbaa !345, !llfi_index !1628
  %fi61 = call double @injectFault1(i64 1607, double %157, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %158 = fmul double %fi139, %fi61, !llfi_index !1629
  %fi62 = call double @injectFault1(i64 1608, double %158, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %159 = fadd double %fi60, %fi62, !llfi_index !1630
  %fi63 = call double @injectFault1(i64 1609, double %159, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %160 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1631
  %fi64 = call double @injectFault1(i64 1610, double %160, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %161 = fmul double %fi27, %fi64, !llfi_index !1632
  %fi65 = call double @injectFault1(i64 1611, double %161, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %162 = fadd double %fi63, %fi65, !llfi_index !1633
  %fi66 = call double @injectFault1(i64 1612, double %162, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %163 = load double, double* %fi31, align 8, !tbaa !345, !llfi_index !1634
  %fi67 = call double @injectFault1(i64 1613, double %163, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %164 = fmul double %fi58, %fi67, !llfi_index !1635
  %fi68 = call double @injectFault1(i64 1614, double %164, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %165 = fadd double %fi66, %fi68, !llfi_index !1636
  %fi69 = call double @injectFault1(i64 1615, double %165, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %166 = fmul double %fi69, %11, !llfi_index !1637
  %fi70 = call double @injectFault1(i64 1616, double %166, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %167 = getelementptr inbounds double, double* %12, i64 1, !llfi_index !1638
  store double %fi70, double* %167, align 8, !tbaa !345, !llfi_index !1639
  %168 = load double, double* %5, align 8, !tbaa !345, !llfi_index !1640
  %169 = fmul double %fi108, %168, !llfi_index !1641
  %170 = load double, double* %fi116, align 8, !tbaa !345, !llfi_index !1642
  %171 = fmul double %fi139, %170, !llfi_index !1643
  %172 = fadd double %169, %171, !llfi_index !1644
  %173 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1645
  %174 = fmul double %fi27, %173, !llfi_index !1646
  %175 = fadd double %172, %174, !llfi_index !1647
  %176 = load double, double* %fi35, align 8, !tbaa !345, !llfi_index !1648
  %177 = fmul double %fi58, %176, !llfi_index !1649
