...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %50 = fsub <2 x double> %fi1, %49, !llfi_index !3343
  ...
  %fi2 = call <2 x double> @injectFault0(i64 3334, <2 x double> %83, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3339
  %84 = insertelement <2 x double> %fi2, double %7, i32 1, !llfi_index !3377
  %fi3 = call <2 x double> @injectFault0(i64 3335, <2 x double> %84, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3339
  %85 = fsub <2 x double> %fi3, %fi1, !llfi_index !3378
  %fi4 = call <2 x double> @injectFault0(i64 3336, <2 x double> %85, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3339
  ...
  %112 = fadd <2 x double> %77, %fi4, !llfi_index !3406
