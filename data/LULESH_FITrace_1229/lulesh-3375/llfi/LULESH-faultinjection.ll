...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3294, <2 x double> %43, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %44 = insertelement <2 x double> %fi, double %19, i32 1, !llfi_index !3337
  %fi1 = call <2 x double> @injectFault0(i64 3295, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %45 = fsub <2 x double> %42, %fi1, !llfi_index !3338
  ...
  %fi2 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %56 = insertelement <2 x double> %fi2, double %18, i32 1, !llfi_index !3349
  %fi3 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  ...
  %59 = fsub <2 x double> %fi3, %58, !llfi_index !3352
  ...
  %fi4 = call <2 x double> @injectFault0(i64 3317, <2 x double> %66, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %67 = insertelement <2 x double> %fi4, double %4, i32 1, !llfi_index !3360
  ...
  %72 = insertelement <2 x double> %fi2, double %5, i32 1, !llfi_index !3365
  ...
  %81 = insertelement <2 x double> %fi4, double %17, i32 1, !llfi_index !3374
  %fi5 = call <2 x double> @injectFault0(i64 3332, <2 x double> %81, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %82 = fsub <2 x double> %fi1, %fi5, !llfi_index !3375
  %fi6 = call <2 x double> @injectFault0(i64 3333, <2 x double> %82, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  ...
  %fi7 = call <2 x double> @injectFault0(i64 3340, <2 x double> %89, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %90 = insertelement <2 x double> %fi7, double %23, i32 1, !llfi_index !3383
  %fi8 = call <2 x double> @injectFault0(i64 3341, <2 x double> %90, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  %91 = fsub <2 x double> %fi8, %fi3, !llfi_index !3384
  %fi9 = call <2 x double> @injectFault0(i64 3342, <2 x double> %91, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  ...
  %123 = fadd <2 x double> %fi6, %fi9, !llfi_index !3417
  %fi10 = call <2 x double> @injectFault0(i64 3375, <2 x double> %123, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3336
  ...
  %127 = fmul <2 x double> %126, %fi10, !llfi_index !3421
