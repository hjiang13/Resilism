...
19:                                               ; preds = %17, %13
  ...
  %fi = call i1 @injectFault0(i64 29, i1 %22, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br i1 %fi, label %25, label %23, !llfi_index !38
