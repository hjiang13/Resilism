...
181:                                              ; preds = %179, %175
  ...
  %fi = call i1 @injectFault0(i64 218, i1 %184, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !228
  br i1 %fi, label %187, label %185, !llfi_index !229
