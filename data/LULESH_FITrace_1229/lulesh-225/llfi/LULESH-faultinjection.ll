...
187:                                              ; preds = %185, %181
  ...
  %fi = call i1 @injectFault0(i64 225, i1 %190, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !235
  br i1 %fi, label %193, label %191, !llfi_index !236
