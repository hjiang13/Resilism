...
12:                                               ; preds = %12, %10
  ...
  %29 = getelementptr double, double* %8, i64 %13, !llfi_index !3301
  %fi = call double* @injectFault0(i64 3261, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3302
  %30 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3303
  %31 = fadd double %28, %30, !llfi_index !3304
  store double %31, double* %fi, align 8, !tbaa !345, !llfi_index !3305
