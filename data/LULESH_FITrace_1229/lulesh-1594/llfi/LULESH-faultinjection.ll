...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %50 = getelementptr double, double* %0, i64 7, !llfi_index !1519
  %fi3 = call double* @injectFault0(i64 1499, double* %50, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1520
  %51 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1521
  %fi4 = call double @injectFault1(i64 1500, double %51, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1520
  %52 = fmul double %49, %fi4, !llfi_index !1522
  ...
  %83 = fmul double %fi4, %82, !llfi_index !1553
  ...
  %114 = fmul double %fi4, %113, !llfi_index !1584
  ...
  %fi = call double* @injectFault0(i64 1592, double* %143, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1520
  %144 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1614
  %fi1 = call double @injectFault1(i64 1593, double %144, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1520
  %145 = fmul double %fi4, %fi1, !llfi_index !1615
  %fi2 = call double @injectFault1(i64 1594, double %145, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1520
  %146 = fadd double %142, %fi2, !llfi_index !1616
  ...
  %241 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1718
  ...
  %350 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1828
  ...
  %447 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1932
  ...
  %556 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2042
  ...
  %653 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2146
