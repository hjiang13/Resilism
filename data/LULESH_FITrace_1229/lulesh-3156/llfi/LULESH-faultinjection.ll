...
12:                                               ; preds = %12, %7
  %13 = phi i64 [ 0, %7 ], [ %fi4, %12 ], !llfi_index !3191
  ...
  %fi4 = call i64 @injectFault1(i64 3160, i64 %18, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3182
  %19 = icmp eq i64 %fi4, %8, !llfi_index !3198
