...
12:                                               ; preds = %12, %7
  ...
  %fi = call i32 @injectFault0(i64 3156, i32 %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3193
  %16 = sext i32 %fi to i64, !llfi_index !3194
