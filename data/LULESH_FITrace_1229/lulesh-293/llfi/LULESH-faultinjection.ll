...
247:                                              ; preds = %245, %241
  %248 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 5, i32 0, i32 0, i32 0, i32 0, !llfi_index !302
  %fi = call double** @injectFault0(i64 293, double** %248, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !303
  %249 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !304
