...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi2 = call i64 @injectFault2(i64 1116, i64 %32, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %33 = getelementptr inbounds double, double* %21, i64 %fi2, !llfi_index !1138
  ...
  %fi3 = call double* @injectFault3(i64 1141, double* %52, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  ...
  %61 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1174
  %fi4 = call double* @injectFault3(i64 1153, double* %61, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %62 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1175
  %fi5 = call double @injectFault4(i64 1154, double %62, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1112
  %63 = getelementptr inbounds double, double* %2, i64 3, !llfi_index !1176
  store double %fi5, double* %63, align 8, !tbaa !345, !llfi_index !1177
  ...
  %85 = getelementptr inbounds double, double* %76, i64 %fi2, !llfi_index !1206
