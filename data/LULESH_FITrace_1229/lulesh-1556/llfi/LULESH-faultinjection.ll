...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi20 = call double @injectFault1(i64 1466, double %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %18 = fmul double %16, %fi20, !llfi_index !1488
  %19 = load double, double* %4, align 8, !tbaa !345, !llfi_index !1489
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1490
  %fi21 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %21 = load double, double* %fi21, align 8, !tbaa !345, !llfi_index !1491
  %fi22 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %22 = fmul double %19, %fi22, !llfi_index !1492
  ...
  %fi23 = call double* @injectFault0(i64 1474, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %26 = load double, double* %fi23, align 8, !tbaa !345, !llfi_index !1496
  %fi24 = call double @injectFault1(i64 1475, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %27 = fmul double %24, %fi24, !llfi_index !1497
  ...
  %fi25 = call double* @injectFault0(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %31 = load double, double* %fi25, align 8, !tbaa !345, !llfi_index !1501
  %fi26 = call double @injectFault1(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %32 = fmul double %29, %fi26, !llfi_index !1502
  ...
  %fi27 = call double* @injectFault0(i64 1484, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %36 = load double, double* %fi27, align 8, !tbaa !345, !llfi_index !1506
  %fi28 = call double @injectFault1(i64 1485, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %37 = fmul double %34, %fi28, !llfi_index !1507
  ...
  %fi29 = call double* @injectFault0(i64 1489, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %41 = load double, double* %fi29, align 8, !tbaa !345, !llfi_index !1511
  %fi30 = call double @injectFault1(i64 1490, double %41, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %42 = fmul double %39, %fi30, !llfi_index !1512
  ...
  %63 = fmul double %fi24, %62, !llfi_index !1533
  ...
  %67 = fmul double %fi26, %66, !llfi_index !1537
  ...
  %71 = fmul double %fi28, %70, !llfi_index !1541
  ...
  %75 = fmul double %fi30, %74, !llfi_index !1545
  ...
  %fi31 = call double* @injectFault0(i64 1534, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %86 = load double, double* %fi31, align 8, !tbaa !345, !llfi_index !1556
  %fi32 = call double @injectFault1(i64 1535, double %86, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %87 = fmul double %fi20, %fi32, !llfi_index !1557
  %fi33 = call double @injectFault1(i64 1536, double %87, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  ...
  %90 = fmul double %fi22, %fi1, !llfi_index !1560
  ...
  %91 = fadd double %fi33, %fi2, !llfi_index !1561
  ...
  %94 = fmul double %fi24, %fi5, !llfi_index !1564
  ...
  %98 = fmul double %fi26, %fi9, !llfi_index !1568
  ...
  %102 = fmul double %fi28, %fi13, !llfi_index !1572
  ...
  %106 = fmul double %fi30, %fi17, !llfi_index !1576
  ...
  %111 = fadd double %fi19, %110, !llfi_index !1581
  ...
  %118 = fmul double %fi20, %117, !llfi_index !1588
  ...
  %121 = fmul double %fi22, %120, !llfi_index !1591
  ...
  %125 = fmul double %fi24, %124, !llfi_index !1595
  ...
  %129 = fmul double %fi26, %128, !llfi_index !1599
  ...
  %133 = fmul double %fi28, %132, !llfi_index !1603
  ...
  %150 = fmul double %fi32, %115, !llfi_index !1620
  ...
  %307 = load double, double* %fi31, align 8, !tbaa !345, !llfi_index !1785
  ...
  %513 = load double, double* %fi31, align 8, !tbaa !345, !llfi_index !1999
