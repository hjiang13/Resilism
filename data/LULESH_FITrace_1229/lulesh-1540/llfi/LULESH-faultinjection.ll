...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi4 = call double @injectFault1(i64 1466, double %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %18 = fmul double %16, %fi4, !llfi_index !1488
  %19 = load double, double* %4, align 8, !tbaa !345, !llfi_index !1489
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1490
  %fi5 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %21 = load double, double* %fi5, align 8, !tbaa !345, !llfi_index !1491
  %fi6 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %22 = fmul double %19, %fi6, !llfi_index !1492
  ...
  %fi7 = call double* @injectFault0(i64 1534, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %86 = load double, double* %fi7, align 8, !tbaa !345, !llfi_index !1556
  %fi8 = call double @injectFault1(i64 1535, double %86, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %87 = fmul double %fi4, %fi8, !llfi_index !1557
  %fi9 = call double @injectFault1(i64 1536, double %87, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  ...
  %90 = fmul double %fi6, %fi1, !llfi_index !1560
  ...
  %91 = fadd double %fi9, %fi2, !llfi_index !1561
  ...
  %95 = fadd double %fi3, %94, !llfi_index !1565
  ...
  %150 = fmul double %fi8, %115, !llfi_index !1620
  ...
  %307 = load double, double* %fi7, align 8, !tbaa !345, !llfi_index !1785
  ...
  %513 = load double, double* %fi7, align 8, !tbaa !345, !llfi_index !1999
