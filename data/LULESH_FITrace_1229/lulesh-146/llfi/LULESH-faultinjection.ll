...
121:                                              ; preds = %119, %115
  %122 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 26, i32 0, i32 0, i32 0, i32 0, !llfi_index !153
  %fi = call double** @injectFault0(i64 146, double** %122, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !154
  %123 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !155
