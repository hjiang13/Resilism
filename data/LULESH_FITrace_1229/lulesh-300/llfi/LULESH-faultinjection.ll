...
253:                                              ; preds = %251, %247
  %254 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 4, i32 0, i32 0, i32 0, i32 0, !llfi_index !309
  %fi = call double** @injectFault0(i64 300, double** %254, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !310
  %255 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !311
