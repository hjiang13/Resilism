...
71:                                               ; preds = %106, %63
  ...
  %80 = getelementptr double, double* %0, i64 %72, !llfi_index !4771
  %fi = call double* @injectFault0(i64 4708, double* %80, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4772
  ...
  %84 = bitcast double* %fi to <2 x double>*, !llfi_index !4776
...
94:                                               ; preds = %71
  ...
  store double %97, double* %fi, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4796
