...
31:                                               ; preds = %31, %20
  ...
  %fi1 = call i64 @injectFault1(i64 3176, i64 %32, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %33 = getelementptr i32, i32* %fi, i64 %fi1, !llfi_index !3216
  %fi2 = call i32* @injectFault0(i64 3177, i32* %33, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %34 = load i32, i32* %fi2, align 4, !tbaa !404, !llfi_index !3217
  %fi3 = call i32 @injectFault2(i64 3178, i32 %34, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %35 = sext i32 %fi3 to i64, !llfi_index !3218
  %fi4 = call i64 @injectFault1(i64 3179, i64 %35, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %36 = getelementptr inbounds double, double* %22, i64 %fi4, !llfi_index !3219
  store double 0.000000e+00, double* %36, align 8, !tbaa !345, !llfi_index !3220
  %37 = add nuw nsw i64 %fi1, 1, !llfi_index !3221
  %fi5 = call i64 @injectFault1(i64 3182, i64 %37, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %38 = icmp eq i64 %fi5, %8, !llfi_index !3222
