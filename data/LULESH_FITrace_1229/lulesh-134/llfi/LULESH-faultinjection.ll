...
109:                                              ; preds = %107, %103
  ...
  %fi = call i1 @injectFault0(i64 134, i1 %112, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !142
  br i1 %fi, label %115, label %113, !llfi_index !143
