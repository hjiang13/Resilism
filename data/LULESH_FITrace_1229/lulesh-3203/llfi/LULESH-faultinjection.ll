...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3203, double %20, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3243
  %21 = tail call double @llvm.fabs.f64(double %fi) #2, !llfi_index !3244
  %22 = fcmp olt double %21, %1, !llfi_index !3245
  %23 = select i1 %22, double 0.000000e+00, double %fi, !llfi_index !3246
