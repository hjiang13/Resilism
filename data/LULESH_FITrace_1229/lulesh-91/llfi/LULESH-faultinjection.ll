...
73:                                               ; preds = %71, %67
  ...
  %fi = call double* @injectFault0(i64 91, double* %75, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !99
  %76 = icmp eq double* %fi, null, !llfi_index !100
  br i1 %76, label %79, label %77, !llfi_index !101

77:                                               ; preds = %73
  %78 = bitcast double* %fi to i8*, !llfi_index !102
