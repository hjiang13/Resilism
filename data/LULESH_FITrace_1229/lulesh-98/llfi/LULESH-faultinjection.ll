...
79:                                               ; preds = %77, %73
  ...
  %fi = call double* @injectFault0(i64 98, double* %81, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !106
  %82 = icmp eq double* %fi, null, !llfi_index !107
  br i1 %82, label %85, label %83, !llfi_index !108

83:                                               ; preds = %79
  %84 = bitcast double* %fi to i8*, !llfi_index !109
