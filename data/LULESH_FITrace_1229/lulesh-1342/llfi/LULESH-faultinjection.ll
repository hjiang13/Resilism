...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %29 = getelementptr double, double* %4, i64 7, !llfi_index !1312
  %fi = call double* @injectFault0(i64 1292, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1313
  %30 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1314
  ...
  %53 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1338
  ...
  %77 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1363
  %fi1 = call double @injectFault1(i64 1342, double %77, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1313
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %67, double %68, double %69, double %70, double %71, double %72, double %73, double %74, double %75, double %76, double %fi1, double %78, double %79, double %80, double %81, double %82, double %83, double %84, double* nonnull %85, double* nonnull %86, double* nonnull %87), !llfi_index !1374
  ...
  %115 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1403
  ...
  %137 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1426
  ...
  %159 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1449
