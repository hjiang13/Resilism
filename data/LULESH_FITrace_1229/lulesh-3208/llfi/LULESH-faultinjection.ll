...
13:                                               ; preds = %13, %11
  ...
  %fi3 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3228
  %43 = icmp eq i64 %fi3, %12, !llfi_index !3269
