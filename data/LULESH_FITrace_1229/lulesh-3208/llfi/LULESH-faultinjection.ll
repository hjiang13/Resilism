...
13:                                               ; preds = %13, %11
  ...
  %24 = getelementptr double, double* %6, i64 %14, !llfi_index !3247
  %fi = call double* @injectFault0(i64 3208, double* %24, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3248
  %25 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3249
  ...
  store double %32, double* %fi, align 8, !tbaa !345, !llfi_index !3257
