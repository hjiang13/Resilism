...
41:                                               ; preds = %52
  ...
  %45 = getelementptr double, double* %2, i64 %34, !llfi_index !1047
  %fi = call double* @injectFault0(i64 1030, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1048
  %46 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1049
