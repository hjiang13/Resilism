...
41:                                               ; preds = %52
  ...
  %47 = getelementptr double, double* %3, i64 %34, !llfi_index !1049
  %fi = call double* @injectFault0(i64 1032, double* %47, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1050
  %48 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1051
