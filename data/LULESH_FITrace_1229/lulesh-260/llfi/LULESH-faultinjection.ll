...
217:                                              ; preds = %215, %211
  ...
  %fi = call i1 @injectFault0(i64 260, i1 %220, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !270
  br i1 %fi, label %223, label %221, !llfi_index !271
