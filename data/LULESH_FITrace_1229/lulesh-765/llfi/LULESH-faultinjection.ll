...
7:                                                ; preds = %122
  ...
  %28 = getelementptr double, double* %4, i64 2, !llfi_index !780
  %fi = call double* @injectFault0(i64 764, double* %28, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !781
  %29 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !782
  %fi1 = call double @injectFault1(i64 765, double %29, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !781
  ...
  %78 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !833
  ...
  %84 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !840
