...
23:                                               ; preds = %23, %9
  %24 = phi i64 [ 0, %9 ], [ %fi5, %23 ], !llfi_index !3204
  %fi4 = call i64 @injectFault1(i64 3166, i64 %24, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  %25 = getelementptr inbounds i32, i32* %10, i64 %fi4, !llfi_index !3205
  ...
  %29 = add nuw nsw i64 %fi4, 1, !llfi_index !3210
  %fi5 = call i64 @injectFault1(i64 3172, i64 %29, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  %30 = icmp eq i64 %fi5, %fi3, !llfi_index !3211
  %fi6 = call i1 @injectFault2(i64 3173, i1 %30, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3179
  br i1 %fi6, label %20, label %23, !llvm.loop !3212, !llfi_index !3213
...
31:                                               ; preds = %31, %20
  ...
  %38 = icmp eq i64 %37, %fi3, !llfi_index !3222
