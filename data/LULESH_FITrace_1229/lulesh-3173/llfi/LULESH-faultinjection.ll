...
23:                                               ; preds = %23, %9
  ...
  %fi = call i1 @injectFault0(i64 3173, i1 %30, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !3211
  br i1 %fi, label %20, label %23, !llvm.loop !3212, !llfi_index !3213
