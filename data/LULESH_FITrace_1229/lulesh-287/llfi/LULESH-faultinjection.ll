...
241:                                              ; preds = %239, %235
  ...
  %fi = call double* @injectFault0(i64 287, double* %243, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !297
  %244 = icmp eq double* %fi, null, !llfi_index !298
  br i1 %244, label %247, label %245, !llfi_index !299

245:                                              ; preds = %241
  %246 = bitcast double* %fi to i8*, !llfi_index !300
