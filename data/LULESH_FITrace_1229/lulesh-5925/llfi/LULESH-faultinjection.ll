...
182:                                              ; preds = %182, %158
  %183 = phi i64 [ 0, %158 ], [ %fi8, %182 ], !llfi_index !6058
  ...
  %fi8 = call i64 @injectFault1(i64 5931, i64 %190, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %191 = icmp eq i64 %fi8, 8, !llfi_index !6067
