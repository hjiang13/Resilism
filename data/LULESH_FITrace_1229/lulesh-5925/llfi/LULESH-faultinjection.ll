...
182:                                              ; preds = %182, %158
  ...
  %fi = call i32 @injectFault0(i64 5925, i32 %185, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !6060
  %186 = sext i32 %fi to i64, !llfi_index !6061
