...
55:                                               ; preds = %53, %49
  %56 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 37, i32 0, i32 0, i32 0, i32 0, !llfi_index !76
  %fi = call double** @injectFault0(i64 69, double** %56, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !77
  %57 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !78
