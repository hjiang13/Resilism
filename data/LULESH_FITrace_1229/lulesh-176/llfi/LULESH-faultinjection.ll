...
145:                                              ; preds = %143, %139
  ...
  %fi = call i1 @injectFault0(i64 176, i1 %148, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !186
  br i1 %fi, label %151, label %149, !llfi_index !187
