...
27:                                               ; preds = %24
  ...
  %fi = call double @injectFault0(i64 363, double %28, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !375
  %29 = fcmp ogt double %22, %fi, !llfi_index !376
  br i1 %29, label %30, label %32, !llfi_index !377

30:                                               ; preds = %27
  %31 = fmul double %9, %fi, !llfi_index !378
