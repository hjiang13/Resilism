...
12:                                               ; preds = %12, %10
  ...
  %17 = getelementptr double, double* %4, i64 %13, !llfi_index !3287
  %fi = call double* @injectFault0(i64 3247, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3288
  %18 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3289
  %19 = fadd double %16, %18, !llfi_index !3290
  store double %19, double* %fi, align 8, !tbaa !345, !llfi_index !3291
