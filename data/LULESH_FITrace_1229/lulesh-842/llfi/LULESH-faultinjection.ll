...
7:                                                ; preds = %122
  ...
  %91 = getelementptr double, double* %4, i64 7, !llfi_index !846
  %fi = call double* @injectFault0(i64 830, double* %91, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !847
  %92 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !848
  ...
  %102 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !859
  %fi1 = call double @injectFault1(i64 842, double %102, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !847
  ...
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %14, double* nonnull %15, double* nonnull %16, double* nonnull %80, double* nonnull %81, double* nonnull %82, double* nonnull %38, double* nonnull %39, double* nonnull %40, double* nonnull %0, double* nonnull %1, double* nonnull %2, double %98, double %99, double %100, double %101, double %fi1, double %103, double %104, double %105, double %106, double %107, double %108, double %109), !llfi_index !867
  ...
  %114 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !872
