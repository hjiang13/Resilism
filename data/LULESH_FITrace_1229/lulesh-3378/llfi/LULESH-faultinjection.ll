...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi11 = call <2 x double> @injectFault0(i64 3297, <2 x double> %46, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %47 = insertelement <2 x double> %fi11, double %2, i32 1, !llfi_index !3340
  %fi12 = call <2 x double> @injectFault0(i64 3298, <2 x double> %47, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %48 = insertelement <2 x double> poison, double %0, i32 0, !llfi_index !3341
  %fi13 = call <2 x double> @injectFault0(i64 3299, <2 x double> %48, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %49 = shufflevector <2 x double> %fi13, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3342
  %fi14 = call <2 x double> @injectFault0(i64 3300, <2 x double> %49, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %50 = fsub <2 x double> %fi12, %fi14, !llfi_index !3343
  %fi15 = call <2 x double> @injectFault0(i64 3301, <2 x double> %50, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %51 = insertelement <2 x double> poison, double %13, i32 0, !llfi_index !3344
  %fi16 = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %52 = insertelement <2 x double> %fi16, double %10, i32 1, !llfi_index !3345
  %fi17 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %53 = shufflevector <2 x double> %fi, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %fi18 = call <2 x double> @injectFault0(i64 3304, <2 x double> %53, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %54 = fsub <2 x double> %fi17, %fi18, !llfi_index !3347
  %fi19 = call <2 x double> @injectFault0(i64 3305, <2 x double> %54, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  ...
  %85 = fsub <2 x double> %84, %fi12, !llfi_index !3378
  ...
  %88 = fsub <2 x double> %87, %fi17, !llfi_index !3381
  ...
  %114 = fmul <2 x double> %fi19, %45, !llfi_index !3408
  ...
  %118 = fmul <2 x double> %fi15, %45, !llfi_index !3412
  ...
  %124 = fmul <2 x double> %fi5, %fi19, !llfi_index !3418
  %fi20 = call <2 x double> @injectFault0(i64 3376, <2 x double> %124, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %125 = fmul <2 x double> %fi15, %fi10, !llfi_index !3419
  %fi21 = call <2 x double> @injectFault0(i64 3377, <2 x double> %125, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %126 = fsub <2 x double> %fi20, %fi21, !llfi_index !3420
  %fi22 = call <2 x double> @injectFault0(i64 3378, <2 x double> %126, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3321
  %127 = fmul <2 x double> %fi22, %123, !llfi_index !3421
