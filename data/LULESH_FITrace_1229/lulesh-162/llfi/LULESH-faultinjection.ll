...
133:                                              ; preds = %131, %127
  ...
  %fi = call i1 @injectFault0(i64 162, i1 %136, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !172
  br i1 %fi, label %139, label %137, !llfi_index !173
