...
7:                                                ; preds = %122
  ...
  %49 = getelementptr double, double* %4, i64 4, !llfi_index !802
  %fi = call double* @injectFault0(i64 786, double* %49, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !803
  %50 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !804
  ...
  %105 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !862
  %fi1 = call double @injectFault1(i64 845, double %105, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !803
  ...
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %14, double* nonnull %15, double* nonnull %16, double* nonnull %80, double* nonnull %81, double* nonnull %82, double* nonnull %38, double* nonnull %39, double* nonnull %40, double* nonnull %0, double* nonnull %1, double* nonnull %2, double %98, double %99, double %100, double %101, double %102, double %103, double %104, double %fi1, double %106, double %107, double %108, double %109), !llfi_index !867
  %110 = load double, double* %47, align 8, !tbaa !345, !llfi_index !868
  %111 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !869
