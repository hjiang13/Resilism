...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %16 = getelementptr [8 x double], [8 x double]* %0, i64 0, i64 6, !llfi_index !900
  %fi = call double* @injectFault0(i64 883, double* %16, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !901
  %17 = bitcast double* %fi to <2 x double>*, !llfi_index !902
  %fi1 = call <2 x double>* @injectFault1(i64 884, <2 x double>* %17, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !901
  %18 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !903
  %fi2 = call <2 x double> @injectFault2(i64 885, <2 x double> %18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !901
  ...
  %fi3 = call <2 x double> @injectFault2(i64 911, <2 x double> %44, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !901
  %45 = shufflevector <2 x double> %fi3, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !930
  %fi4 = call <2 x double> @injectFault2(i64 912, <2 x double> %45, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !901
  ...
  %57 = fneg <2 x double> %fi2, !llfi_index !945
  %fi5 = call <2 x double> @injectFault2(i64 927, <2 x double> %57, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !901
  %58 = fmul <2 x double> %fi4, %fi5, !llfi_index !946
  %fi6 = call <2 x double> @injectFault2(i64 928, <2 x double> %58, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !901
  %59 = bitcast double* %56 to <2 x double>*, !llfi_index !947
  store <2 x double> %fi6, <2 x double>* %59, align 8, !tbaa !345, !llfi_index !948
