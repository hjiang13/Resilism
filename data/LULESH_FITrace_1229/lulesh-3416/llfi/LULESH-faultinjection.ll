...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %32 = getelementptr double, double* %1, i64 7, !llfi_index !3456
  %fi = call double* @injectFault0(i64 3415, double* %32, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3457
  %33 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3458
  %fi1 = call double @injectFault1(i64 3416, double %33, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3457
