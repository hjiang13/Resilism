...
182:                                              ; preds = %182, %158
  ...
  %fi = call double @injectFault0(i64 5929, double %189, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !6064
  store double %fi, double* %187, align 8, !tbaa !345, !llfi_index !6065
