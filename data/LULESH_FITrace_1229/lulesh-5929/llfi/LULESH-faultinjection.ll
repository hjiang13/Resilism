...
define dso_local i32 @main(i32 %0, i8** nocapture readonly %1) local_unnamed_addr #21 {
  ...
  %fi = call [8 x double]* @injectFault0(i64 5686, [8 x double]* %3, i32 31, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %4 = alloca [8 x double], align 16, !llfi_index !5811
  %fi1 = call [8 x double]* @injectFault0(i64 5687, [8 x double]* %4, i32 31, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %5 = alloca [8 x double], align 16, !llfi_index !5812
  %fi2 = call [8 x double]* @injectFault0(i64 5688, [8 x double]* %5, i32 31, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !5810
...
.loopexit35:                                      ; preds = %138, %121, %.loopexit37
  ...
  %123 = bitcast [8 x double]* %fi to i8*, !llfi_index !5981
  %124 = bitcast [8 x double]* %fi1 to i8*, !llfi_index !5982
  %125 = bitcast [8 x double]* %fi2 to i8*, !llfi_index !5983
  ...
  %fi3 = call i32* @injectFault1(i64 5852, i32* %126, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  ...
  %130 = getelementptr [8 x double], [8 x double]* %fi, i64 0, i64 0, !llfi_index !5988
  %fi4 = call double* @injectFault2(i64 5856, double* %130, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %131 = getelementptr [8 x double], [8 x double]* %fi1, i64 0, i64 0, !llfi_index !5989
  %fi5 = call double* @injectFault2(i64 5857, double* %131, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %132 = getelementptr [8 x double], [8 x double]* %fi2, i64 0, i64 0, !llfi_index !5990
  %fi6 = call double* @injectFault2(i64 5858, double* %132, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  ...
  %fi7 = call double* @injectFault2(i64 5861, double* %135, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5810
...
154:                                              ; preds = %179, %136
  %155 = phi i64 [ 0, %136 ], [ %fi13, %179 ], !llfi_index !6017
  %fi8 = call i64 @injectFault3(i64 5884, i64 %155, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  ...
  %156 = shl nsw i64 %fi8, 3, !llfi_index !6021
  %fi9 = call i64 @injectFault3(i64 5888, i64 %156, i32 25, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %157 = getelementptr i32, i32* %fi3, i64 %fi9, !llfi_index !6022
  %fi10 = call i32* @injectFault1(i64 5889, i32* %157, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  br label %163, !llfi_index !6023

158:                                              ; preds = %163
  %159 = call double @_Z14CalcElemVolumePKdS0_S0_(double* nonnull %fi4, double* nonnull %fi5, double* nonnull %fi6), !llfi_index !6024
  %fi11 = call double @injectFault4(i64 5891, double %159, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %160 = getelementptr inbounds double, double* %133, i64 %fi8, !llfi_index !6025
  store double %fi11, double* %160, align 8, !tbaa !345, !llfi_index !6026
  %161 = getelementptr inbounds double, double* %134, i64 %fi8, !llfi_index !6027
  store double %fi11, double* %161, align 8, !tbaa !345, !llfi_index !6028
  %162 = fmul double %fi11, 1.250000e-01, !llfi_index !6029
  %fi12 = call double @injectFault4(i64 5896, double %162, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  br label %182, !llfi_index !6030

163:                                              ; preds = %163, %154
  %164 = phi i64 [ 0, %154 ], [ %177, %163 ], !llfi_index !6031
  %165 = getelementptr inbounds i32, i32* %fi10, i64 %164, !llfi_index !6032
  ...
  %170 = getelementptr inbounds [8 x double], [8 x double]* %fi, i64 0, i64 %164, !llfi_index !6037
  ...
  %173 = getelementptr inbounds [8 x double], [8 x double]* %fi1, i64 0, i64 %164, !llfi_index !6041
  ...
  %176 = getelementptr inbounds [8 x double], [8 x double]* %fi2, i64 0, i64 %164, !llfi_index !6045
...
179:                                              ; preds = %182
  ...
  %180 = add nuw nsw i64 %fi8, 1, !llfi_index !6054
  %fi13 = call i64 @injectFault3(i64 5920, i64 %180, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %181 = icmp eq i64 %fi13, %137, !llfi_index !6055
  br i1 %181, label %.loopexit34, label %154, !llvm.loop !6056, !llfi_index !6057

182:                                              ; preds = %182, %158
  %183 = phi i64 [ 0, %158 ], [ %fi21, %182 ], !llfi_index !6058
  %fi14 = call i64 @injectFault3(i64 5923, i64 %183, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %184 = getelementptr i32, i32* %fi10, i64 %fi14, !llfi_index !6059
  %fi15 = call i32* @injectFault1(i64 5924, i32* %184, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %185 = load i32, i32* %fi15, align 4, !tbaa !404, !llfi_index !6060
  %fi16 = call i32 @injectFault5(i64 5925, i32 %185, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %186 = sext i32 %fi16 to i64, !llfi_index !6061
  %fi17 = call i64 @injectFault3(i64 5926, i64 %186, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %187 = getelementptr double, double* %fi7, i64 %fi17, !llfi_index !6062
  %fi18 = call double* @injectFault2(i64 5927, double* %187, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %188 = load double, double* %fi18, align 8, !tbaa !345, !llfi_index !6063
  %fi19 = call double @injectFault4(i64 5928, double %188, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %189 = fadd double %fi12, %fi19, !llfi_index !6064
  %fi20 = call double @injectFault4(i64 5929, double %189, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  store double %fi20, double* %fi18, align 8, !tbaa !345, !llfi_index !6065
  %190 = add nuw nsw i64 %fi14, 1, !llfi_index !6066
  %fi21 = call i64 @injectFault3(i64 5931, i64 %190, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5810
  %191 = icmp eq i64 %fi21, 8, !llfi_index !6067
...
define [8 x double]* @injectFault0(i64 %0, [8 x double]* %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
  %tmploc = alloca [8 x double]*, align 8
  store [8 x double]* %1, [8 x double]** %tmploc, align 8
...
exit:                                             ; preds = %inject, %entry
  %updateval = load [8 x double]*, [8 x double]** %tmploc, align 8
...
define i32 @injectFault5(i64 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i8* %6) {
entry:
