...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi = call double @injectFault0(i64 1478, double %29, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1499
  %30 = getelementptr double, double* %0, i64 3, !llfi_index !1500
  %fi1 = call double* @injectFault1(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1499
  %31 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1501
  %fi2 = call double @injectFault0(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1499
  %32 = fmul double %fi, %fi2, !llfi_index !1502
  %fi3 = call double @injectFault0(i64 1481, double %32, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1499
  %33 = fadd double %28, %fi3, !llfi_index !1503
  ...
  %67 = fmul double %fi2, %66, !llfi_index !1537
  ...
  %98 = fmul double %fi2, %97, !llfi_index !1568
  ...
  %129 = fmul double %fi2, %128, !llfi_index !1599
