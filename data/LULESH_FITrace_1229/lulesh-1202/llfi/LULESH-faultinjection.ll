...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %73 = getelementptr inbounds double, double* %52, i64 %fi2, !llfi_index !1190
  ...
  %fi3 = call double* @injectFault3(i64 1173, double* %76, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1120
  ...
  %97 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1222
  %fi4 = call double* @injectFault3(i64 1201, double* %97, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1120
  %98 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1223
  %fi5 = call double @injectFault4(i64 1202, double %98, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1120
  %99 = getelementptr inbounds double, double* %3, i64 7, !llfi_index !1224
  store double %fi5, double* %99, align 8, !tbaa !345, !llfi_index !1225
