...
7:                                                ; preds = %122
  ...
  %fi1 = call double @injectFault1(i64 810, double %72, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !826
