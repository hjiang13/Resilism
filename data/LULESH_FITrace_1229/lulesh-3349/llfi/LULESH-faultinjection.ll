...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi7 = call <2 x double> @injectFault1(i64 3311, <2 x double> %60, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %61 = insertelement <2 x double> poison, double %4, i32 0, !llfi_index !3354
  %fi8 = call <2 x double> @injectFault1(i64 3312, <2 x double> %61, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %62 = insertelement <2 x double> %fi8, double %12, i32 1, !llfi_index !3355
  %fi9 = call <2 x double> @injectFault1(i64 3313, <2 x double> %62, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %63 = fsub <2 x double> %fi7, %fi9, !llfi_index !3356
  %fi10 = call <2 x double> @injectFault1(i64 3314, <2 x double> %63, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %64 = fsub double %22, %20, !llfi_index !3357
  %fi11 = call double @injectFault0(i64 3315, double %64, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %65 = fsub double %12, %11, !llfi_index !3358
  %fi12 = call double @injectFault0(i64 3316, double %65, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  ...
  %fi13 = call double @injectFault0(i64 3322, double %71, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  ...
  %76 = insertelement <2 x double> %fi8, double %1, i32 1, !llfi_index !3369
  ...
  %92 = fadd double %fi12, %fi13, !llfi_index !3385
  %fi14 = call double @injectFault0(i64 3343, double %92, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %93 = fmul double %fi, %fi11, !llfi_index !3386
  %fi15 = call double @injectFault0(i64 3344, double %93, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %shift = shufflevector <2 x double> %fi5, <2 x double> poison, <2 x i32> <i32 1, i32 undef>, !llfi_index !3387
  %fi16 = call <2 x double> @injectFault1(i64 3345, <2 x double> %shift, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %94 = fmul <2 x double> %fi10, %fi16, !llfi_index !3388
  %fi17 = call <2 x double> @injectFault1(i64 3346, <2 x double> %94, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %95 = extractelement <2 x double> %fi17, i32 0, !llfi_index !3389
  %fi18 = call double @injectFault0(i64 3347, double %95, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %96 = fsub double %fi15, %fi18, !llfi_index !3390
  %fi19 = call double @injectFault0(i64 3348, double %96, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %97 = fmul double %fi14, %fi19, !llfi_index !3391
  %fi20 = call double @injectFault0(i64 3349, double %97, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %98 = fadd <2 x double> %70, %75, !llfi_index !3392
  %99 = fmul <2 x double> %fi10, %fi5, !llfi_index !3393
  %100 = insertelement <2 x double> poison, double %fi, i32 0, !llfi_index !3394
  %101 = shufflevector <2 x double> %100, <2 x double> %fi5, <2 x i32> <i32 0, i32 2>, !llfi_index !3395
  %102 = extractelement <2 x double> %fi10, i32 1, !llfi_index !3396
  %103 = insertelement <2 x double> poison, double %102, i32 0, !llfi_index !3397
  %104 = insertelement <2 x double> %103, double %fi11, i32 1, !llfi_index !3398
  ...
  %109 = fadd double %108, %fi20, !llfi_index !3403
