...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %67 = getelementptr inbounds double, double* %52, i64 %fi2, !llfi_index !1182
  ...
  %fi3 = call double* @injectFault3(i64 1173, double* %76, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  ...
  %91 = getelementptr double, double* %fi3, i64 %fi2, !llfi_index !1214
  %fi4 = call double* @injectFault3(i64 1193, double* %91, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %92 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1215
  %fi5 = call double @injectFault4(i64 1194, double %92, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1116
  %93 = getelementptr inbounds double, double* %3, i64 5, !llfi_index !1216
  store double %fi5, double* %93, align 8, !tbaa !345, !llfi_index !1217
