...
145:                                              ; preds = %143, %139
  ...
  %fi = call i32* @injectFault0(i64 175, i32* %147, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !185
  %148 = icmp eq i32* %fi, null, !llfi_index !186
  br i1 %148, label %151, label %149, !llfi_index !187

149:                                              ; preds = %145
  %150 = bitcast i32* %fi to i8*, !llfi_index !188
