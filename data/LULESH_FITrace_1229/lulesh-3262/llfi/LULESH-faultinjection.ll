...
define dso_local void @_Z20CalcPositionForNodesd(double %0) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3237, double* %8, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3278
...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3278
  ...
  %29 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3302
  %fi2 = call double* @injectFault0(i64 3261, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3278
  %30 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3303
  %fi3 = call double @injectFault2(i64 3262, double %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3278
  %31 = fadd double %28, %fi3, !llfi_index !3304
  store double %31, double* %fi2, align 8, !tbaa !345, !llfi_index !3305
  %32 = add nuw nsw i64 %fi1, 1, !llfi_index !3306
  %fi4 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3278
