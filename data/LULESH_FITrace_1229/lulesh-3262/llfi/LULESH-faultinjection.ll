...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3262, double %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3303
  %31 = fadd double %28, %fi, !llfi_index !3304
