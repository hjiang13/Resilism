...
217:                                              ; preds = %215, %211
  %218 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 10, i32 0, i32 0, i32 0, i32 0, !llfi_index !267
  %fi = call double** @injectFault0(i64 258, double** %218, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !268
  %219 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !269
