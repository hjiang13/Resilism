...
163:                                              ; preds = %161, %157
  ...
  %fi = call i1 @injectFault0(i64 197, i1 %166, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !207
  br i1 %fi, label %169, label %167, !llfi_index !208
