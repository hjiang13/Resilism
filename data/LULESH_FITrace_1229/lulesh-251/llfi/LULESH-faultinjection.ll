...
211:                                              ; preds = %209, %205
  %212 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 11, i32 0, i32 0, i32 0, i32 0, !llfi_index !260
  %fi = call double** @injectFault0(i64 251, double** %212, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !261
  %213 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !262
