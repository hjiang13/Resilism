...
define linkonce_odr dso_local void @_ZN4MeshD2Ev(%struct.Mesh* nonnull align 8 dereferenceable(1376) %0) unnamed_addr #3 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
  %2 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 46, i32 0, i32 0, i32 0, i32 0, !llfi_index !8
  %fi = call double** @injectFault0(i64 6, double** %2, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !9
  %3 = load double*, double** %fi, align 8, !tbaa !10, !llfi_index !15
