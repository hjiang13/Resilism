...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double> @injectFault0(i64 4711, <2 x double> %83, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !4775
  %84 = bitcast double* %80 to <2 x double>*, !llfi_index !4776
  store <2 x double> %fi, <2 x double>* %84, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4781
  ...
  %89 = select <2 x i1> %88, <2 x double> %fi, <2 x double> zeroinitializer, !llfi_index !4787
