...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3136, double %28, i32 21, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !3172
  %29 = getelementptr inbounds double, double* %8, i64 %13, !llfi_index !3173
  store double %fi, double* %29, align 8, !tbaa !345, !llfi_index !3174
