...
define dso_local void @_Z24CalcAccelerationForNodesv() local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3108, double* %3, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  ...
  %fi1 = call double* @injectFault0(i64 3112, double* %7, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
...
12:                                               ; preds = %12, %10
  ...
  %fi2 = call i64 @injectFault1(i64 3119, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %14 = getelementptr inbounds double, double* %2, i64 %fi2, !llfi_index !3156
  %15 = load double, double* %14, align 8, !tbaa !345, !llfi_index !3157
  %16 = getelementptr double, double* %fi, i64 %fi2, !llfi_index !3158
  %fi3 = call double* @injectFault0(i64 3122, double* %16, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %17 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3159
  %18 = fdiv double %15, %17, !llfi_index !3160
  %19 = getelementptr inbounds double, double* %4, i64 %fi2, !llfi_index !3161
  store double %18, double* %19, align 8, !tbaa !345, !llfi_index !3162
  %20 = getelementptr inbounds double, double* %5, i64 %fi2, !llfi_index !3163
  %21 = load double, double* %20, align 8, !tbaa !345, !llfi_index !3164
  %22 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3165
  %23 = fdiv double %21, %22, !llfi_index !3166
  %24 = getelementptr inbounds double, double* %6, i64 %fi2, !llfi_index !3167
  store double %23, double* %24, align 8, !tbaa !345, !llfi_index !3168
  %25 = getelementptr double, double* %fi1, i64 %fi2, !llfi_index !3169
  %fi4 = call double* @injectFault0(i64 3133, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %26 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !3170
  %fi5 = call double @injectFault2(i64 3134, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %27 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3171
  %fi6 = call double @injectFault2(i64 3135, double %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %28 = fdiv double %fi5, %fi6, !llfi_index !3172
  %fi7 = call double @injectFault2(i64 3136, double %28, i32 21, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !3144
  %29 = getelementptr inbounds double, double* %8, i64 %fi2, !llfi_index !3173
  store double %fi7, double* %29, align 8, !tbaa !345, !llfi_index !3174
  %30 = add nuw nsw i64 %fi2, 1, !llfi_index !3175
  %fi8 = call i64 @injectFault1(i64 3139, i64 %30, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3144
