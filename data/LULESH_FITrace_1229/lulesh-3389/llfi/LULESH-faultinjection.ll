...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %5 = getelementptr double, double* %0, i64 1, !llfi_index !3429
  %fi = call double* @injectFault0(i64 3388, double* %5, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3430
  %6 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3431
  %fi1 = call double @injectFault1(i64 3389, double %6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3430
