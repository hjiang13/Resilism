...
103:                                              ; preds = %101, %97
  ...
  %fi = call double* @injectFault0(i64 126, double* %105, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !134
  %106 = icmp eq double* %fi, null, !llfi_index !135
  br i1 %106, label %109, label %107, !llfi_index !136

107:                                              ; preds = %103
  %108 = bitcast double* %fi to i8*, !llfi_index !137
