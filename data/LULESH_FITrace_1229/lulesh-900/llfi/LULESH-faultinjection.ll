...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %fi = call double* @injectFault0(i64 898, double* %31, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !916
  %32 = bitcast double* %fi to <2 x double>*, !llfi_index !917
  %fi1 = call <2 x double>* @injectFault1(i64 899, <2 x double>* %32, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !916
  %33 = load <2 x double>, <2 x double>* %fi1, align 8, !tbaa !345, !llfi_index !918
  %fi2 = call <2 x double> @injectFault2(i64 900, <2 x double> %33, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !916
  ...
  %77 = fneg <2 x double> %fi2, !llfi_index !970
