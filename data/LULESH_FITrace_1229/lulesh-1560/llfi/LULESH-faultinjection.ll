...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi24 = call double @injectFault1(i64 1466, double %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %18 = fmul double %16, %fi24, !llfi_index !1488
  %19 = load double, double* %4, align 8, !tbaa !345, !llfi_index !1489
  %20 = getelementptr double, double* %0, i64 1, !llfi_index !1490
  %fi25 = call double* @injectFault0(i64 1469, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %21 = load double, double* %fi25, align 8, !tbaa !345, !llfi_index !1491
  %fi26 = call double @injectFault1(i64 1470, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %22 = fmul double %19, %fi26, !llfi_index !1492
  ...
  %fi27 = call double* @injectFault0(i64 1474, double* %25, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %26 = load double, double* %fi27, align 8, !tbaa !345, !llfi_index !1496
  %fi28 = call double @injectFault1(i64 1475, double %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %27 = fmul double %24, %fi28, !llfi_index !1497
  ...
  %fi29 = call double* @injectFault0(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %31 = load double, double* %fi29, align 8, !tbaa !345, !llfi_index !1501
  %fi30 = call double @injectFault1(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %32 = fmul double %29, %fi30, !llfi_index !1502
  ...
  %fi31 = call double* @injectFault0(i64 1484, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %36 = load double, double* %fi31, align 8, !tbaa !345, !llfi_index !1506
  %fi32 = call double @injectFault1(i64 1485, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %37 = fmul double %34, %fi32, !llfi_index !1507
  ...
  %fi33 = call double* @injectFault0(i64 1489, double* %40, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %41 = load double, double* %fi33, align 8, !tbaa !345, !llfi_index !1511
  %fi34 = call double @injectFault1(i64 1490, double %41, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %42 = fmul double %39, %fi34, !llfi_index !1512
  ...
  %fi35 = call double* @injectFault0(i64 1494, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %46 = load double, double* %fi35, align 8, !tbaa !345, !llfi_index !1516
  %fi36 = call double @injectFault1(i64 1495, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %47 = fmul double %44, %fi36, !llfi_index !1517
  ...
  %63 = fmul double %fi28, %62, !llfi_index !1533
  ...
  %67 = fmul double %fi30, %66, !llfi_index !1537
  ...
  %71 = fmul double %fi32, %70, !llfi_index !1541
  ...
  %75 = fmul double %fi34, %74, !llfi_index !1545
  ...
  %79 = fmul double %fi36, %78, !llfi_index !1549
  ...
  %fi37 = call double* @injectFault0(i64 1534, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %86 = load double, double* %fi37, align 8, !tbaa !345, !llfi_index !1556
  %fi38 = call double @injectFault1(i64 1535, double %86, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %87 = fmul double %fi24, %fi38, !llfi_index !1557
  %fi39 = call double @injectFault1(i64 1536, double %87, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  ...
  %90 = fmul double %fi26, %fi1, !llfi_index !1560
  ...
  %91 = fadd double %fi39, %fi2, !llfi_index !1561
  ...
  %94 = fmul double %fi28, %fi5, !llfi_index !1564
  ...
  %98 = fmul double %fi30, %fi9, !llfi_index !1568
  ...
  %102 = fmul double %fi32, %fi13, !llfi_index !1572
  ...
  %106 = fmul double %fi34, %fi17, !llfi_index !1576
  ...
  %110 = fmul double %fi36, %fi21, !llfi_index !1580
  ...
  %115 = fadd double %fi23, %114, !llfi_index !1585
  ...
  %118 = fmul double %fi24, %117, !llfi_index !1588
  ...
  %121 = fmul double %fi26, %120, !llfi_index !1591
  ...
  %125 = fmul double %fi28, %124, !llfi_index !1595
  ...
  %129 = fmul double %fi30, %128, !llfi_index !1599
  ...
  %133 = fmul double %fi32, %132, !llfi_index !1603
  ...
  %137 = fmul double %fi34, %136, !llfi_index !1607
  ...
  %141 = fmul double %fi36, %140, !llfi_index !1611
  ...
  %150 = fmul double %fi38, %115, !llfi_index !1620
  ...
  %307 = load double, double* %fi37, align 8, !tbaa !345, !llfi_index !1785
  ...
  %513 = load double, double* %fi37, align 8, !tbaa !345, !llfi_index !1999
