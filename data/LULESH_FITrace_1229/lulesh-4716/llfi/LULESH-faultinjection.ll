...
71:                                               ; preds = %106, %63
  ...
  %85 = getelementptr double, double* %5, i64 %fi, !llfi_index !4782
  %fi1 = call double* @injectFault1(i64 4714, double* %85, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %86 = bitcast double* %fi1 to <2 x double>*, !llfi_index !4783
  %fi2 = call <2 x double>* @injectFault2(i64 4715, <2 x double>* %86, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %87 = load <2 x double>, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4784, !llfi_index !4785
  %fi3 = call <2 x double> @injectFault3(i64 4716, <2 x double> %87, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %88 = fcmp ult <2 x double> %fi3, %68, !llfi_index !4786
