...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double> @injectFault0(i64 4716, <2 x double> %87, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4785
  %88 = fcmp ult <2 x double> %fi, %68, !llfi_index !4786
