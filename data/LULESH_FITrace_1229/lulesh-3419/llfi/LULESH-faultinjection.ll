...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %35 = getelementptr double, double* %2, i64 1, !llfi_index !3459
  %fi = call double* @injectFault0(i64 3418, double* %35, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3460
  %36 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3461
  %fi1 = call double @injectFault1(i64 3419, double %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3460
