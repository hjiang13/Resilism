...
115:                                              ; preds = %113, %109
  ...
  %fi = call i1 @injectFault0(i64 141, i1 %118, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !149
  br i1 %fi, label %121, label %119, !llfi_index !150
