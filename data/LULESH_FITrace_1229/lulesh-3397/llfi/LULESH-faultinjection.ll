...
define dso_local double @_Z14CalcElemVolumePKdS0_S0_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2) local_unnamed_addr #17 {
  ...
  %13 = getelementptr double, double* %0, i64 5, !llfi_index !3437
  %fi = call double* @injectFault0(i64 3396, double* %13, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3438
  %14 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3439
  %fi1 = call double @injectFault1(i64 3397, double %14, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3438
