...
241:                                              ; preds = %239, %235
  %242 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 6, i32 0, i32 0, i32 0, i32 0, !llfi_index !295
  %fi = call double** @injectFault0(i64 286, double** %242, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !296
  %243 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !297
