...
223:                                              ; preds = %221, %217
  ...
  %fi = call i1 @injectFault0(i64 267, i1 %226, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !277
  br i1 %fi, label %229, label %227, !llfi_index !278
