...
163:                                              ; preds = %163, %154
  ...
  %fi = call i64 @injectFault0(i64 5901, i64 %167, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !6034
  %168 = getelementptr inbounds double, double* %127, i64 %fi, !llfi_index !6035
  ...
  %171 = getelementptr inbounds double, double* %128, i64 %fi, !llfi_index !6039
  ...
  %174 = getelementptr inbounds double, double* %129, i64 %fi, !llfi_index !6043
