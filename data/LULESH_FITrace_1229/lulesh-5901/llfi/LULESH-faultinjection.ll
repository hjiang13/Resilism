...
154:                                              ; preds = %179, %136
  ...
  %fi1 = call i64 @injectFault1(i64 5884, i64 %155, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  ...
  %156 = shl nsw i64 %fi1, 3, !llfi_index !6021
  %fi2 = call i64 @injectFault1(i64 5888, i64 %156, i32 25, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %157 = getelementptr i32, i32* %fi, i64 %fi2, !llfi_index !6022
  %fi3 = call i32* @injectFault0(i64 5889, i32* %157, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
158:                                              ; preds = %163
  ...
  %160 = getelementptr inbounds double, double* %133, i64 %fi1, !llfi_index !6025
  store double %159, double* %160, align 8, !tbaa !345, !llfi_index !6026
  %161 = getelementptr inbounds double, double* %134, i64 %fi1, !llfi_index !6027
...
163:                                              ; preds = %163, %154
  %164 = phi i64 [ 0, %154 ], [ %fi8, %163 ], !llfi_index !6031
  %fi4 = call i64 @injectFault1(i64 5898, i64 %164, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %165 = getelementptr i32, i32* %fi3, i64 %fi4, !llfi_index !6032
  %fi5 = call i32* @injectFault0(i64 5899, i32* %165, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %166 = load i32, i32* %fi5, align 4, !tbaa !404, !llfi_index !6033
  %fi6 = call i32 @injectFault2(i64 5900, i32 %166, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %167 = sext i32 %fi6 to i64, !llfi_index !6034
  %fi7 = call i64 @injectFault1(i64 5901, i64 %167, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %168 = getelementptr inbounds double, double* %127, i64 %fi7, !llfi_index !6035
  %169 = load double, double* %168, align 8, !tbaa !345, !llfi_index !6036
  %170 = getelementptr inbounds [8 x double], [8 x double]* %3, i64 0, i64 %fi4, !llfi_index !6037
  store double %169, double* %170, align 8, !tbaa !345, !llfi_index !6038
  %171 = getelementptr inbounds double, double* %128, i64 %fi7, !llfi_index !6039
  %172 = load double, double* %171, align 8, !tbaa !345, !llfi_index !6040
  %173 = getelementptr inbounds [8 x double], [8 x double]* %4, i64 0, i64 %fi4, !llfi_index !6041
  store double %172, double* %173, align 8, !tbaa !345, !llfi_index !6042
  %174 = getelementptr inbounds double, double* %129, i64 %fi7, !llfi_index !6043
  %175 = load double, double* %174, align 8, !tbaa !345, !llfi_index !6044
  %176 = getelementptr inbounds [8 x double], [8 x double]* %5, i64 0, i64 %fi4, !llfi_index !6045
  store double %175, double* %176, align 8, !tbaa !345, !llfi_index !6046
  %177 = add nuw nsw i64 %fi4, 1, !llfi_index !6047
  %fi8 = call i64 @injectFault1(i64 5914, i64 %177, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
  %178 = icmp eq i64 %fi8, 8, !llfi_index !6048
...
179:                                              ; preds = %182
  ...
  %180 = add nuw nsw i64 %fi1, 1, !llfi_index !6054
  %fi9 = call i64 @injectFault1(i64 5920, i64 %180, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !5984
...
182:                                              ; preds = %182, %158
  ...
  %184 = getelementptr inbounds i32, i32* %fi3, i64 %183, !llfi_index !6059
