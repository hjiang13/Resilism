...
121:                                              ; preds = %119, %115
  ...
  %fi = call i1 @injectFault0(i64 148, i1 %124, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !156
  br i1 %fi, label %127, label %125, !llfi_index !157
