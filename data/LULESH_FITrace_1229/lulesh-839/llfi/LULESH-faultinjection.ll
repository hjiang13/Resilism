...
7:                                                ; preds = %122
  ...
  %34 = getelementptr double, double* %4, i64 3, !llfi_index !786
  %fi1 = call double* @injectFault1(i64 770, double* %34, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !787
  %35 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !788
  ...
  %96 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !852
  ...
  %99 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !856
  %fi = call double @injectFault0(i64 839, double %99, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !787
  ...
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %14, double* nonnull %15, double* nonnull %16, double* nonnull %80, double* nonnull %81, double* nonnull %82, double* nonnull %38, double* nonnull %39, double* nonnull %40, double* nonnull %0, double* nonnull %1, double* nonnull %2, double %98, double %fi, double %100, double %101, double %102, double %103, double %104, double %105, double %106, double %107, double %108, double %109), !llfi_index !867
