...
139:                                              ; preds = %137, %133
  ...
  %fi = call i32* @injectFault0(i64 168, i32* %141, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !178
  %142 = icmp eq i32* %fi, null, !llfi_index !179
  br i1 %142, label %145, label %143, !llfi_index !180

143:                                              ; preds = %139
  %144 = bitcast i32* %fi to i8*, !llfi_index !181
