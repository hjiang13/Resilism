...
7:                                                ; preds = %122
  ...
  %12 = getelementptr double, double* %1, i64 2, !llfi_index !764
  %fi = call double* @injectFault0(i64 748, double* %12, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !765
