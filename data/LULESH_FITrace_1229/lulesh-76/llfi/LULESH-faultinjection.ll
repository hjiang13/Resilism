...
61:                                               ; preds = %59, %55
  %62 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 36, i32 0, i32 0, i32 0, i32 0, !llfi_index !83
  %fi = call double** @injectFault0(i64 76, double** %62, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !84
  %63 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !85
