...
211:                                              ; preds = %209, %205
  ...
  %fi = call double* @injectFault0(i64 252, double* %213, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !262
  %214 = icmp eq double* %fi, null, !llfi_index !263
  br i1 %214, label %217, label %215, !llfi_index !264

215:                                              ; preds = %211
  %216 = bitcast double* %fi to i8*, !llfi_index !265
