...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call double* @injectFault0(i64 3189, double* %7, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3229
...
13:                                               ; preds = %13, %11
  ...
  %fi1 = call i64 @injectFault1(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3229
  %15 = getelementptr inbounds double, double* %4, i64 %fi1, !llfi_index !3238
  %16 = load double, double* %15, align 8, !tbaa !345, !llfi_index !3239
  %17 = getelementptr inbounds double, double* %5, i64 %fi1, !llfi_index !3240
  ...
  %24 = getelementptr inbounds double, double* %6, i64 %fi1, !llfi_index !3248
  %25 = load double, double* %24, align 8, !tbaa !345, !llfi_index !3249
  %26 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3250
  %fi2 = call double* @injectFault0(i64 3210, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3229
  %27 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3251
  %fi3 = call double @injectFault2(i64 3211, double %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3229
  %28 = fmul double %fi3, %0, !llfi_index !3252
  %fi4 = call double @injectFault2(i64 3212, double %28, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3229
  %29 = fadd double %25, %fi4, !llfi_index !3253
  ...
  %33 = getelementptr inbounds double, double* %8, i64 %fi1, !llfi_index !3258
  %34 = load double, double* %33, align 8, !tbaa !345, !llfi_index !3259
  %35 = getelementptr inbounds double, double* %9, i64 %fi1, !llfi_index !3260
  ...
  %42 = add nuw nsw i64 %fi1, 1, !llfi_index !3268
  %fi5 = call i64 @injectFault1(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3229
