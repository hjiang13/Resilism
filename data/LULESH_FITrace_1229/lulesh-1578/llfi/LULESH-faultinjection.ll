...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %30 = getelementptr double, double* %0, i64 3, !llfi_index !1499
  %fi3 = call double* @injectFault0(i64 1479, double* %30, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1500
  %31 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !1501
  %fi4 = call double @injectFault1(i64 1480, double %31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1500
  %32 = fmul double %29, %fi4, !llfi_index !1502
  ...
  %67 = fmul double %fi4, %66, !llfi_index !1537
  ...
  %98 = fmul double %fi4, %97, !llfi_index !1568
  ...
  %fi = call double* @injectFault0(i64 1576, double* %127, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1500
  %128 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1598
  %fi1 = call double @injectFault1(i64 1577, double %128, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1500
  %129 = fmul double %fi4, %fi1, !llfi_index !1599
  %fi2 = call double @injectFault1(i64 1578, double %129, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1500
  %130 = fadd double %126, %fi2, !llfi_index !1600
  ...
  %189 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1662
  ...
  %338 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1816
  ...
  %395 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1876
  ...
  %544 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2030
  ...
  %601 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !2090
