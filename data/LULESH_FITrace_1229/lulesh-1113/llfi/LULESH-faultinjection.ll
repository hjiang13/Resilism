...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %fi2 = call double* @injectFault2(i64 1102, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  ...
  %fi3 = call i64 @injectFault3(i64 1111, i64 %28, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  %29 = getelementptr double, double* %fi2, i64 %fi3, !llfi_index !1133
  %fi4 = call double* @injectFault2(i64 1112, double* %29, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  %30 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1134
  %fi5 = call double @injectFault4(i64 1113, double %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1110
  %31 = getelementptr inbounds double, double* %1, i64 2, !llfi_index !1135
  store double %fi5, double* %31, align 8, !tbaa !345, !llfi_index !1136
  ...
  %58 = getelementptr inbounds double, double* %52, i64 %fi3, !llfi_index !1170
  ...
  %82 = getelementptr inbounds double, double* %76, i64 %fi3, !llfi_index !1202
