...
13:                                               ; preds = %13, %11
  ...
  %33 = getelementptr double, double* %8, i64 %14, !llfi_index !3257
  %fi = call double* @injectFault0(i64 3218, double* %33, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3258
  %34 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3259
  ...
  store double %41, double* %fi, align 8, !tbaa !345, !llfi_index !3267
