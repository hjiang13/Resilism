...
127:                                              ; preds = %125, %121
  %128 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 25, i32 0, i32 0, i32 0, i32 0, !llfi_index !160
  %fi = call double** @injectFault0(i64 153, double** %128, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !161
  %129 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !162
