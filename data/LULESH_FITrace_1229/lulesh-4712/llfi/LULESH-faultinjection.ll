...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double>* @injectFault0(i64 4712, <2 x double>* %84, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4776
  store <2 x double> %83, <2 x double>* %fi, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4781
