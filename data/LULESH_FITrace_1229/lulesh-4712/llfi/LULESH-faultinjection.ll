...
71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi3, %106 ], !llfi_index !4758
  ...
  %80 = getelementptr double, double* %0, i64 %fi, !llfi_index !4772
  %fi1 = call double* @injectFault1(i64 4708, double* %80, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  ...
  %84 = bitcast double* %fi1 to <2 x double>*, !llfi_index !4776
  %fi2 = call <2 x double>* @injectFault2(i64 4712, <2 x double>* %84, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  store <2 x double> %83, <2 x double>* %fi2, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4781
...
94:                                               ; preds = %71
  ...
  store double %97, double* %fi1, align 8, !tbaa !345, !alias.scope !4777, !noalias !4779, !llfi_index !4796
...
106:                                              ; preds = %100, %98
  ...
  %fi3 = call i64 @injectFault0(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %108 = icmp eq i64 %fi3, %64, !llfi_index !4808
