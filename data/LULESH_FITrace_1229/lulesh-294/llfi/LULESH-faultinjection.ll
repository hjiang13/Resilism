...
247:                                              ; preds = %245, %241
  ...
  %fi = call double* @injectFault0(i64 294, double* %249, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !304
  %250 = icmp eq double* %fi, null, !llfi_index !305
  br i1 %250, label %253, label %251, !llfi_index !306

251:                                              ; preds = %247
  %252 = bitcast double* %fi to i8*, !llfi_index !307
