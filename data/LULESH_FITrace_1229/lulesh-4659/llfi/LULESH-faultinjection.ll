...
32:                                               ; preds = %32, %30
  ...
  %fi = call <2 x double> @injectFault0(i64 4659, <2 x double> %36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4712
  %37 = fadd <2 x double> %fi, <double 1.000000e+00, double 1.000000e+00>, !llfi_index !4713
