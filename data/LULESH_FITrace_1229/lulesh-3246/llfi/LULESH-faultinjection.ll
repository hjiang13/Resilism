...
12:                                               ; preds = %12, %10
  %13 = phi i64 [ 0, %10 ], [ %fi5, %12 ], !llfi_index !3284
  %fi1 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3273
  %14 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3285
  %fi2 = call double* @injectFault0(i64 3244, double* %14, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3273
  %15 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3286
  %fi3 = call double @injectFault2(i64 3245, double %15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3273
  %16 = fmul double %fi3, %0, !llfi_index !3287
  %fi4 = call double @injectFault2(i64 3246, double %16, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3273
  %17 = getelementptr inbounds double, double* %4, i64 %fi1, !llfi_index !3288
  %18 = load double, double* %17, align 8, !tbaa !345, !llfi_index !3289
  %19 = fadd double %fi4, %18, !llfi_index !3290
  store double %19, double* %17, align 8, !tbaa !345, !llfi_index !3291
  %20 = getelementptr inbounds double, double* %5, i64 %fi1, !llfi_index !3292
  %21 = load double, double* %20, align 8, !tbaa !345, !llfi_index !3293
  %22 = fmul double %21, %0, !llfi_index !3294
  %23 = getelementptr inbounds double, double* %6, i64 %fi1, !llfi_index !3295
  ...
  %26 = getelementptr inbounds double, double* %7, i64 %fi1, !llfi_index !3299
  %27 = load double, double* %26, align 8, !tbaa !345, !llfi_index !3300
  %28 = fmul double %27, %0, !llfi_index !3301
  %29 = getelementptr inbounds double, double* %8, i64 %fi1, !llfi_index !3302
  ...
  %32 = add nuw nsw i64 %fi1, 1, !llfi_index !3306
  %fi5 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3273
  %33 = icmp eq i64 %fi5, %11, !llfi_index !3307
