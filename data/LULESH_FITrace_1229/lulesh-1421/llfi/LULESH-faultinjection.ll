...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1276, double* %13, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1297
  %14 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1298
  ...
  %47 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1332
  ...
  %93 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1380
  ...
  %130 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1419
  ...
  %152 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1442
  %fi = call double @injectFault0(i64 1421, double %152, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1297
