...
10:                                               ; preds = %10, %8
  %11 = phi i64 [ 0, %8 ], [ %fi4, %10 ], !llfi_index !416
  ...
  %fi4 = call i64 @injectFault1(i64 415, i64 %21, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %22 = icmp eq i64 %fi4, %9, !llfi_index !430
