...
10:                                               ; preds = %10, %8
  ...
  %fi = call double @injectFault0(i64 408, double %17, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !422
  %18 = getelementptr inbounds double, double* %3, i64 %11, !llfi_index !423
  store double %fi, double* %18, align 8, !tbaa !345, !llfi_index !424
  %19 = getelementptr inbounds double, double* %2, i64 %11, !llfi_index !425
  store double %fi, double* %19, align 8, !tbaa !345, !llfi_index !426
  %20 = getelementptr inbounds double, double* %1, i64 %11, !llfi_index !427
  store double %fi, double* %20, align 8, !tbaa !345, !llfi_index !428
