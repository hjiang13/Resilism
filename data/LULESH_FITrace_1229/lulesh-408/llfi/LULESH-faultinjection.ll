...
define dso_local void @_Z23InitStressTermsForElemsiPdS_S_(i32 %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 395, double* %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !409
  ...
  %fi1 = call double* @injectFault0(i64 396, double* %6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !409
...
10:                                               ; preds = %10, %8
  %11 = phi i64 [ 0, %8 ], [ %fi9, %10 ], !llfi_index !416
  %fi3 = call i64 @injectFault2(i64 402, i64 %11, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %12 = getelementptr double, double* %fi, i64 %fi3, !llfi_index !417
  %fi4 = call double* @injectFault0(i64 403, double* %12, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %13 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !418
  %fi5 = call double @injectFault1(i64 404, double %13, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %14 = fneg double %fi5, !llfi_index !419
  %fi6 = call double @injectFault1(i64 405, double %14, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %15 = getelementptr double, double* %fi1, i64 %fi3, !llfi_index !420
  %fi7 = call double* @injectFault0(i64 406, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %16 = load double, double* %fi7, align 8, !tbaa !345, !llfi_index !421
  %fi8 = call double @injectFault1(i64 407, double %16, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %17 = fsub double %fi6, %fi8, !llfi_index !422
  %fi2 = call double @injectFault1(i64 408, double %17, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %18 = getelementptr inbounds double, double* %3, i64 %fi3, !llfi_index !423
  store double %fi2, double* %18, align 8, !tbaa !345, !llfi_index !424
  %19 = getelementptr inbounds double, double* %2, i64 %fi3, !llfi_index !425
  store double %fi2, double* %19, align 8, !tbaa !345, !llfi_index !426
  %20 = getelementptr inbounds double, double* %1, i64 %fi3, !llfi_index !427
  store double %fi2, double* %20, align 8, !tbaa !345, !llfi_index !428
  %21 = add nuw nsw i64 %fi3, 1, !llfi_index !429
  %fi9 = call i64 @injectFault2(i64 415, i64 %21, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !409
  %22 = icmp eq i64 %fi9, %9, !llfi_index !430
...
52:                                               ; preds = %52, %33
  ...
  %55 = load i32, i32* %54, align 4, !tbaa !404, !llfi_index !1059
...
71:                                               ; preds = %71, %41
  ...
  %74 = load i32, i32* %73, align 4, !tbaa !404, !llfi_index !1083
...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  %5 = load i32, i32* %0, align 4, !tbaa !404, !llfi_index !1107
  %6 = getelementptr inbounds i32, i32* %0, i64 1, !llfi_index !1108
  %7 = load i32, i32* %6, align 4, !tbaa !404, !llfi_index !1109
  %8 = getelementptr inbounds i32, i32* %0, i64 2, !llfi_index !1110
  %9 = load i32, i32* %8, align 4, !tbaa !404, !llfi_index !1111
