...
115:                                              ; preds = %113, %109
  %116 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 27, i32 0, i32 0, i32 0, i32 0, !llfi_index !146
  %fi = call double** @injectFault0(i64 139, double** %116, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !147
  %117 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !148
