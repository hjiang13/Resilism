...
115:                                              ; preds = %113, %109
  ...
  %fi = call double* @injectFault0(i64 140, double* %117, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !148
  %118 = icmp eq double* %fi, null, !llfi_index !149
  br i1 %118, label %121, label %119, !llfi_index !150

119:                                              ; preds = %115
  %120 = bitcast double* %fi to i8*, !llfi_index !151
