...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call double* @injectFault0(i64 3187, double* %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3227
...
13:                                               ; preds = %13, %11
  %14 = phi i64 [ 0, %11 ], [ %fi5, %13 ], !llfi_index !3237
  %fi2 = call i64 @injectFault2(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3227
  ...
  %17 = getelementptr double, double* %fi, i64 %fi2, !llfi_index !3240
  %fi3 = call double* @injectFault0(i64 3200, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3227
  %18 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3241
  %fi4 = call double @injectFault1(i64 3201, double %18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3227
  %19 = fmul double %fi4, %0, !llfi_index !3242
  %fi1 = call double @injectFault1(i64 3202, double %19, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3227
  %20 = fadd double %16, %fi1, !llfi_index !3243
  ...
  %fi5 = call i64 @injectFault2(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3227
  %43 = icmp eq i64 %fi5, %12, !llfi_index !3269
