...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3202, double %19, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3242
  %20 = fadd double %16, %fi, !llfi_index !3243
