...
12:                                               ; preds = %12, %10
  ...
  %23 = getelementptr double, double* %6, i64 %13, !llfi_index !3294
  %fi = call double* @injectFault0(i64 3254, double* %23, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3295
  %24 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3296
  %25 = fadd double %22, %24, !llfi_index !3297
  store double %25, double* %fi, align 8, !tbaa !345, !llfi_index !3298
