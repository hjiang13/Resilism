...
define dso_local void @_Z20CalcPositionForNodesd(double %0) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3234, double* %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  ...
  %fi1 = call double* @injectFault0(i64 3235, double* %6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3275
...
12:                                               ; preds = %12, %10
  ...
  %fi2 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  ...
  %20 = getelementptr double, double* %fi, i64 %fi2, !llfi_index !3292
  %fi3 = call double* @injectFault0(i64 3251, double* %20, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %21 = load double, double* %fi3, align 8, !tbaa !345, !llfi_index !3293
  %fi4 = call double @injectFault2(i64 3252, double %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %22 = fmul double %fi4, %0, !llfi_index !3294
  %fi5 = call double @injectFault2(i64 3253, double %22, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %23 = getelementptr double, double* %fi1, i64 %fi2, !llfi_index !3295
  %fi6 = call double* @injectFault0(i64 3254, double* %23, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %24 = load double, double* %fi6, align 8, !tbaa !345, !llfi_index !3296
  %fi7 = call double @injectFault2(i64 3255, double %24, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  %25 = fadd double %fi5, %fi7, !llfi_index !3297
  %fi8 = call double @injectFault2(i64 3256, double %25, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3275
  store double %fi8, double* %fi6, align 8, !tbaa !345, !llfi_index !3298
  %26 = getelementptr inbounds double, double* %7, i64 %fi2, !llfi_index !3299
  %27 = load double, double* %26, align 8, !tbaa !345, !llfi_index !3300
  %28 = fmul double %27, %0, !llfi_index !3301
  %29 = getelementptr inbounds double, double* %8, i64 %fi2, !llfi_index !3302
  ...
  %fi9 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3275
