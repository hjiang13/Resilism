...
12:                                               ; preds = %12, %10
  ...
  %fi = call double @injectFault0(i64 3256, double %25, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3297
  store double %fi, double* %23, align 8, !tbaa !345, !llfi_index !3298
