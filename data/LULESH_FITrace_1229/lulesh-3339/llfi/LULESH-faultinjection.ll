...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi = call <2 x double> @injectFault0(i64 3302, <2 x double> %51, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3344
  %52 = insertelement <2 x double> %fi, double %10, i32 1, !llfi_index !3345
  %fi1 = call <2 x double> @injectFault0(i64 3303, <2 x double> %52, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3344
  %53 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3346
  %54 = fsub <2 x double> %fi1, %53, !llfi_index !3347
  ...
  %fi2 = call <2 x double> @injectFault0(i64 3337, <2 x double> %86, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3344
  %87 = insertelement <2 x double> %fi2, double %15, i32 1, !llfi_index !3380
  %fi3 = call <2 x double> @injectFault0(i64 3338, <2 x double> %87, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3344
  %88 = fsub <2 x double> %fi3, %fi1, !llfi_index !3381
  %fi4 = call <2 x double> @injectFault0(i64 3339, <2 x double> %88, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3344
  ...
  %117 = fadd <2 x double> %80, %fi4, !llfi_index !3411
