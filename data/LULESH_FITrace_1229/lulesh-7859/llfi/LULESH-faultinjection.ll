...
151:                                              ; preds = %146
  ...
  %fi2 = call i64 @injectFault0(i64 7842, i64 %153, i32 28, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @and_namestr, i32 0, i32 0)), !llfi_injectfault !8044
...
.preheader:                                       ; preds = %162, %146
  %.ph = phi i64 [ %fi2, %162 ], [ 1, %146 ], !llfi_index !8059
  %.ph22 = phi double* [ %163, %162 ], [ %148, %146 ], !llfi_index !8060
  %fi3 = call i64 @injectFault0(i64 7856, i64 %.ph, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !8044
  br label %165, !llfi_index !8061

165:                                              ; preds = %165, %.preheader
  %166 = phi i64 [ %fi1, %165 ], [ %fi3, %.preheader ], !llfi_index !8062
