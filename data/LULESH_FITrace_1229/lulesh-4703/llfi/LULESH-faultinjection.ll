...
71:                                               ; preds = %106, %63
  %72 = phi i64 [ 0, %63 ], [ %fi4, %106 ], !llfi_index !4758
  ...
  %76 = getelementptr inbounds double, double* %3, i64 %fi, !llfi_index !4766
  ...
  %79 = fmul <2 x double> %fi3, %78, !llfi_index !4771
...
106:                                              ; preds = %100, %98
  ...
  %fi4 = call i64 @injectFault0(i64 4738, i64 %107, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !4759
  %108 = icmp eq i64 %fi4, %64, !llfi_index !4808
