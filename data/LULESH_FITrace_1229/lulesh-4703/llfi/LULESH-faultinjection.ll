...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x double> @injectFault0(i64 4703, <2 x double> %75, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !4765
  ...
  %79 = fmul <2 x double> %fi, %78, !llfi_index !4771
