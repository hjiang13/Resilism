...
165:                                              ; preds = %165, %.preheader
  ...
  %fi = call double* @injectFault0(i64 7860, double* %167, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !8063
  store double %149, double* %fi, align 8, !tbaa !345, !llfi_index !8064
  %168 = add i64 %166, -1, !llfi_index !8065
  %169 = getelementptr inbounds double, double* %fi, i64 1, !llfi_index !8066
