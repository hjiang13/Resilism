...
13:                                               ; preds = %13, %11
  ...
  %39 = call double @llvm.fabs.f64(double %38) #2, !llfi_index !3263
  %fi = call double @injectFault0(i64 3224, double %39, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !3264
  %40 = fcmp olt double %fi, %1, !llfi_index !3265
