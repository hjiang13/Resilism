...
define dso_local void @_Z24CalcAccelerationForNodesv() local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3111, double* %6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3147
...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3119, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3147
  ...
  %24 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3167
  %fi2 = call double* @injectFault0(i64 3131, double* %24, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3147
  store double %23, double* %fi2, align 8, !tbaa !345, !llfi_index !3168
  ...
  %fi3 = call i64 @injectFault1(i64 3139, i64 %30, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3147
