...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi = call double* @injectFault0(i64 1494, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %46 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1516
  %fi1 = call double @injectFault1(i64 1495, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %47 = fmul double %44, %fi1, !llfi_index !1517
  ...
  %fi2 = call double* @injectFault0(i64 1526, double* %77, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %78 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1548
  %fi3 = call double @injectFault1(i64 1527, double %78, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %79 = fmul double %fi1, %fi3, !llfi_index !1549
  %fi4 = call double @injectFault1(i64 1528, double %79, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1515
  %80 = fadd double %76, %fi4, !llfi_index !1550
  ...
  %110 = fmul double %fi1, %109, !llfi_index !1580
  ...
  %141 = fmul double %fi1, %140, !llfi_index !1611
  ...
  %222 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1698
  ...
  %301 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1779
  ...
  %428 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1912
  ...
  %507 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !1993
  ...
  %634 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !2126
