...
61:                                               ; preds = %59, %55
  ...
  %fi = call i1 @injectFault0(i64 78, i1 %64, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !86
  br i1 %fi, label %67, label %65, !llfi_index !87
