...
define dso_local void @_Z20CalcPositionForNodesd(double %0) local_unnamed_addr #6 {
  ...
  %fi = call double* @injectFault0(i64 3233, double* %4, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3274
...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3274
  ...
  %17 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3288
  %fi2 = call double* @injectFault0(i64 3247, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3274
  %18 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3289
  %fi3 = call double @injectFault2(i64 3248, double %18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3274
  %19 = fadd double %16, %fi3, !llfi_index !3290
  store double %19, double* %fi2, align 8, !tbaa !345, !llfi_index !3291
  ...
  %fi4 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3274
