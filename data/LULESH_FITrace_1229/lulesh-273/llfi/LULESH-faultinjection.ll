...
229:                                              ; preds = %227, %223
  ...
  %fi = call double* @injectFault0(i64 273, double* %231, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !283
  %232 = icmp eq double* %fi, null, !llfi_index !284
  br i1 %232, label %235, label %233, !llfi_index !285

233:                                              ; preds = %229
  %234 = bitcast double* %fi to i8*, !llfi_index !286
