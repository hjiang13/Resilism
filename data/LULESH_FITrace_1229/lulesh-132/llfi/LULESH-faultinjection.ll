...
109:                                              ; preds = %107, %103
  %110 = getelementptr %struct.Mesh, %struct.Mesh* %0, i64 0, i32 28, i32 0, i32 0, i32 0, i32 0, !llfi_index !139
  %fi = call double** @injectFault0(i64 132, double** %110, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !140
  %111 = load double*, double** %fi, align 8, !tbaa !9, !llfi_index !141
