...
7:                                                ; preds = %122
  ...
  %93 = getelementptr double, double* %5, i64 7, !llfi_index !848
  %fi = call double* @injectFault0(i64 832, double* %93, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !849
  %94 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !850
  ...
  %103 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !860
  %fi1 = call double @injectFault1(i64 843, double %103, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !849
  ...
  tail call void @_Z17SumElemFaceNormalPdS_S_S_S_S_S_S_S_S_S_S_dddddddddddd(double* nonnull %14, double* nonnull %15, double* nonnull %16, double* nonnull %80, double* nonnull %81, double* nonnull %82, double* nonnull %38, double* nonnull %39, double* nonnull %40, double* nonnull %0, double* nonnull %1, double* nonnull %2, double %98, double %99, double %100, double %101, double %102, double %fi1, double %104, double %105, double %106, double %107, double %108, double %109), !llfi_index !867
  ...
  %115 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !873
