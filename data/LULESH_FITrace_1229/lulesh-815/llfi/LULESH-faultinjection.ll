...
7:                                                ; preds = %122
  ...
  %fi1 = call double* @injectFault1(i64 762, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !779
  %27 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !780
  ...
  %83 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !839
