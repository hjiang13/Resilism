...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi12 = call <2 x double> @injectFault1(i64 3352, <2 x double> %100, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %101 = shufflevector <2 x double> %fi12, <2 x double> %fi5, <2 x i32> <i32 0, i32 2>, !llfi_index !3395
  %fi13 = call <2 x double> @injectFault1(i64 3353, <2 x double> %101, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %102 = extractelement <2 x double> %fi10, i32 1, !llfi_index !3396
  %fi14 = call double @injectFault0(i64 3354, double %102, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %103 = insertelement <2 x double> poison, double %fi14, i32 0, !llfi_index !3397
  %fi15 = call <2 x double> @injectFault1(i64 3355, <2 x double> %103, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %104 = insertelement <2 x double> %fi15, double %fi11, i32 1, !llfi_index !3398
  %fi16 = call <2 x double> @injectFault1(i64 3356, <2 x double> %104, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %105 = fmul <2 x double> %fi13, %fi16, !llfi_index !3399
  %fi17 = call <2 x double> @injectFault1(i64 3357, <2 x double> %105, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %106 = fsub <2 x double> %99, %fi17, !llfi_index !3400
