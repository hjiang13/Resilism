...
13:                                               ; preds = %13, %11
  ...
  %17 = getelementptr double, double* %5, i64 %14, !llfi_index !3239
  %fi = call double* @injectFault0(i64 3200, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3240
  %18 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3241
