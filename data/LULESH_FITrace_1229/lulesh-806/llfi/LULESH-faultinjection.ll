...
7:                                                ; preds = %122
  ...
  %53 = getelementptr double, double* %3, i64 5, !llfi_index !806
  %fi = call double* @injectFault0(i64 790, double* %53, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !807
  %54 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !808
  ...
  %68 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !823
  %fi1 = call double @injectFault1(i64 806, double %68, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !807
  ...
  %119 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !877
