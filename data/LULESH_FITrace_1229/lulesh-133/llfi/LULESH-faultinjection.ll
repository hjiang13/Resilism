...
109:                                              ; preds = %107, %103
  ...
  %fi = call double* @injectFault0(i64 133, double* %111, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !141
  %112 = icmp eq double* %fi, null, !llfi_index !142
  br i1 %112, label %115, label %113, !llfi_index !143

113:                                              ; preds = %109
  %114 = bitcast double* %fi to i8*, !llfi_index !144
