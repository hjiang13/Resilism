...
define dso_local void @_Z27SumElemStressesToNodeForcesPA8_KddddPdS2_S2_([8 x double]* nocapture readonly %0, double %1, double %2, double %3, double* nocapture %4, double* nocapture %5, double* nocapture %6) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 895, double* %28, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %29 = bitcast double* %fi1 to <2 x double>*, !llfi_index !914
  %fi2 = call <2 x double>* @injectFault2(i64 896, <2 x double>* %29, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @bitcast_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %30 = load <2 x double>, <2 x double>* %fi2, align 8, !tbaa !345, !llfi_index !915
  %fi3 = call <2 x double> @injectFault0(i64 897, <2 x double> %30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !913
  ...
  %74 = fneg <2 x double> %fi3, !llfi_index !966
  %fi = call <2 x double> @injectFault0(i64 948, <2 x double> %74, i32 12, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !913
  %75 = fmul <2 x double> %62, %fi, !llfi_index !967
