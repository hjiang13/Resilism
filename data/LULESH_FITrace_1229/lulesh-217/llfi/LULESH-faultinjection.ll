...
181:                                              ; preds = %179, %175
  ...
  %fi = call i32* @injectFault0(i64 217, i32* %183, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !227
  %184 = icmp eq i32* %fi, null, !llfi_index !228
  br i1 %184, label %187, label %185, !llfi_index !229

185:                                              ; preds = %181
  %186 = bitcast i32* %fi to i8*, !llfi_index !230
