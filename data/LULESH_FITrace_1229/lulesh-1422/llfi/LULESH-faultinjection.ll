...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %fi1 = call double* @injectFault1(i64 1280, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1301
  %18 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1302
  ...
  %46 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1331
  ...
  %71 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1357
  ...
  %109 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1397
  ...
  %131 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1420
  ...
  %153 = load double, double* %fi1, align 8, !tbaa !345, !llfi_index !1443
  %fi = call double @injectFault0(i64 1422, double %153, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1301
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %151, double %152, double %fi, double %154, double %155, double %156, double %157, double %158, double %159, double %160, double %161, double %162, double %163, double %164, double %165, double %166, double %167, double %168, double* nonnull %169, double* nonnull %170, double* nonnull %171), !llfi_index !1462
