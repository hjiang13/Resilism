...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %156 = fmul double %fi73, %155, !llfi_index !1627
  %157 = load double, double* %fi77, align 8, !tbaa !345, !llfi_index !1628
  %158 = fmul double %fi104, %157, !llfi_index !1629
  ...
  %fi28 = call double @injectFault1(i64 1619, double %168, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %169 = fmul double %fi73, %fi28, !llfi_index !1641
  %fi29 = call double @injectFault1(i64 1620, double %169, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %170 = load double, double* %fi81, align 8, !tbaa !345, !llfi_index !1642
  %fi30 = call double @injectFault1(i64 1621, double %170, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %171 = fmul double %fi104, %fi30, !llfi_index !1643
  %fi31 = call double @injectFault1(i64 1622, double %171, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %172 = fadd double %fi29, %fi31, !llfi_index !1644
  %fi32 = call double @injectFault1(i64 1623, double %172, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %173 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1645
  %fi33 = call double @injectFault1(i64 1624, double %173, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %174 = fmul double %fi27, %fi33, !llfi_index !1646
  %fi34 = call double @injectFault1(i64 1625, double %174, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %175 = fadd double %fi32, %fi34, !llfi_index !1647
  %fi35 = call double @injectFault1(i64 1626, double %175, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1486
  %176 = load double, double* %123, align 8, !tbaa !345, !llfi_index !1648
  %177 = fmul double %146, %176, !llfi_index !1649
  %178 = fadd double %fi35, %177, !llfi_index !1650
