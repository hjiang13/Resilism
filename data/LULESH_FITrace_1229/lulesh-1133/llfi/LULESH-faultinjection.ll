...
define dso_local void @_Z29CollectDomainNodesToElemNodesPKiPdS1_S1_(i32* nocapture readonly %0, double* nocapture %1, double* nocapture %2, double* nocapture %3) local_unnamed_addr #5 {
  ...
  %16 = getelementptr i32, i32* %0, i64 6, !llfi_index !1117
  %fi = call i32* @injectFault0(i64 1097, i32* %16, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %17 = load i32, i32* %fi, align 4, !tbaa !404, !llfi_index !1119
  %fi1 = call i32 @injectFault1(i64 1098, i32 %17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  ...
  %fi2 = call double* @injectFault2(i64 1102, double* %21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  ...
  %44 = sext i32 %fi1 to i64, !llfi_index !1152
  %fi3 = call i64 @injectFault3(i64 1131, i64 %44, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %45 = getelementptr double, double* %fi2, i64 %fi3, !llfi_index !1153
  %fi4 = call double* @injectFault2(i64 1132, double* %45, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %46 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !1154
  %fi5 = call double @injectFault4(i64 1133, double %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1118
  %47 = getelementptr inbounds double, double* %1, i64 6, !llfi_index !1155
  store double %fi5, double* %47, align 8, !tbaa !345, !llfi_index !1156
  ...
  %70 = getelementptr inbounds double, double* %52, i64 %fi3, !llfi_index !1186
  ...
  %94 = getelementptr inbounds double, double* %76, i64 %fi3, !llfi_index !1218
