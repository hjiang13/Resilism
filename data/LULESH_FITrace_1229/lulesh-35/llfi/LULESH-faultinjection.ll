...
25:                                               ; preds = %23, %19
  ...
  %fi = call double* @injectFault0(i64 35, double* %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !43
  %28 = icmp eq double* %fi, null, !llfi_index !44
  br i1 %28, label %31, label %29, !llfi_index !45

29:                                               ; preds = %25
  %30 = bitcast double* %fi to i8*, !llfi_index !46
