...
12:                                               ; preds = %12, %10
  ...
  %fi1 = call i64 @injectFault1(i64 3243, i64 %13, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %14 = getelementptr inbounds double, double* %3, i64 %fi1, !llfi_index !3285
  ...
  %26 = getelementptr double, double* %fi, i64 %fi1, !llfi_index !3299
  %fi2 = call double* @injectFault0(i64 3258, double* %26, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %27 = load double, double* %fi2, align 8, !tbaa !345, !llfi_index !3300
  %fi3 = call double @injectFault2(i64 3259, double %27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  %28 = fmul double %fi3, %0, !llfi_index !3301
  %fi4 = call double @injectFault2(i64 3260, double %28, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3277
  ...
  %31 = fadd double %fi4, %30, !llfi_index !3304
  store double %31, double* %29, align 8, !tbaa !345, !llfi_index !3305
  %32 = add nuw nsw i64 %fi1, 1, !llfi_index !3306
  %fi5 = call i64 @injectFault1(i64 3265, i64 %32, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3277
