...
175:                                              ; preds = %173, %169
  ...
  %fi = call i32* @injectFault0(i64 210, i32* %177, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !220
  %178 = icmp eq i32* %fi, null, !llfi_index !221
  br i1 %178, label %181, label %179, !llfi_index !222

179:                                              ; preds = %175
  %180 = bitcast i32* %fi to i8*, !llfi_index !223
