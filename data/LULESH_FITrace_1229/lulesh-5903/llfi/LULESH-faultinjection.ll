...
163:                                              ; preds = %163, %154
  ...
  %fi = call double @injectFault0(i64 5903, double %169, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !6036
  %170 = getelementptr inbounds [8 x double], [8 x double]* %3, i64 0, i64 %164, !llfi_index !6037
  store double %fi, double* %170, align 8, !tbaa !345, !llfi_index !6038
