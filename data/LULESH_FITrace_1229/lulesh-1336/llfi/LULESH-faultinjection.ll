...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  ...
  %17 = getelementptr double, double* %3, i64 7, !llfi_index !1300
  %fi = call double* @injectFault0(i64 1280, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1301
  %18 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1302
  ...
  %46 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1331
  ...
  %71 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1357
  %fi1 = call double @injectFault1(i64 1336, double %71, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1301
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %67, double %68, double %69, double %70, double %fi1, double %72, double %73, double %74, double %75, double %76, double %77, double %78, double %79, double %80, double %81, double %82, double %83, double %84, double* nonnull %85, double* nonnull %86, double* nonnull %87), !llfi_index !1374
  ...
  %109 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1397
  ...
  %131 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1420
  ...
  %153 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1443
