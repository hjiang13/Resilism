...
31:                                               ; preds = %31, %20
  %32 = phi i64 [ 0, %20 ], [ %fi4, %31 ], !llfi_index !3215
  ...
  %fi4 = call i64 @injectFault1(i64 3182, i64 %37, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3201
  %38 = icmp eq i64 %fi4, %8, !llfi_index !3222
