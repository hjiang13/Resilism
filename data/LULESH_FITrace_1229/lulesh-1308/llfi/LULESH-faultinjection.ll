...
define dso_local void @_Z24CalcElemVolumeDerivativePdS_S_PKdS1_S1_(double* nocapture %0, double* nocapture %1, double* nocapture %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5) local_unnamed_addr #5 {
  %7 = getelementptr double, double* %3, i64 1, !llfi_index !1290
  %fi = call double* @injectFault0(i64 1270, double* %7, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1291
  %8 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1292
  ...
  %44 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1329
  %fi1 = call double @injectFault1(i64 1308, double %44, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1291
  ...
  tail call void @_Z7VoluDerddddddddddddddddddPdS_S_(double %43, double %fi1, double %45, double %46, double %47, double %49, double %50, double %51, double %52, double %53, double %54, double %56, double %57, double %58, double %59, double %60, double %61, double %63, double* nonnull %64, double* nonnull %65, double* nonnull %66), !llfi_index !1352
  %67 = load double, double* %11, align 8, !tbaa !345, !llfi_index !1353
  %68 = load double, double* %3, align 8, !tbaa !345, !llfi_index !1354
  %69 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1355
  ...
  %114 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1402
  ...
  %133 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1422
  ...
  %155 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !1445
