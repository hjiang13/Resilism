...
85:                                               ; preds = %83, %79
  ...
  %fi = call double* @injectFault0(i64 105, double* %87, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !113
  %88 = icmp eq double* %fi, null, !llfi_index !114
  br i1 %88, label %91, label %89, !llfi_index !115

89:                                               ; preds = %85
  %90 = bitcast double* %fi to i8*, !llfi_index !116
