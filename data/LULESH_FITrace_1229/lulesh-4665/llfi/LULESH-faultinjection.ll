...
32:                                               ; preds = %32, %30
  ...
  %41 = getelementptr double, double* %2, i64 %33, !llfi_index !4721
  %fi = call double* @injectFault0(i64 4665, double* %41, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !4722
  %42 = bitcast double* %fi to <2 x double>*, !llfi_index !4723
