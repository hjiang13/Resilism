...
13:                                               ; preds = %11, %7
  ...
  %fi = call i1 @injectFault0(i64 22, i1 %16, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !30
  br i1 %fi, label %19, label %17, !llfi_index !31
