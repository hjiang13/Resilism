...
175:                                              ; preds = %173, %169
  ...
  %fi = call i1 @injectFault0(i64 211, i1 %178, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !221
  br i1 %fi, label %181, label %179, !llfi_index !222
