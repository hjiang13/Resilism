...
71:                                               ; preds = %106, %63
  ...
  %fi = call <2 x i1> @injectFault0(i64 4720, <2 x i1> %91, i32 30, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @xor_namestr, i32 0, i32 0)), !llfi_injectfault !4789
  %92 = or <2 x i1> %90, %fi, !llfi_index !4790
