...
13:                                               ; preds = %13, %11
  ...
  %fi = call double @injectFault0(i64 3206, double %23, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !3246
  store double %fi, double* %15, align 8, !tbaa !345, !llfi_index !3247
