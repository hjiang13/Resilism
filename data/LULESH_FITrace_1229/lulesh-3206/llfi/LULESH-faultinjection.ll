...
define dso_local void @_Z20CalcVelocityForNodesdd(double %0, double %1) local_unnamed_addr #7 {
  ...
  %fi = call double* @injectFault0(i64 3186, double* %4, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  ...
  %fi1 = call double* @injectFault0(i64 3187, double* %5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3226
...
13:                                               ; preds = %13, %11
  %14 = phi i64 [ 0, %11 ], [ %fi12, %13 ], !llfi_index !3237
  %fi3 = call i64 @injectFault2(i64 3197, i64 %14, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %15 = getelementptr double, double* %fi, i64 %fi3, !llfi_index !3238
  %fi4 = call double* @injectFault0(i64 3198, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %16 = load double, double* %fi4, align 8, !tbaa !345, !llfi_index !3239
  %fi5 = call double @injectFault1(i64 3199, double %16, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %17 = getelementptr double, double* %fi1, i64 %fi3, !llfi_index !3240
  %fi6 = call double* @injectFault0(i64 3200, double* %17, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %18 = load double, double* %fi6, align 8, !tbaa !345, !llfi_index !3241
  %fi7 = call double @injectFault1(i64 3201, double %18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %19 = fmul double %fi7, %0, !llfi_index !3242
  %fi2 = call double @injectFault1(i64 3202, double %19, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %20 = fadd double %fi5, %fi2, !llfi_index !3243
  %fi8 = call double @injectFault1(i64 3203, double %20, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %21 = call double @llvm.fabs.f64(double %fi8) #2, !llfi_index !3244
  %fi9 = call double @injectFault1(i64 3204, double %21, i32 56, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %22 = fcmp olt double %fi9, %1, !llfi_index !3245
  %fi10 = call i1 @injectFault3(i64 3205, i1 %22, i32 54, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %23 = select i1 %fi10, double 0.000000e+00, double %fi8, !llfi_index !3246
  %fi11 = call double @injectFault1(i64 3206, double %23, i32 57, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @select_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  store double %fi11, double* %fi4, align 8, !tbaa !345, !llfi_index !3247
  %24 = getelementptr inbounds double, double* %6, i64 %fi3, !llfi_index !3248
  %25 = load double, double* %24, align 8, !tbaa !345, !llfi_index !3249
  %26 = getelementptr inbounds double, double* %7, i64 %fi3, !llfi_index !3250
  ...
  %33 = getelementptr inbounds double, double* %8, i64 %fi3, !llfi_index !3258
  %34 = load double, double* %33, align 8, !tbaa !345, !llfi_index !3259
  %35 = getelementptr inbounds double, double* %9, i64 %fi3, !llfi_index !3260
  ...
  %42 = add nuw nsw i64 %fi3, 1, !llfi_index !3268
  %fi12 = call i64 @injectFault2(i64 3228, i64 %42, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !3226
  %43 = icmp eq i64 %fi12, %12, !llfi_index !3269
