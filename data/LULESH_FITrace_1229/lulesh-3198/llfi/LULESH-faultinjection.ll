...
13:                                               ; preds = %13, %11
  ...
  %15 = getelementptr double, double* %4, i64 %14, !llfi_index !3237
  %fi = call double* @injectFault0(i64 3198, double* %15, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !3238
  %16 = load double, double* %fi, align 8, !tbaa !345, !llfi_index !3239
  ...
  store double %23, double* %fi, align 8, !tbaa !345, !llfi_index !3247
