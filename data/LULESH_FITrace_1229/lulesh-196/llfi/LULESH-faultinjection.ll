...
163:                                              ; preds = %161, %157
  ...
  %fi = call i32* @injectFault0(i64 196, i32* %165, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !206
  %166 = icmp eq i32* %fi, null, !llfi_index !207
  br i1 %166, label %169, label %167, !llfi_index !208

167:                                              ; preds = %163
  %168 = bitcast i32* %fi to i8*, !llfi_index !209
