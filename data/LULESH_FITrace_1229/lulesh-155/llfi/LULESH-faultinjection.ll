...
127:                                              ; preds = %125, %121
  ...
  %fi = call i1 @injectFault0(i64 155, i1 %130, i32 53, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !163
  br i1 %fi, label %133, label %131, !llfi_index !164
