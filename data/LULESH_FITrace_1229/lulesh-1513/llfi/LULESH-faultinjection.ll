...
define dso_local void @_Z24CalcElemFBHourglassForcePdS_S_S_S_S_S_S_S_S_S_dS_S_S_(double* nocapture readonly %0, double* nocapture readonly %1, double* nocapture readonly %2, double* nocapture readonly %3, double* nocapture readonly %4, double* nocapture readonly %5, double* nocapture readonly %6, double* nocapture readonly %7, double* nocapture readonly %8, double* nocapture readonly %9, double* nocapture readonly %10, double %11, double* nocapture %12, double* nocapture %13, double* nocapture %14) local_unnamed_addr #5 {
  ...
  %fi5 = call double* @injectFault1(i64 1503, double* %54, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %55 = load double, double* %fi5, align 8, !tbaa !345, !llfi_index !1525
  %fi6 = call double @injectFault0(i64 1504, double %55, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %56 = fmul double %fi, %fi6, !llfi_index !1526
  %fi7 = call double @injectFault0(i64 1505, double %56, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %57 = getelementptr double, double* %4, i64 1, !llfi_index !1527
  %fi8 = call double* @injectFault1(i64 1506, double* %57, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %58 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !1528
  %fi9 = call double @injectFault0(i64 1507, double %58, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %59 = fmul double %fi2, %fi9, !llfi_index !1529
  %fi10 = call double @injectFault0(i64 1508, double %59, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %60 = fadd double %fi7, %fi10, !llfi_index !1530
  %fi11 = call double @injectFault0(i64 1509, double %60, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %61 = getelementptr double, double* %5, i64 1, !llfi_index !1531
  %fi12 = call double* @injectFault1(i64 1510, double* %61, i32 34, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %62 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !1532
  %fi13 = call double @injectFault0(i64 1511, double %62, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %63 = fmul double %fi4, %fi13, !llfi_index !1533
  %fi14 = call double @injectFault0(i64 1512, double %63, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  %64 = fadd double %fi11, %fi14, !llfi_index !1534
  %fi15 = call double @injectFault0(i64 1513, double %64, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !1487
  ...
  %68 = fadd double %fi15, %67, !llfi_index !1538
  ...
  %148 = fmul double %fi6, %84, !llfi_index !1618
  ...
  %157 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !1628
  ...
  %170 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !1642
  ...
  %284 = load double, double* %fi5, align 8, !tbaa !345, !llfi_index !1762
  %285 = fmul double %247, %284, !llfi_index !1763
  %286 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !1764
  %287 = fmul double %251, %286, !llfi_index !1765
  %288 = fadd double %285, %287, !llfi_index !1766
  %289 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !1767
  ...
  %363 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !1842
  ...
  %376 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !1856
  ...
  %490 = load double, double* %fi5, align 8, !tbaa !345, !llfi_index !1976
  %491 = fmul double %453, %490, !llfi_index !1977
  %492 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !1978
  %493 = fmul double %457, %492, !llfi_index !1979
  %494 = fadd double %491, %493, !llfi_index !1980
  %495 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !1981
  ...
  %569 = load double, double* %fi8, align 8, !tbaa !345, !llfi_index !2056
  ...
  %582 = load double, double* %fi12, align 8, !tbaa !345, !llfi_index !2070
