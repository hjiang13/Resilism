...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi5 = call <2 x double> @injectFault0(i64 3306, <2 x double> %55, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %56 = insertelement <2 x double> %fi5, double %18, i32 1, !llfi_index !3349
  %fi6 = call <2 x double> @injectFault0(i64 3307, <2 x double> %56, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %57 = insertelement <2 x double> poison, double %16, i32 0, !llfi_index !3350
  %fi7 = call <2 x double> @injectFault0(i64 3308, <2 x double> %57, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %58 = shufflevector <2 x double> %fi7, <2 x double> poison, <2 x i32> zeroinitializer, !llfi_index !3351
  %fi8 = call <2 x double> @injectFault0(i64 3309, <2 x double> %58, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %59 = fsub <2 x double> %fi6, %fi8, !llfi_index !3352
  %fi9 = call <2 x double> @injectFault0(i64 3310, <2 x double> %59, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  ...
  %113 = fmul <2 x double> %fi4, %fi9, !llfi_index !3407
  %fi10 = call <2 x double> @injectFault0(i64 3365, <2 x double> %113, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3329
  %114 = fmul <2 x double> %54, %45, !llfi_index !3408
  %115 = fsub <2 x double> %fi10, %114, !llfi_index !3409
  ...
  %119 = fmul <2 x double> %35, %fi9, !llfi_index !3413
