...
define dso_local double @_Z14CalcElemVolumedddddddddddddddddddddddd(double %0, double %1, double %2, double %3, double %4, double %5, double %6, double %7, double %8, double %9, double %10, double %11, double %12, double %13, double %14, double %15, double %16, double %17, double %18, double %19, double %20, double %21, double %22, double %23) local_unnamed_addr #16 {
  ...
  %fi13 = call <2 x double> @injectFault1(i64 3317, <2 x double> %66, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %67 = insertelement <2 x double> %fi13, double %4, i32 1, !llfi_index !3360
  %fi14 = call <2 x double> @injectFault1(i64 3318, <2 x double> %67, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %68 = insertelement <2 x double> poison, double %19, i32 0, !llfi_index !3361
  %fi15 = call <2 x double> @injectFault1(i64 3319, <2 x double> %68, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %69 = insertelement <2 x double> %fi15, double %3, i32 1, !llfi_index !3362
  %fi16 = call <2 x double> @injectFault1(i64 3320, <2 x double> %69, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %70 = fsub <2 x double> %fi14, %fi16, !llfi_index !3363
  %fi17 = call <2 x double> @injectFault1(i64 3321, <2 x double> %70, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %71 = fsub double %13, %15, !llfi_index !3364
  %72 = insertelement <2 x double> %fi7, double %5, i32 1, !llfi_index !3365
  %fi18 = call <2 x double> @injectFault1(i64 3323, <2 x double> %72, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %73 = insertelement <2 x double> poison, double %23, i32 0, !llfi_index !3366
  %fi19 = call <2 x double> @injectFault1(i64 3324, <2 x double> %73, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %74 = insertelement <2 x double> %fi19, double %7, i32 1, !llfi_index !3367
  %fi20 = call <2 x double> @injectFault1(i64 3325, <2 x double> %74, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %75 = fsub <2 x double> %fi18, %fi20, !llfi_index !3368
  %fi21 = call <2 x double> @injectFault1(i64 3326, <2 x double> %75, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  ...
  %81 = insertelement <2 x double> %fi13, double %17, i32 1, !llfi_index !3374
  ...
  %94 = fmul <2 x double> %fi11, %shift, !llfi_index !3388
  ...
  %98 = fadd <2 x double> %fi17, %fi21, !llfi_index !3392
  %fi22 = call <2 x double> @injectFault1(i64 3350, <2 x double> %98, i32 14, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %99 = fmul <2 x double> %fi11, %fi5, !llfi_index !3393
  %fi23 = call <2 x double> @injectFault1(i64 3351, <2 x double> %99, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %100 = insertelement <2 x double> poison, double %fi, i32 0, !llfi_index !3394
  %fi24 = call <2 x double> @injectFault1(i64 3352, <2 x double> %100, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %101 = shufflevector <2 x double> %fi24, <2 x double> %fi5, <2 x i32> <i32 0, i32 2>, !llfi_index !3395
  %fi25 = call <2 x double> @injectFault1(i64 3353, <2 x double> %101, i32 63, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @shufflevector_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %102 = extractelement <2 x double> %fi11, i32 1, !llfi_index !3396
  %fi26 = call double @injectFault0(i64 3354, double %102, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %103 = insertelement <2 x double> poison, double %fi26, i32 0, !llfi_index !3397
  %fi27 = call <2 x double> @injectFault1(i64 3355, <2 x double> %103, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %104 = insertelement <2 x double> %fi27, double %fi12, i32 1, !llfi_index !3398
  %fi28 = call <2 x double> @injectFault1(i64 3356, <2 x double> %104, i32 62, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @insertelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %105 = fmul <2 x double> %fi25, %fi28, !llfi_index !3399
  %fi29 = call <2 x double> @injectFault1(i64 3357, <2 x double> %105, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %106 = fsub <2 x double> %fi23, %fi29, !llfi_index !3400
  %fi30 = call <2 x double> @injectFault1(i64 3358, <2 x double> %106, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %107 = fmul <2 x double> %fi30, %fi22, !llfi_index !3401
  %fi31 = call <2 x double> @injectFault1(i64 3359, <2 x double> %107, i32 18, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %108 = extractelement <2 x double> %fi31, i32 1, !llfi_index !3402
  %109 = fadd double %108, %97, !llfi_index !3403
  %110 = extractelement <2 x double> %fi31, i32 0, !llfi_index !3404
  %fi32 = call double @injectFault0(i64 3362, double %110, i32 61, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @extractelement_namestr, i32 0, i32 0)), !llfi_injectfault !3318
  %111 = fadd double %fi32, %109, !llfi_index !3405
